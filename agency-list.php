...
<html lang="en">
  <head>
    ...
    <title>Agencies List - Jovi Planet</title>
    <!-- Google fonts -->
    ...
    <meta name="twitter:title" content="Agencies List">
    <meta name="twitter:description" content="Real Estate Html Template">
    <meta name="twitter:image" content="images/homeid-social-logo.png">
    <!-- Facebook -->
    <meta property="og:url" content="agency-list.html">
    <meta property="og:title" content="Agencies List">
        ...
        <div class="row" style="margin-right: -200px;">
          <div class="col-md-6">
            <div class="pb-6 page-title shadow">
              <h1 class="text-white fs-30 lh-16 mb-1 font-weight-600" data-animate="fadeInRight">Descubra Agências Imobiliárias Parceiras
              </h1>
              <h6 class="text-white mb-1">Explore uma seleção exclusiva de agências registadas na nossa plataforma</h6>
            </div>
          </div>
        </div> 
      </div>
            ...
            <div class="col-lg-12 mb-6 mb-lg-0">
              <div class="row align-items-sm-center mb-6">
                <div class="col-sm-6 mb-6 mb-sm-0">
                  <h2 class="fs-15 text-dark mb-0">We found <span class="text-primary">45</span> agencies
                    available
                    for
                    you
                  </h2>
                ...
                <div class="col-sm-6">
                  <div class="d-flex align-items-center justify-content-sm-end">
                    ...
                    <!-- <div class="d-none d-md-block list-layout">
                      ...
                      <a href="agency-grid.html" class="fs-sm-18 text-muted ml-5">
...
SELECT * FROM tb0180_imobiliaria
WHERE ativoIMOBILIARIA = 1
";
...
?>
              <div class="card shadow-hover-lg-xs-4 border border-sm-0 mb-4" style="
    padding: 10px;
    border: solid 0.5px #f2f2f2 !important;
">
                <div class="row no-gutters align-items-center">
                  <div class="col-sm-2 border-sm rounded-0 rounded-lg-top-left card-img">
                    <a href="/agency-details/<?php echo $imovel['codigoIMOBILIARIA'];?>">
                      <img src="<?php echo $imovel['imagemIMOBILIARIA'];?>" alt="<?php echo $imovel['nomeIMOBILIARIA'];?>" height="150" >
                    </a>
                  </div>
                  <div class="col-sm-10">
                    <div class="card-body px-6 py-6 py-sm-0 border-top border-sm-0">
                      <a href="/agency-details/<?php echo $imovel['codigoIMOBILIARIA'];?>">
                        <h6 class="card-title text-dark lh-213 mb-0 hover-primary"><?php echo $imovel['nomeIMOBILIARIA'];?></h6>
                      </a>
                      <p class="card-text"><?php echo $imovel['enderecoIMOBILIARIA'];?></p>
                      <ul class="list-group list-group-no-border">
                        <!-- <li class="list-group-item d-flex align-items-sm-center lh-114 row m-0 px-0 pt-3 pb-0">
                          <span class="col-sm-3 p-0 fs-13 mb-1 mb-sm-0">Office</span>
                          <span class="col-sm-9 p-0 text-heading font-weight-500">123 900 68668</span>
                        </li> -->
                        <li class="list-group-item d-flex align-items-sm-center lh-114 row m-0 px-0 pt-3 pb-0">
                          <span class="col-sm-3 p-0 fs-13 mb-1 mb-sm-0">Mobile</span>
                          <span class="col-sm-9 p-0 text-heading font-weight-500"><?php echo $imovel['telefoneIMOBILIARIA'];?></span>
                        </li>
                        <!-- <li class="list-group-item d-flex align-items-sm-center lh-114 row m-0 px-0 pt-3 pb-0">
                          <span class="col-sm-3 p-0 fs-13 mb-1 mb-sm-0">Fax</span>
                          <span class="col-sm-9 p-0 text-heading font-weight-500">1-323 900 6800</span>
                        </li> -->
                        <li class="list-group-item d-flex align-items-sm-center lh-114 row m-0 px-0 pt-3 pb-0">
                          <span class="col-sm-3 p-0 fs-13 mb-1 mb-sm-0">Email</span>
                          <span class="col-sm-9 p-0"><?php echo $imovel['emailIMOBILIARIA'];?></span>
                        </li>
                        <li class="list-group-item d-flex align-items-sm-center lh-114 row m-0 px-0 pt-4 pb-0">
                          ...
                          <ul class="col-sm-9 list-inline text-gray-lighter m-0 p-0 z-index-2">
                            <li class="list-inline-item m-0">
                              <a href="<?php echo $imovel['twitterIMOBILIARIA'];?>"
                            ...
                            <li class="list-inline-item mr-0 ml-2">
                              <a href="<?php echo $imovel['facebookIMOBILIARIA'];?>"
                                                    class="w-32px h-32 rounded bg-hover-primary bg-white hover-white text-body d-flex align-items-center justify-content-center border border-hover-primary"><i
                                                        class="fab fa-facebook-f"></i></a>
                            </li>
                            <li class="list-inline-item mr-0 ml-2">
                              <a href="<?php echo $imovel['instagramIMOBILIARIA'];?>"
                                                    class="w-32px h-32 rounded bg-hover-primary bg-white hover-white text-body d-flex align-items-center justify-content-center border border-hover-primary"><i
                                                        class="fab fa-instagram"></i></a>
                            </li>
                            <li class="list-inline-item mr-0 ml-2">
                              <a href="<?php echo $imovel['linkedinIMOBILIARIA'];?>"
                                                    class="w-32px h-32 rounded bg-hover-primary bg-white hover-white text-body d-flex align-items-center justify-content-center border border-hover-primary"><i

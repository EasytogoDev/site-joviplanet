...
<head>
  ...
  <title> Add new Listings - Joviplanet</title>
  <!-- Google fonts -->
  <link
      ...
      <div class="page-content">
        ...
        <main id="content" class="bg-gray-01">
          <div class="px-3 px-lg-6 px-xxl-13 py-5 py-lg-10 my-profile">
            ...
            <!--Campos Ocultos-->
            <input type="hidden" class="form-control form-control-lg border-0" id="clienteIMOVEL" name="clienteIMOVEL" value="<?php echo $usuario['codigoUSUARIO'];?>">
            ...
            <div class="collapse-tabs new-property-step">
              <ul class="nav nav-pills border py-2 px-3 mb-6 d-none d-md-flex mb-6" role="tablist">
                ...
                <li class="nav-item col">
                  <a class="nav-link bg-transparent shadow-none py-2 font-weight-500 text-center lh-214 d-block"
                    id="detail-tab" data-toggle="pill" data-number="3." href="#detail" role="tab" aria-controls="detail"
                                      ...
                                      <div class="col-md-6 col-lg-12 col-xxl-6 px-2 mb-4 mb-md-0">
                                        <div class="form-group mb-0">
                                          ...
                                          <select class="form-control border-0 shadow-none form-control-lg selectpicker"
                                            ...
                                            $sql_CategoriasImaveis = "
                                            SELECT codigoCATEGORIA, nomeCATEGORIA, imagemCATEGORIA 
                                           
                                            FROM tb0001_categorias WHERE ativoCATEGORIA = 1
";
                                            try {
                                      ...
                                      <div class="col-md-6 col-lg-12 col-xxl-6 px-2 mb-4 mb-md-0">
                                        <div class="form-group mb-0">
                                          ...
                                          <select class="form-control border-0 shadow-none form-control-lg selectpicker"
                                            title="Select" data-style="btn-lg py-2 h-52" id="tipoIMOVEL" name="tipoIMOVEL" onChange="validaTipoImovel()">
                                            <?php
                                            ...
                                            while ($TipoImoveis = $query_TipoImoveis->fetch(PDO::FETCH_ASSOC)) {
                                              ...
                                              ?>
                                              <option value="<?php echo $TipoImoveis['codigoTIPOIMOVEL']; ?>">
                                      ...
                                      <div class="col-md-6 col-lg-12 col-xxl-6 px-2 mb-4 mb-md-0">
                                        <div class="form-group mb-0">
                                          <label for="planoIMOVEL" class="text-heading">Plans</label>
                                          <select class="form-control border-0 shadow-none form-control-lg selectpicker"
        ...
        while ($PlanoImoveis = $query_PlanoImoveis->fetch(PDO::FETCH_ASSOC)) {
          ...
          ?>
          <option value="<?php echo $PlanoImoveis['codigoPLANO']; ?>"  >
                                ...
                                <div class="card mb-6">
                                  <div class="card-body p-6">
                                    ...
                                    <div class="form-row mx-n2">
                                      ...
                                      <div class="col-md-6 col-lg-12 col-xxl-6 px-2">
                                        <div class="form-group">
                                          <label for="labelvalorIMOVEL" class="text-heading">Label After Price Label <span
                                          ...
                                          <input type="text" class="form-control form-control-lg border-0"
                                            id="labelvalorIMOVEL" name="labelvalorIMOVEL">
                                        </div>
                                      </div>
                                    </div>
                                    <div class="form-row mx-n2">
                                    ...
                                    <div class="form-row mx-n2">
                                      ...
                                      <div class="col-md-12 col-lg-12 col-xxl-12 px-2">
                                        <div class="form-group mb-md-0">
                                          ...
                                          <input type="videoIMOVEL" name="videoIMOVEL"
                        ...
                        <div class="card-header d-block d-md-none bg-transparent px-0 py-1 border-bottom-0"
                          ...
                          <h5 class="mb-0">
                            <button class="btn btn-block collapse-parent collapsed border shadow-none"
                              ...
                              <span class="number">2.</span> Location
                            </button>
                          </h5>
                        </div>
                                ...
                                <div class="card mb-6">
                                  <div class="card-body p-6">
                                    ...
                                    <div class="form-row mx-n2">
                                      <div class="col-md-6 col-lg-12 col-xxl-6 px-2">
                                        <div class="form-group">
                                          <label for="zipcodeIMOVEL" class="text-heading">ZIP / Postcode</label>
                                          <input type="text" placeholder="ZIP / Postcode"
                                            class="form-control form-control-lg border-0" id="zipcodeIMOVEL"
                                            name="zipcodeIMOVEL" autocomplete="zipcodeIMOVEL">
                                        </div>
                                      </div>
                                    </div>
                                    ...
                                    <div class="form-row mx-n2">
                                      <div class="col-md-6 col-lg-12 col-xxl-6 px-2">
                                        <div class="form-group">
                                          <label for="countryIMOVEL" class="text-heading">Country</label>
                                          <input type="text" placeholder="Type here..."
                                            class="form-control form-control-lg border-0" id="countryIMOVEL"
                                            name="countryIMOVEL" autocomplete="shipping postal-code">
                                        </div>
                                      </div>
                                    </div>
                                ...
                                <div class="card mb-6">
                                  <div class="card-body p-6">
                                    ...
                                    <div class="form-row mx-n2">
                                      <div class="col-md-6 col-lg-12 col-xxl-6 px-2">
                                        <div class="form-group mb-md-0">
                                          <label for="latitudeIMOVEL" class="text-heading">Latitude </label>
                                          <input type="text" class="form-control form-control-lg border-0" id="latitudeIMOVEL"
                                            name="latitudeIMOVEL">
                                        </div>
                                      </div>
                                      ...
                                      <div class="col-md-6 col-lg-12 col-xxl-6 px-2">
                                        <div class="form-group mb-md-0">
                                          <label for="longitudeIMOVEL" class="text-heading">Longitude</label>
                                          <input type="text" class="form-control form-control-lg border-0"
                                            id="longitudeIMOVEL" name="longitudeIMOVEL">
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                    ...
                    <div class="tab-pane tab-pane-parent fade px-0" id="detail" role="tabpanel"
                      ...
                      <div class="card bg-transparent border-0">
                        <div class="card-header d-block d-md-none bg-transparent px-0 py-1 border-bottom-0"
                          ...
                          <h5 class="mb-0">
                            <button class="btn btn-block collapse-parent collapsed border shadow-none"
                              data-toggle="collapse" data-number="3." data-target="#detail-collapse"
                              aria-expanded="true" aria-controls="detail-collapse">
                              <span class="number">3.</span> Detail
                            </button>
                          </h5>
                        </div>
                        ...
                        <div id="detail-collapse" class="collapse collapsible" aria-labelledby="heading-detail"
                          ...
                          <div class="card-body py-4 py-md-0 px-0">
                            <div class="card mb-6">
                                  ...
                                  <div class="col-lg-2">
                                    <div class="form-group">
                                      <label for="floors-no" class="text-heading">Type of area<span
                                          class="text-muted"></span></label>
                                      <select class="form-control border-0 shadow-none form-control-lg selectpicker"
                                        title="Select" data-style="btn-lg py-2 h-52" id="tipometragemIMOVEL" name="floors-no">
                                        <option id>m²</option>
                                        <option>ft²</option>
                              ...
                              <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="qtdpessoasIMOVEL" class="text-heading">Number of peoples</label>
                                  ...
                                  <option value="2">No</option>
                                    ...
                                    <div class="form-group">
                                      <label for="regrasadicionaisIMOVEL" class="text-heading">Additional Rules<span
                                          ...
                                          ------>
                                          <textarea class="form-control border-0" id="regrasadicionaisIMOVEL" name="regrasadicionaisIMOVEL"></textarea>
                                      </div>
                                    </div>
                              ...
                              -->
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="coberturaIMOVEL" class="text-heading">Roofing</label>
                                    <!-----  <input type="text" class="form-control form-control-lg border-0" id="roofing"
                                        name="roofing">
                                    ----->
                                    <select class="form-control form-control-lg border-0" id="coberturaIMOVEL" name="coberturaIMOVEL">
                                    <option value="">Select...</option>
                                  <option value="1">Yes</option>
                                  <option value="2">No</option>
                                  </select>
...
--->                          
                                  <div class="col-lg-8">
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control form-control-lg border-0" id="floorIMOVEL"
                                        name="floorIMOVEL">
                                    </div>
                                  </div>
                        ...
                        <div class="card-header d-block d-md-none bg-transparent px-0 py-1 border-bottom-0"
                          ...
                          <h5 class="mb-0">
                            <button class="btn btn-block collapse-parent collapsed border shadow-none"
                              ...
                              <span class="number">4.</span> Amenities
                            </button>
                          </h5>
                        </div>
                            ...
                            <div class="card mb-6">
                              <div class="card-body p-6">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="floors-no" class="text-heading">Attic<span
                                          class="text-muted"></span></label>
                                      <select class="form-control border-0 shadow-none form-control-lg selectpicker"
                                        title="Select" data-style="btn-lg py-2 h-52" id="sotaoIMOVEL" name="floors-no">
                                        <option value="1">Yes</option>
                                        <option value="2">No</option>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="floors-no" class="text-heading">Basketball<span
                                          class="text-muted"></span></label>
                                      <select class="form-control border-0 shadow-none form-control-lg selectpicker"
                                        title="Select" data-style="btn-lg py-2 h-52" id="quadrabasqueteIMOVEL" name="floors-no">
                                        <option value="1">Yes</option>
                                        <option value="2">No</option>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="floors-no" class="text-heading">Doorman<span
                                          class="text-muted"></span></label>
                                      <select class="form-control border-0 shadow-none form-control-lg selectpicker"
                                        title="Select" data-style="btn-lg py-2 h-52" id="porteiroIMOVEL" name="floors-no">
                                        <option value="1">Yes</option>
                                        <option value="2">No</option>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="floors-no" class="text-heading">Front Yard<span
                                          class="text-muted"></span></label>
                                      <select class="form-control border-0 shadow-none form-control-lg selectpicker"
                                        title="Select" data-style="btn-lg py-2 h-52" id="jadimdefrenteIMOVEL" name="floors-no">
                                        <option value="1">Yes</option>
                                        <option value="2">No</option>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="floors-no" class="text-heading">Lake view<span
                                          class="text-muted"></span></label>
                                      <select class="form-control border-0 shadow-none form-control-lg selectpicker"
                                        title="Select" data-style="btn-lg py-2 h-52" id="vistadolagoIMOVEL" name="floors-no">
                                        <option value="1">Yes</option>
                                        <option value="2">No</option>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="floors-no" class="text-heading">Ocean View<span
                                          class="text-muted"></span></label>
                                      <select class="form-control border-0 shadow-none form-control-lg selectpicker"
                                        title="Select" data-style="btn-lg py-2 h-52" id="vistadomarIMOVEL" name="floors-no">
                                        <option value="1">Yes</option>
                                        <option value="2">No</option>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="floors-no" class="text-heading">Private Space<span
                                          class="text-muted"></span></label>
                                      <select class="form-control border-0 shadow-none form-control-lg selectpicker"
                                        title="Select" data-style="btn-lg py-2 h-52" id="espacoprivadoIMOVEL" name="floors-no">
                                        <option value="1">Yes</option>
                                        <option value="2">No</option>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="floors-no" class="text-heading">Sprinklers<span
                                          class="text-muted"></span></label>
                                      <select class="form-control border-0 shadow-none form-control-lg selectpicker"
                                        title="Select" data-style="btn-lg py-2 h-52" id="sprinklersIMOVEL" name="floors-no">
                                        <option value="1">Yes</option>
                                        <option value="2">No</option>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="floors-no" class="text-heading">Wine Cellar<span
                                          class="text-muted"></span></label>
                                      <select class="form-control border-0 shadow-none form-control-lg selectpicker"
                                        title="Select" data-style="btn-lg py-2 h-52" id="adegaIMOVEL" name="floors-no">
                                        <option value="1">Yes</option>
                                        <option value="2">No</option>
                                  ...
                                  <div class="d-flex flex-wrap">
                                    ...
                                    <button class="btn btn-lg btn-primary mb-3" type="button"
                                      onclick="CadastraImovel();">Submit property
                                    </button>
                                  </div>
                          </div>
                        </div>
...
*/
  ...
  <script>
    ...
    function CadastraImovel() {
      ...
      $.ajax({
        url: '/require/ajax/my-listings/insert.php',
        type: 'post',
        data: {
        
        imobiliariaIMOVEL: $('#imobiliariaIMOVEL').val(),
        agenteIMOVEL: $('#agenteIMOVEL').val(),
        ...
        countryIMOVEL: $('#countryIMOVEL').val(),
        ...
        coberturaIMOVEL: $('#coberturaIMOVEL').val(),
        ...
        emailIMOVEL: $('#emailIMOVEL').val(),
        destaqueIMOVEL: $('#destaqueIMOVEL').val(),
        disponivelIMOVEL: $('#disponivelIMOVEL').val(),
        quadrabasqueteIMOVEL: $('#quadrabasqueteIMOVEL').val(),
        sotaoIMOVEL: $('#sotaoIMOVEL').val(),
        porteiroIMOVEL: $('#porteiroIMOVEL').val(),
        jardimdefrenteIMOVEL: $('#jardimdefrenteIMOVEL').val(),
        vistadolagoIMOVEL: $('#vistadolagoIMOVEL').val(),
        vistadomarIMOVEL: $('#vistadomarIMOVEL').val(),
        espacoprivadoIMOVEL: $('#espacoprivadoIMOVEL').val(),
        adegaIMOVEL: $('#adegaIMOVEL').val(),
        sprinklersIMOVEL: $('#sprinklersIMOVEL').val(),
        floorIMOVEL: $('#floorIMOVEL').val(),

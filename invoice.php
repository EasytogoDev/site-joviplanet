...
<html lang="en">
  <head>
    ...
    <title>My Bookings - Joviplanet</title>
    <!-- Google fonts -->
                  ...
                  <div class="col-sm-12 col-md-6 d-flex justify-content-md-start justify-content-center">
                    ...
                    <div class="align-self-center">
                      <button class="btn btn-primary btn-lg" tabindex="0"
                            aria-controls="invoice-list" src="/add-new-invoice"><span>Add New</span></button>
                    </div>
                  </div>
                ...
                <table id="invoice-list" class="table table-hover bg-white border rounded-lg">
                  ...
                  <tbody>
                    ...
                    <tr role="row">
                      ...
                      <td class="align-middle"><span class="text-primary pr-1"><i class="fal fa-envelope"></i></span>alexGray3188@gmail.com</td>
                      <td class="align-middle"><span class="text-success pr-1"><i class="fal fa-calendar"></i></span>20 Dec 2020</td>
                    ...
                    <tr role="row">
                      ...
                      <td class="align-middle"><span class="text-primary pr-1"><i class="fal fa-envelope"></i></span>jamestaylor468@gmail.com</td>
                      <td class="align-middle"><span class="text-success pr-1"><i class="fal fa-calendar"></i></span>27 Dec 2020</td>
                      <td class="align-middle"><span class="inv-amount">$20.00</span></td>
                      <td class="align-middle"><span class="badge badge-yellow text-capitalize">Pending</span></td>
                      <td class="align-middle">
                        <a href="#" data-toggle="tooltip" title="Edit"
                           class="d-inline-block fs-18 text-muted hover-primary mr-5"><i
                                class="fal fa-pencil-alt"></i></a>
                    ...
                    <tr role="row">
                      ...
                      <td class="align-middle"><span class="text-primary pr-1"><i class="fal fa-envelope"></i></span>graceRoberts@company.com</td>
                      <td class="align-middle"><span class="text-success pr-1"><i class="fal fa-calendar"></i></span>31 Dec 2020</td>
                    ...
                    <tr role="row">
                      ...
                      <td class="align-middle"><span class="text-primary pr-1"><i class="fal fa-envelope"></i></span>donnaRogers@hotmail.com</td>
                      <td class="align-middle"><span class="text-success pr-1"><i class="fal fa-calendar"></i></span>03 Jan 2021</td>
                    ...
                    <tr role="row">
                      ...
                      <td class="align-middle"><span class="text-primary pr-1"><i class="fal fa-envelope"></i></span>amy968@gmail.com</td>
                      <td class="align-middle"><span class="text-success pr-1"><i class="fal fa-calendar"></i></span>14 Jan 2021</td>
                    ...
                    <tr role="row">
                      ...
                      <td class="align-middle"><span class="text-primary pr-1"><i class="fal fa-envelope"></i></span>niahillyer666@comapny.com</td>
                      <td class="align-middle"><span class="text-success pr-1"><i class="fal fa-calendar"></i></span>20 Jan 2021</td>

            ...
            <div class="px-3 px-lg-6 px-xxl-13 py-5 py-lg-10">
              <div class="d-flex flex-wrap flex-md-nowrap mb-6">
                <div class="mr-0 mr-md-auto">
                  <h2 class="mb-0 text-heading fs-22 lh-15">Datas Indisponíveis<span
                ...
                <table class="table table-hover bg-white border rounded-lg">
                  <thead class="thead-sm thead-black">
                    ...
                    <th scope="col" class="border-top-0 px-6 pt-5 pb-4"></th>
                      <th scope="col" class="border-top-0 px-6 pt-5 pb-4">ID</th>
                      <th scope="col" class="border-top-0 pt-5 pb-4">Status</th>
                      <th scope="col" class="border-top-0 pt-5 pb-4">Disponibilidade</th>
                    </tr>
                  </thead>
                  <?php
                  ...
                  $sql_Imovel = "
                  SELECT * FROM tb0034_reservas
                  INNER JOIN tb0201_usuarios ON codigoUSUARIO = usuarioRESERVA
                  INNER JOIN tb0031_imoveis ON codigoIMOVEL = imovelRESERVA
                  ...
                  <tbody>
                    <tr class="shadow-hover-xs-2 bg-hover-white">
                      <td class="align-middle pt-6 pb-4 px-6">
                        <div class="media">
                          <div class="w-120px mr-4 position-relative">
                            ...
                            <span class="badge badge-indigo position-absolute pos-fixed-top">for <?php echo $Imovel['tipoIMOVEL'];?></span>
                          </div>
                          <div class="media-body">
                            <a href="single-property-1.html" class="text-dark hover-primary">
                              <h5 class="fs-16 mb-0 lh-18"><?php echo $Imovel['tituloIMOVEL'];?></h5>
                            </a>
                            <p class="mb-1 font-weight-500"><?php echo $Imovel['tipoIMOVEL'];?>&nbsp;<?php echo $Imovel['enderecoIMOVEL'];?>,&nbsp;<?php echo $Imovel['cityIMOVEL'];?></p>
                      ...
                      <td class="align-middle"><?php echo $Imovel['datapublicadaRESERVA'];?></td>
                      <td class="align-middle">
                        <span
                                class="badge text-capitalize font-weight-normal fs-12 badge-yellow"><?php echo $Imovel['statusRESERVA'];?></span>
                      </td>
                      <td class="align-middle">2049</td>
                      <!-- <td class="align-middle">
                        <a href="#" data-toggle="tooltip" title="Cancel Booking" class="d-inline-block fs-18 text-muted hover-primary"><i
                                class="gg-close"></i></a>
                      </td> -->
                    </tr>
                    <?php } ?>

...
<head>
  ...
  <title>Joviplanet &#8211; Buy, Rent &amp; Vacation</title>
  <!-- Google fonts -->
  <link
          ...
          <article class="col-lg-8 pr-xl-7">
            <section class="pb-7 border-bottom">
              <ul class="list-inline d-sm-flex align-items-sm-center mb-2">
                ...
                <li class="list-inline-item mr-2 mt-2 mt-sm-0"><i class="fa fa-clock mr-1"></i>2 months ago
                </li>
...
<!---------------------------------------------------------------------------------------->
              ...
              <div class="d-sm-flex justify-content-sm-between">
                <div>
                  ...
                  <p class="mb-0"><i class="fa fa-map-marker-alt mr-2"></i><?php echo $imovel['numeroIMOVEL'];?> &nbsp; <?php echo $imovel['enderecoIMOVEL'];?>, &nbsp; <?php echo $imovel['cidadeIMOVEL'];?></p>
                </div>
              ...
              <div class="row">
                <div class="col-lg-3 col-sm-4 mb-6">
                  <div class="media">
                    ...
                    <div class="media-body">
                      ...
                      <p class="mb-0 fs-13 font-weight-bold text-heading"><?php echo $imovel['tipoIMOVEL'];?></p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-lg-3 col-sm-4 mb-6">
                  <div class="media">
                    ...
                    <div class="media-body">
                      <h5 class="my-1 fs-14 text-uppercase letter-spacing-093 font-weight-normal">Double bed</h5>
                      <p class="mb-0 fs-13 font-weight-bold text-heading"><?php echo $imovel['casalcamasIMOVEL'];?></p>
                    </div>
                  </div>
                </div>
                <div class="col-lg-3 col-sm-4 mb-6">
                  <div class="media">
                    ...
                    <div class="media-body">
                      <h5 class="my-1 fs-14 text-uppercase letter-spacing-093 font-weight-normal">Single bed</h5>
                      <p class="mb-0 fs-13 font-weight-bold text-heading"><?php echo $imovel['solteirocamasIMOVEL'];?></p>
                    </div>
                  </div>
                </div>
                <div class="col-lg-3 col-sm-4 mb-6">
            ...
            <section class="py-6 border-bottom">
              ...
              <iframe height="430" src="https://my.matterport.com/show/?m=wWcGxjuUuSb&amp;utm_source=hit-content-embed"

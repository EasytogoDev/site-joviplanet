...
<html lang="en">
  <head>
    ...
    <meta name="twitter:title" content="Agent Grid 1">
    <meta name="twitter:description" content="Real Estate Html Template">
    <meta name="twitter:image" content="/images/homeid-social-logo.png">
    <!-- Facebook -->
    <meta property="og:url" content="agents-grid-1.html">
    <meta property="og:title" content="Agent Grid 1">
         ...
         <div class="row" style="margin-right: -200px;">
          ...
          <div class="col-md-6">
              <div class="pb-6 page-title shadow">
                <h1 class="text-white fs-30 lh-16 mb-1 font-weight-600" data-animate="fadeInRight">Conheça os Nossos Agentes Imobiliários
                </h1>
                <h6 class="text-white mb-1">Explore perfis de agentes qualificados e experientes na área imobiliária</h6>
              </div>
            </div>
        ...
        <div class="container">
          <div class="row align-items-sm-center mb-6">
            <div class="col-sm-6 mb-6 mb-sm-0">
              <h2 class="fs-15 text-dark mb-0">We found <span class="text-primary">45</span> agents available for
                you
              </h2>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 mb-6">
              <div class="card shadow-hover-xs-4 agent-3">
                <div class="card-header text-center pt-6 pb-3 bg-transparent text-center">
                  <a href="/agents-details/<?php echo $imovel['codigoAGENTE'];?>" class="d-inline-block mb-2 w-120px h-120">
                    <img src="<?php echo $imovel['imagemAGENTE'];?>" alt="Max Kordek">
                  </a>
                  <a href="/agents-details/<?php echo $imovel['codigoAGENTE'];?>"
                           class="d-block fs-16 lh-2 text-dark mb-0 font-weight-500 hover-primary"><?php echo $imovel['nomeAGENTE'];?></a>
                  <p class="mb-2"><?php echo $imovel['categoriaAGENTE'];?></p>
                  <ul class="list-inline mb-0">
                    <li class="list-inline-item mr-6">
                      <a href="<?php echo $imovel['twitterAGENTE'];?>"
                                   class="text-muted hover-primary"><i
                                        class="fab fa-twitter"></i></a>
                    </li>
                    <li class="list-inline-item mr-6">
                      <a href="<?php echo $imovel['facebookAGENTE'];?>"
                                   class="text-muted hover-primary"><i
                                        class="fab fa-facebook-f"></i></a>
                    </li>
                    <li class="list-inline-item mr-6">
                      <a href="<?php echo $imovel['skypeAGENTE'];?>"
                                   class="text-muted hover-primary">
                        <i class="fab fa-skype"></i></a>
                    </li>
                    <li class="list-inline-item">
                      <a href="<?php echo $imovel['linkedinAGENTE'];?>"
                                   class="text-muted hover-primary"><i
                ...
                <!-- <div class="card-body text-center pt-2  px-0">
                  <a href="mailto:oliverbeddows@homeid.com" class="text-body"><?php echo $imovel['emailAGENTE'];?></a>
                  <a href="tel:123-900-68668" class="text-heading font-weight-600 d-block mb-3"><?php echo $imovel['telefoneAGENTE'];?></a>
                  <ul class="list-inline mb-0">

...
$sql_Imovel = " SELECT * FROM tb0180_imobiliaria WHERE codigoIMOBILIARIA = '".$pga."' ";
...
<html lang="en">
  <head>
    ...
    <title><?php echo $imovel['nomeIMOBILIARIA'];?> - JoviPlanet</title>
    <!-- Google fonts -->
    ...
    <meta name="twitter:title" content="Agency Details 2">
    <meta name="twitter:description" content="Real Estate Html Template">
    <meta name="twitter:image" content="/images/homeid-social-logo.png">
    <!-- Facebook -->
    <meta property="og:url" content="agency-details-2.html">
    <meta property="og:title" content="Agency Details 2">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="pb-6 page-title shadow">
              <h1 class="text-white fs-30 lh-16 mb-1 font-weight-600" data-animate="fadeInRight"><?php echo $imovel['nomeIMOBILIARIA'];?>
              </h1>
            </div>
          </div>
        </div> 
        ...
        <div class="container">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
              ...
              <li class="breadcrumb-item"><a href="/agency-list">Agencies</a></li>
              <li class="breadcrumb-item active" aria-current="page"><?php echo $imovel['nomeIMOBILIARIA'];?></li>
            </ol>
          </nav>
        </div>
      </section>
          ...
          <div class="row no-gutters">
            <div class="col-md-5 border border-2x mb-6 mb-md-0 h-100">
              <div class="py-0 py-md-7">
                <img src="<?php echo $imovel['imagemIMOBILIARIA'];?>"
                         alt="">
              </div>
            </div>
            ...
            <div class="col-md-7 h-100">
              <div class="pl-md-10 pr-md-8">
                <h2 class="fs-30 text-dark font-weight-600 lh-16 mb-0"><?php echo $imovel['nomeIMOBILIARIA'];?></h2>
                <p class="fs-16 font-weight-500 lh-213 mb-4"><?php echo $imovel['enderecoIMOBILIARIA'];?></p>
                <p class="mb-1">Copany Agent at <a href="#" class="text-heading"><u>Modern House Real Estate</u></a>
                </p>
                <p class="mb-6"><?php echo $imovel['descricaoIMOBILIARIA'];?></p>
                <hr class="mb-4">
                <div class="row">
                  <div class="col-sm-6 mb-4">
                    <p class="mb-0">Phone</p>
                    <p class="text-heading font-weight-500 mb-0 lh-13"><?php echo $imovel['telefoneIMOBILIARIA'];?></p>
                  </div>
                  <div class="col-sm-6 mb-4">
                    <p class="mb-0">Email</p>
                    <p class="text-heading font-weight-500 mb-0 lh-13"><?php echo $imovel['emailIMOBILIARIA'];?></p>
                  </div>
                  <div class="col-sm-6 mb-4">
                    <p class="mb-0">Language</p>
                    <p class="text-heading font-weight-500 mb-0 lh-13"><?php echo $imovel['idiomaIMOBILIARIA'];?></p>
                  </div>
                  <div class="col-sm-6 mb-4">
                    <p class="mb-0">Website</p>
                    <p class="text-heading font-weight-500 mb-0 lh-13"><?php echo $imovel['siteIMOBILIARIA'];?></p>
                  </div>
                  <div class="col-sm-6 mb-4">
                    <p class="mb-0">Tax Number</p>
                    <p class="text-heading font-weight-500 mb-0 lh-13">4930</p>
                  </div>
                </div>
                <hr class="mb-4">
                ...
                <div class="card mb-4">
                  <div class="card-body px-6 py-6">
                    <div class="media mb-4">
                      <img src="<?php echo $imovel['imagemIMOBILIARIA'];?>" class="rounded-circle mr-2" alt="<?php echo $imovel['nomeIMOBILIARIA'];?>">
                    </div>
                    <div class="media-body">
                        <p class="fs-16 lh-1 text-dark mb-0 font-weight-500">
                          <?php echo $imovel['nomeIMOBILIARIA'];?>
                        </p>

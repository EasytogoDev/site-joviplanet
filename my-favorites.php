          ...
          <div class="px-3 px-lg-6 px-xxl-13 py-5 py-lg-10">
                ...
                <div class="p-2">
                  <div class="input-group input-group-lg bg-white border">
                    ...
                    <select class="form-control bg-transparent pl-0 selectpicker d-flex align-items-center sortby"
                      name="sort-by" data-style="bg-transparent px-1 py-0 lh-1 font-weight-600 text-body" id="status">
            ...
            <div class="row">
                  ...
                  $sql_Imovel = "
                    SELECT *
                    FROM tb0031_imoveis
                    INNER JOIN tb0202_favoritos ON codigoIMOVEL = imovelFAVORITO 

                    WHERE usuarioFAVORITO = " . $usuario . "
                ...
                <div class="col-md-6 col-xxl-3 mb-6">
                  <div class="card shadow-hover-1">
                    <div class="hover-change-image bg-hover-overlay rounded-lg card-img-top">
                      <img src="images/properties-grid-06.jpg" alt="Home in Metric Way">
                      <div class="card-img-overlay p-2 d-flex flex-column">
                        <div>
                          <span class="badge badge-primary">for &nbsp;<?php echo $Imovel['tipoIMOVEL'];?></span>
                        </div>
                    ...
                    <div class="card-body pt-3">
                      <h2 class="card-title fs-16 lh-2 mb-0"><a href="single-property-1.html"
                          class="text-dark hover-primary"><?php echo $Imovel['tituloIMOVEL'];?></a>
                      </h2>
                      <p class="card-text font-weight-500 text-gray-light mb-2"><?php echo $Imovel['numeroIMOVEL'];?>&nbsp;<?php echo $Imovel['enderecoIMOVEL'];?>&nbsp;, <?php echo $Imovel['cityIMOVEL'];?></p>
                      <ul class="list-inline d-flex mb-0 flex-wrap">
                        ...
                        <li class="list-inline-item text-gray font-weight-500 fs-13 d-flex align-items-center px-1 mr-2"
                          ...
                          <?php echo $Imovel['metragemIMOVEL'];?>&nbsp;Sq.Ft
                        </li>
                        <li class="list-inline-item text-gray font-weight-500 fs-13 d-flex align-items-center mr-2"

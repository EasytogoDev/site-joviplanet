...
<html lang="en">
  <head>
    ...
    <title>My Messages- Joviplanet</title>
    <!-- Google fonts -->
        ...
        <div class="page-content">
          ...
          <main id="content" class="bg-gray-01">
            <div class="px-3 px-lg-6 px-xxl-13 py-5 py-lg-10">
              <div class="mb-6">
                <h2 class="mb-0 text-heading fs-22 lh-15">Mensages<span
                class="badge badge-white badge-pill text-primary fs-18 font-weight-bold ml-2">29</span>
                </h2>
                <p class="mb-1">Veja suas mensagens do portal</p>
              </div>
              <div class="card border-0 mb-4">
                <div class="card-body p-0 p-sm-8 p-4">
                  <h3 class="fs-16 lh-2 text-heading mb-0 d-inline-block pr-4 border-bottom border-primary">5 Mensagens</h3>
                  ...
                  $sql_Imovel = "
                    ...
                    ORDER BY codigoIMOVEL ASC LIMIT " . $inicio . ", " . $limite;

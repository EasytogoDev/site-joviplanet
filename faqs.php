  ...
  <body>
    ...
    <main id="content">
      <section class="pt-4 pt-lg-12">
        ...
        <h2 class="fs-32 lh-16 mb-8 text-dark text-center">Frequently Asked Questions</h2>
            ...
            <div id="collapse-tabs-accordion-01">
              <div class="tab-pane tab-pane-parent fade show active container " id="selling1" role="tabpanel">
                <div class="card border-0 bg-transparent">
                  ...
                  <div id="selling-collapse-01" class="collapse show collapsible"
              ...
              <div class="tab-pane tab-pane-parent fade container" id="renting1" role="tabpanel">
                <div class="card border-0 bg-transparent">
                  ...
                  <div id="renting-collapse-01" class="collapse collapsible"
              ...
              <div class="tab-pane tab-pane-parent fade container" id="question1" role="tabpanel">
                <div class="card border-0 bg-transparent">
                  ...
                  <div id="other-collapse-01" class="collapse collapsible"
      ...
      <section class="pt-12">
        ...
        <div class="collapse-tabs">
          <ul class="tabs-02 nav nav-pills d-none d-md-flex justify-content-center text-uppercase"
            role="tablist">
            <li class="nav-item">
              <a href="#selling2"
                   class="nav-link btn btn-lg rounded-0 mx-2 bg-gray-01 text-heading"
                   data-toggle="tab" role="tab">
                Question about selling
              </a>
            </li>
            <li class="nav-item">
              <a href="#renting2" class="nav-link active rounded-0 btn btn-lg mx-2 bg-gray-01 text-heading"
                   data-toggle="tab" role="tab">
                Question about renting
              </a>
            </li>
            <li class="nav-item dropdown">
              <a href="#question2"
                   class="nav-link btn btn-lg mx-2 rounded-0 bg-gray-01 text-heading"
                   data-toggle="tab" role="tab">
                Other question
              </a>
            </li>
          </ul>
          <div class="tab-content shadow-none rounded-0 pt-9 pb-12 px-0">
            <div id="collapse-tabs-accordion-02">
              <div class="tab-pane tab-pane-parent fade container" id="selling2" role="tabpanel">
                <div class="card border-0 bg-transparent">
                  <div class="card-header border-0 d-block d-md-none bg-transparent px-0 py-1"
                             id="headingSelling-02">
                    <h5 class="mb-0">
                      <button class="btn lh-2 fs-20 py-1 px-6 w-100 collapse-parent bg-gray-01 collapsed"
                                        data-toggle="collapse"
                  ...
                  <div id="selling-collapse-02" class="collapse collapsible"
                             aria-labelledby="headingSelling-02"
                             data-parent="#collapse-tabs-accordion-02">
                    <div class="row">
                      <div class="col-md-6 mb-6 mb-md-0">
                        <div id="accordion-style-02" class="accordion accordion-02 my-7 mt-md-0">
                          <div class="card border-top-0 border-right-0 border-left-0 border-bottom rounded-0 pb-5 mb-4 pl-7 pr-5 position-relative">
                            <div class="card-header border-0 bg-white p-0" id="heading_19">
                              <h5 class="mb-0">
                                <button class="btn btn-link fs-18 fs-md-22 font-weight-500 p-0 border-0"
                                                            data-toggle="collapse"
                                                            data-target="#collapse_19" aria-expanded="true"
                                                            aria-controls="collapse_19">
                                  How can we help?
                                </button>
                              </h5>
                            </div>
                            <div id="collapse_19" class="collapse show" aria-labelledby="heading_19"
                          ...
                          <div class="card border-top-0 border-right-0 border-left-0 border-bottom rounded-0 pb-5 mb-4 pl-7 pr-5 position-relative">
                            <div class="card-header border-0 bg-white p-0" id="heading_20">
                              <h5 class="mb-0">
                                <button class="btn btn-link fs-18 fs-md-22 font-weight-500 p-0 border-0 collapsed"
                                                            data-toggle="collapse"
                                                            data-target="#collapse_20" aria-expanded="true"
                          ...
                          <div class="card border-top-0 border-right-0 border-left-0 border-bottom rounded-0 pb-5 mb-4 pl-7 pr-5 position-relative">
                            <div class="card-header border-0 bg-white p-0" id="heading_21">
                              <h5 class="mb-0">
                                <button class="btn btn-link fs-18 fs-md-22 font-weight-500 p-0 border-0 collapsed"
                                                            data-toggle="collapse"
                                                            data-target="#collapse_21" aria-expanded="true"
                          ...
                          <div class="card border-top-0 border-right-0 border-left-0 border-bottom rounded-0 pb-5 mb-4 pl-7 pr-5 position-relative">
                            <div class="card-header border-0 bg-white p-0" id="heading_22">
                              <h5 class="mb-0">
                                <button class="btn btn-link fs-18 fs-md-22 font-weight-500 p-0 border-0 collapsed"
                                                            data-toggle="collapse"
                                                            data-target="#collapse_22" aria-expanded="true"
                      ...
                      <div class="col-md-6 mb-6 mb-md-0">
                        <div class="card border-0 pl-lg-6">
                          <img src="images/faqs.jpg" alt="FAQs" class="card-img">
              ...
              <div class="tab-pane fade container tab-pane-parent show active" id="renting2" role="tabpanel">
                <div class="card border-0 bg-transparent">
                  <div class="card-header border-0 d-block d-md-none bg-transparent px-0 py-1"
                             id="headingRenting-02">
                    <h5 class="mb-0">
                      <button class="btn lh-2 fs-20 py-1 px-6 w-100 collapse-parent bg-gray-01"
                                        data-toggle="collapse"
                  ...
                  <div id="renting-collapse-02" class="collapse show collapsible"
                             aria-labelledby="headingRenting-02"
                             data-parent="#collapse-tabs-accordion-02">
                    <div class="row">
                      <div class="col-md-6 mb-6 mb-md-0">
                        <div id="accordion-style-02-1" class="accordion accordion-02 my-7 mt-md-0">
                          <div class="card border-top-0 border-right-0 border-left-0 border-bottom rounded-0 pb-5 mb-4 pl-7 pr-5 position-relative">
                            <div class="card-header border-0 bg-white p-0" id="heading_23">
                              <h5 class="mb-0">
                                <button class="btn btn-link fs-18 fs-md-22 font-weight-500 p-0 border-0"
                                                            data-toggle="collapse"
                            ...
                            <div id="collapse_23" class="collapse show" aria-labelledby="heading_23"
                          ...
                          <div class="card border-top-0 border-right-0 border-left-0 border-bottom rounded-0 pb-5 mb-4 pl-7 pr-5 position-relative">
                            <div class="card-header border-0 bg-white p-0" id="heading_24">
                              <h5 class="mb-0">
                                <button class="btn btn-link fs-18 fs-md-22 font-weight-500 p-0 border-0 collapsed"
                                                            data-toggle="collapse"
                            ...
                            <div id="collapse_24" class="collapse" aria-labelledby="heading_24"
                                                 data-parent="#accordion-style-02-1">
                              <div class="card-body px-0 pt-2 pb-1 lh-214">
                                Lorem ipsum dolor sit amet, consectetur cing elit. Suspe ndisse
                                suscipit
                          ...
                          <div class="card border-top-0 border-right-0 border-left-0 border-bottom rounded-0 pb-5 mb-4 pl-7 pr-5 position-relative">
                            <div class="card-header border-0 bg-white p-0" id="heading_25">
                              <h5 class="mb-0">
                                <button class="btn btn-link fs-18 fs-md-22 font-weight-500 p-0 border-0 collapsed"
                                                            data-toggle="collapse"
                            ...
                            <div id="collapse_25" class="collapse" aria-labelledby="heading_25"
                                                 data-parent="#accordion-style-02-1">
                              <div class="card-body px-0 pt-2 pb-1 lh-214">
                                Lorem ipsum dolor sit amet, consectetur cing elit. Suspe ndisse
                                suscipit
                          ...
                          <div class="card border-top-0 border-right-0 border-left-0 border-bottom rounded-0 pb-5 mb-4 pl-7 pr-5 position-relative">
                            <div class="card-header border-0 bg-white p-0" id="heading_26">
                              <h5 class="mb-0">
                                <button class="btn btn-link fs-18 fs-md-22 font-weight-500 p-0 border-0 collapsed"
                                                            data-toggle="collapse"
                            ...
                            <div id="collapse_26" class="collapse" aria-labelledby="heading_26"
                                                 data-parent="#accordion-style-02-1">
                              <div class="card-body px-0 pt-2 pb-1 lh-214">
                                Lorem ipsum dolor sit amet, consectetur cing elit. Suspe ndisse
                                suscipit
              ...
              <div class="tab-pane fade container tab-pane-parent" id="question2" role="tabpanel">
                <div class="card border-0 bg-transparent">
                  <div class="card-header border-0 d-block d-md-none bg-transparent px-0 py-1"
                             id="headingOther-02">
                    <h5 class="mb-0">
                  ...
                  <div id="other-collapse-02" class="collapse collapsible"
                             aria-labelledby="headingOther-02"
                             data-parent="#collapse-tabs-accordion-02">
                    <div class="row">
                      <div class="col-md-6 mb-6 mb-md-0">
                        <div id="accordion-style-02-2" class="accordion accordion-02 my-7 mt-md-0">
                          <div class="card border-top-0 border-right-0 border-left-0 border-bottom rounded-0 pb-5 mb-4 pl-7 pr-5 position-relative">
                            <div class="card-header border-0 bg-white p-0" id="heading_27">
                              <h5 class="mb-0">
                                <button class="btn btn-link fs-18 fs-md-22 font-weight-500 p-0 border-0"
                                                            data-toggle="collapse"
                            ...
                            <div id="collapse_27" class="collapse show" aria-labelledby="heading_27"
                          ...
                          <div class="card border-top-0 border-right-0 border-left-0 border-bottom rounded-0 pb-5 mb-4 pl-7 pr-5 position-relative">
                            <div class="card-header border-0 bg-white p-0" id="heading_28">
                              <h5 class="mb-0">
                                <button class="btn btn-link fs-18 fs-md-22 font-weight-500 p-0 border-0 collapsed"
                                                            data-toggle="collapse"
                            ...
                            <div id="collapse_28" class="collapse" aria-labelledby="heading_28"
                                                 data-parent="#accordion-style-02-2">
                              <div class="card-body px-0 pt-2 pb-1 lh-214">
                                Lorem ipsum dolor sit amet, consectetur cing elit. Suspe ndisse
                                suscipit
                          ...
                          <div class="card border-top-0 border-right-0 border-left-0 border-bottom rounded-0 pb-5 mb-4 pl-7 pr-5 position-relative">
                            <div class="card-header border-0 bg-white p-0" id="heading_29">
                              <h5 class="mb-0">
                                <button class="btn btn-link fs-18 fs-md-22 font-weight-500 p-0 border-0 collapsed"
                                                            data-toggle="collapse"
                            ...
                            <div id="collapse_29" class="collapse" aria-labelledby="heading_29"
                                                 data-parent="#accordion-style-02-2">
                              <div class="card-body px-0 pt-2 pb-1 lh-214">
                                Lorem ipsum dolor sit amet, consectetur cing elit. Suspe ndisse
                                suscipit
                          ...
                          <div class="card border-top-0 border-right-0 border-left-0 border-bottom rounded-0 pb-5 mb-4 pl-7 pr-5 position-relative">
                            <div class="card-header border-0 bg-white p-0" id="heading_30">
                              <h5 class="mb-0">
                                <button class="btn btn-link fs-18 fs-md-22 font-weight-500 p-0 border-0 collapsed"
                                                            data-toggle="collapse"
                            ...
                            <div id="collapse_30" class="collapse" aria-labelledby="heading_30"
                                                 data-parent="#accordion-style-02-2">
                              <div class="card-body px-0 pt-2 pb-1 lh-214">
                                Lorem ipsum dolor sit amet, consectetur cing elit. Suspe ndisse
                                suscipit

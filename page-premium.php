...
<body>
  ...
  <main id="content">
    <section class="pt-4 page-title shadow">
      <div class="container container-xxl">
      <h1 class="fs-30 lh-1 mb-0 text-heading font-weight-600 pt-15"><?php echo $Categorias['nomeCATEGORIA'];?></h1>  
...
<div class="col-xxl-3 col-lg-4 col-md-6 mb-7 px-2" data-animate="fadeInUp">
         ...
         <!------>
              ...
              <div class="card-body pt-3 px-0 pb-1">
                <h2 class="fs-16 mb-1"><a href="/page-final/<?php echo $imovel['codigoIMOVEL'];?>/<?php echo $imovel['slugIMOVEL'];?>" class="text-dark hover-primary"><?php echo $imovel['tituloIMOVEL'];?></a></h2>
                ...
                <p class="fs-17 font-weight-bold text-heading mb-1">
                  $ &nbsp <?php echo $imovel['valorIMOVEL'];?>
                </p>
                <ul class="list-inline mb-0">

...
<html lang="en">
  <head>
    ...
    <title>My Plans - Joviplanet</title>
    <!-- Google fonts -->
            ...
            <div class="px-3 px-lg-6 px-xxl-13 py-5 py-lg-10">
              <div class="d-flex flex-wrap flex-md-nowrap mb-6">
                <div class="mr-0 mr-md-auto">
                  <h2 class="mb-0 text-heading fs-22 lh-15">My Plans<span
                ...
                <div style="display: flex;">
                  <div>
                    <a href="add-new-plans" class="btn btn-primary btn-lg">
                  ...
                  <div style="margin-left: 20px;"> <!-- Espaço entre as duas divs -->
                    <form class="form">
              ...
              <div class="table-responsive">
                <table class="table table-hover border rounded-lg mb-6 bg-white">
                  <thead class="thead-sm thead-black">
                    <tr>
                      <th scope="col" class="border-top-0 px-6 pt-5 pb-4">Plans</th>
                      <th scope="col" class="border-top-0 pt-5 pb-4">Type Plan</th>
                      <th scope="col" class="border-top-0 pt-5 pb-4">Price</th>
                      <th scope="col" class="border-top-0 pt-5 pb-4">N° Highlights</th>
                      <th scope="col" class="border-top-0 pt-5 pb-4">Period</th>
                      <th scope="col" class="border-top-0 pt-5 pb-4">Destaque</th>
...
INNER JOIN tb0159_periodos ON tempoPLANO = planoPERIODO
WHERE ativoTIPOPLANO = 1 AND ativoPLANO = 1;
LIMIT ".$limite.", ".$inicio;
  ...
  ?>
                    <tr class="shadow-hover-xs-2 bg-hover-white">
                      <td class="align-middle p-6">
                        <a href="#"
                           class="text-dark font-weight-500 hover-primary pt-1"><?php echo $Imovel['nomePLANO']; ?></a>
                      </td>
                      <td class="align-middle"><?php echo $Imovel['planoTIPOPLANO']; ?></a></td>
                      <td class="align-middle"><?php echo $Imovel['valorPLANO']; ?></td>
                      <td class="align-middle"><?php echo $Imovel['quantidadePLANO']; ?></td>
                      <td class="align-middle"><?php echo $Imovel['nomePERIODO']; ?></td>
                      <!----------------------------botão-switch------------------------------------------->
                      <td class="align-middle">
                        <label class="form-switch">
                        <input type="checkbox" <?php if($Imovel['destaquePLANO'] == 1) { echo 'checked'; } ?> onClick="AtivaDesativaPlano('<?php echo $Imovel['destaquePLANO']; ?>', '<?php echo $Imovel['codigoPLANO']; ?>')">

                          <i></i>
                          
                        </label>

                        <?php if($Imovel['destaquePLANO']==1){  ?>
                      ...
                      <td class="align-middle">
                        <a href="/edit-plans/<?php echo $Imovel['codigoPLANO']; ?>" data-toggle="tooltip" title="Edit" class="d-inline-block fs-18 text-muted hover-primary mr-5"><i
                                class="fal fa-pencil-alt"></i></a>
                        <a href="javascript:;" data-toggle="tooltip" title="Delete" class="d-inline-block fs-18 text-muted hover-primary" onClick="DeletePlano('<?php echo $Imovel['codigoPLANO']; ?>');">
                        <i
    ...
    <script>
      function DeletePlano(CODIGO){
        ...
        if (confirm("Tem certeza que deseja apagar o registro?")) { 
          ...
          $.ajax({
        url: '/require/ajax/my-plans/delete.php',
        type: 'post',
        data: {
          codigoPLANO: CODIGO
      ...
      function AtivaDesativaPlano(VALOR,CODIGO) {      


        $.ajax({
          url: '/require/ajax/ativadesativaplano.php',
          type: 'post',
          data: { 
          ativo: VALOR,
          codigo: CODIGO 
          ...
          success: function (data) {
            ...
            alert('Destaque do plano alterado com sucesso!');

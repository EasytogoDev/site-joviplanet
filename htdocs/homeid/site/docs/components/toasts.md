...
{% endcapture %}
{% include docs/example.html content=example class="bg-light p-4" %}
...
{% endcapture %}
{% include docs/example.html content=example class="bg-dark p-4" %}
...
<div aria-live="polite" aria-atomic="true" style="position: relative; min-height: 200px;">
  <div class="toast show fade" style="position: absolute; top: 0; right: 0;">
    <div class="toast-header">
      {% include icons/placeholder.svg width="20" height="20" background="#007aff" class="rounded mr-2" text=" " title=" " %}
      <strong class="mr-auto">Bootstrap</strong>
      <small>11 mins ago</small>
...
{% highlight html %}
<div class="toast show fade" role="alert" aria-live="polite" aria-atomic="true" data-delay="10000">
...
{% capture example %}
<div role="alert" aria-live="assertive" aria-atomic="true" class="toast show fade" data-autohide="false">
  <div class="toast-header">
    {% include icons/placeholder.svg width="20" height="20" background="#007aff" class="rounded mr-2" text=" " title=" " %}
    <strong class="mr-auto">Bootstrap</strong>
    <small>11 mins ago</small>

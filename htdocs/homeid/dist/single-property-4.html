...
<html lang="en">
  <head>
    ...
    <title>Single Property 4 - HomeID</title>
    <!-- Google fonts -->
    ...
    <meta name="twitter:title" content="Single Property 4">
    <meta name="twitter:description" content="Real Estate Html Template">
    <meta name="twitter:image" content="images/homeid-social-logo.png">
    <!-- Facebook -->
    <meta property="og:url" content="single-property-4.html">
    <meta property="og:title" content="Single Property 4">
  ...
  <body>
    ...
    <main id="content">
      <section>
        <div class="container">
          <form class="property-search position-relative d-none d-lg-block">
            <div class="row align-items-center ml-lg-0 py-lg-0 shadow-sm-2 rounded bg-white position-lg-absolute top-lg-n50px py-lg-0 py-6 px-3 z-index-1 w-md-100"
			     data-animate="fadeInDown" id="accordion-3">
              ...
              <div id="advanced-search-filters-3" class="col-12 py-sm-4 order-4 order-sm-5 collapse"
                ...
                <div class="row">
                  <div class="col-sm-6 col-lg-3 pt-6">
                    ...
                    <select class="form-control selectpicker bg-transparent border-bottom rounded-0 border-color-input" name="bedroom"
                  ...
                  <div class="col-sm-6 col-lg-3 pt-6">
                    ...
                    <select class="form-control selectpicker bg-transparent border-bottom rounded-0 border-color-input" name="city"
                  ...
                  <div class="col-sm-6 col-lg-3 pt-6">
                    ...
                    <select class="form-control selectpicker bg-transparent border-bottom rounded-0 border-color-input" name="areas"
                ...
                <div class="row pt-2">
                  ...
                  <div class="collapse row mx-0 w-100" id="other-feature-3">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 py-2">
                      <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="check10-3" name="features[]">
                        <label class="custom-control-label" for="check10-3">Microwave</label>
                      </div>
                    </div>
                    <div class="col-sm-6 col-md-4 col-lg-3 py-2">
                      <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="check11-3" name="features[]">
                        <label class="custom-control-label" for="check11-3">Swimming Pool</label>
                      </div>
                    </div>
                    <div class="col-sm-6 col-md-4 col-lg-3 py-2">
                      <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="check12-3" name="features[]">
                        <label class="custom-control-label" for="check12-3">Window Coverings</label>
                      </div>
                    </div>
                    <div class="col-sm-6 col-md-4 col-lg-3 py-2">
                      <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="check13-3" name="features[]">
                        <label class="custom-control-label" for="check13-3">Gym</label>
                      </div>
                    </div>
                    <div class="col-sm-6 col-md-4 col-lg-3 py-2">
                      <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="check14-3" name="features[]">
                        <label class="custom-control-label" for="check14-3">Outdoor Shower</label>
                      </div>
                    </div>
                    <div class="col-sm-6 col-md-4 col-lg-3 py-2">
                      <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="check15-3" name="features[]">
                        <label class="custom-control-label" for="check15-3">TV Cable</label>
                      </div>
                    </div>
                    <div class="col-sm-6 col-md-4 col-lg-3 py-2">
                      <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="check16-3" name="features[]">
      ...
      <section>
        <div class="mapbox-gl map-grid-property-01" id="map" style="height: 600px" data-marker-target="#template-properties"
          ...
          <div class="box">
            <div class="card shadow-hover-2">
              ...
              <div class="card-body pt-3">
                ...
                <p class="card-text font-weight-500 text-gray-light mb-5">1421 San Pedro St, Los Angeles</p>
                <ul class="list-inline d-flex mb-0 flex-wrap mr-n2">
    ...
    <div class="d-none" id="template-properties">
      <div class="marker-item" data-icon-marker="images/googlle-market-01.png"
	     data-position="[-73.9927227, 40.6734035]"
	     data-marker-style='{"className":"marker","style":{"width":"30px","height":"40px"},"popup":{"className":"popup-map-property","maxWidth":"269px"}}'>
        <div class="card border-0 ">
          <div class="position-relative hover-change-image bg-hover-overlay card-img-top"><img
            ...
            <div class="card-body px-2 py-1">
              <h2 class="fs-16 mb-1"><a href="single-property-1.html"
			                                                           class="text-dark hover-primary">Home in Metric
                  Way</a></h2>

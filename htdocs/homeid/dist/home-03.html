  ...
  <body>
    ...
    <main id="content">
      ...
      <section class="d-flex flex-column">
        <div class="bg-cover text-center d-flex align-items-center justify-content-center flex-column custom-vh-03" style="background-image: url('images/bg-home-03.jpg')">
          <p class="fs-md-45 fs-30 text-white font-weight-light mb-0 lh-15 pt-8" data-animate="zoomIn">Find your</p>
          <h2 class="text-white display-1 lh-1 mb-0" data-animate="zoomIn">Dream home</h2>
          <img src="images/signature.png" class="pl-md-17 ml-md-17 mr-md-n8" alt="Dream home" data-animate="zoomIn">
          <p class="font-weight-500 text-white fs-15 mb-6 mt-3 pb-1" data-animate="zoomIn">Than 10,000 customers buy or sell a home with us each year.</p>
          <a href="#" class="btn btn-lg btn-primary font-weight-600 rounded-lg mb-8" data-animate="zoomIn">Find out more<i class="far fa-long-arrow-right ml-2"></i></a>
        </div>
      </section>
      <section class="py-11">
        <div class="container">
          <p class="text-primary font-weight-500 letter-spacing-263 text-center text-uppercase mb-5">Popular Properties</p>
          <h2 class="text-dark text-center mb-8">Check Out Our Popular Properties</h2>
          <div class="row">
            ...
            <div class="col-lg-4 col-sm-6 mb-6" data-animate="zoomIn">
              <div class="card shadow-hover-1">
                ...
                <div class="card-footer bg-transparent d-flex justify-content-between align-items-center py-3">
                  <p class="fs-17 font-weight-bold text-heading mb-0">$550<span class="fs-14 font-weight-500"> / month</span></p>
                  <ul class="list-inline mb-0">
                    <li class="list-inline-item">
                      <a href="#" class="w-40px h-40 border rounded-circle d-inline-flex align-items-center justify-content-center text-body hover-secondary bg-hover-accent border-hover-accent" data-toggle="tooltip" title="Wishlist"><i class="far fa-heart"></i></a>
                    </li>
            ...
            <div class="col-lg-4 col-sm-6 mb-6" data-animate="zoomIn">
              <div class="card shadow-hover-1">
                <div class="hover-change-image bg-hover-overlay rounded-lg card-img-top">
                  <img src="images/properties-grid-39.jpg" alt="Villa on Hollywood Boulevard">
                  <div class="card-img-overlay p-2 d-flex flex-column">
                    <div>
                      <span class="badge mr-2 badge-orange">Featured</span>
                      <span class="badge mr-2 badge-indigo">For Rent</span>
                ...
                <div class="card-body pt-3">
                  <h2 class="card-title fs-16 lh-2 mb-0"><a href="single-property-1.html" class="text-dark hover-primary">Villa on Hollywood Boulevard</a></h2>
                  <p class="card-text font-weight-500 text-gray-light mb-2">1421 San Pedro St, Los Angeles</p>
                  <ul class="list-inline d-flex justify-content-between mb-0 flex-wrap mr-n5">
                    <li class="list-inline-item text-gray font-weight-500 fs-13 d-flex align-items-center mr-5" data-toggle="tooltip" title="3 Bedroom"><svg class="icon icon-bedroom fs-18 text-primary mr-1"><use xlink:href="#icon-bedroom"></use></svg>3 Br</li>
                    <li class="list-inline-item text-gray font-weight-500 fs-13 d-flex align-items-center mr-5" data-toggle="tooltip" title="3 Bathrooms"><svg class="icon icon-shower fs-18 text-primary mr-1"><use xlink:href="#icon-shower"></use></svg>3 Ba</li>
                ...
                <div class="card-footer bg-transparent d-flex justify-content-between align-items-center py-3">
                  <p class="fs-17 font-weight-bold text-heading mb-0">$5.700<span class="fs-14 font-weight-500"> / year</span></p>
                  <ul class="list-inline mb-0">
                    <li class="list-inline-item">
                      <a href="#" class="w-40px h-40 border rounded-circle d-inline-flex align-items-center justify-content-center text-body hover-secondary bg-hover-accent border-hover-accent" data-toggle="tooltip" title="Wishlist"><i class="far fa-heart"></i></a>
                    </li>
            ...
            <div class="col-lg-4 col-sm-6 mb-6" data-animate="zoomIn">
              <div class="card shadow-hover-1">
                <div class="hover-change-image bg-hover-overlay rounded-lg card-img-top">
                  <img src="images/properties-grid-03.jpg" alt="Home in Metric Way">
                  <div class="card-img-overlay p-2 d-flex flex-column">
                    <div>
                      <span class="badge mr-2 badge-indigo">For Rent</span>
                    </div>
          ...
          <div class="text-center">
            <a href="listing-grid-with-left-filter.html" class="btn btn-lg text-secondary btn-accent rounded-lg mt-4">+2300 Available Properties
              <i class="far fa-long-arrow-right ml-1"></i>
            </a>
          </div>
        </div>
      </section>
      <section class="bg-gray-02 pt-12 pb-8">
        <div class="container">
          <h2 class="text-heading lh-184 mxw-571 text-center fs-26 pb-2">Looking to Buy a new property or Sell an
            existing one?</h2>
          ...
          <div class="slick-slider arrow-haft-inner mx-0"
            ...
            <div class="box px-0 py-6" data-animate="fadeInUp">
              <a href="listing-with-left-sidebar.html"
				   class="card border-0 align-items-center justify-content-center pt-7 pb-5 px-3 shadow-hover-3 bg-transparent bg-hover-white text-decoration-none">
                <img src="images/town.png" class="card-img-top" alt="Apartment">
                <div class="card-body px-0 pt-5 pb-0">
                  <h4 class="card-title fs-16 lh-2 text-dark mb-0">Apartment</h4>
                </div>
              </a>
      ...
      <section class="pt-lg-12 my-lg-1 py-11">
        <div class="container">
          <p class="text-primary font-weight-500 letter-spacing-263 text-center text-uppercase mb-5" data-animate="fadeInLeft">Featured Properties</p>
          <h2 class="text-dark text-center mb-8 pb-lg-1" data-animate="fadeInLeft">Check Out Our Featured Items</h2>
          <div class="slick-slider mx-0 custom-arrow-spacing-30" data-animate="fadeInRight"
		     data-slick-options='{"slidesToShow": 1,"dots":false,"responsive":[{"breakpoint": 992,"settings": {"slidesToShow":1,"arrows":false}},{"breakpoint": 768,"settings": {"slidesToShow": 1,"arrows":false,"autoplay":true}},{"breakpoint": 576,"settings": {"slidesToShow": 1,"arrows":false}}]}'>
            <div class="box px-0">
              <div class="media d-flex flex-column flex-md-row align-items-md-center py-lg-8 position-relative cusstom-bg-slider-gray no-gutters">
                <div class="mr-lg-10 mr-md-6 card border-0 col-md-6">
                  <img src="images/properties-slider-01.jpg" class="card-img"
                ...
                <div class="media-body mt-3 mt-lg-0 pr-lg-9">
                  <h2 class="my-0"><a href="single-property-1.html" class="fs-26 lh-2 text-dark hover-primary">Villa in Coral Gables</a></h2>
                  <p class="mb-2 fs-16 font-weight-500 text-gray-light lh-1">Stourbridge, West Midlands, DY9 9TA</p>
                  <p class="mb-2 ml-0 pr-lg-3">Lorem ipsum dolor sit amet, consec tetur cing elit. Suspeor sit amet, cons ndisse suscorem ipsum dolor sit.</p>
                  ...
                  <div class="d-flex justify-content-between pt-5 border-top">
                    <p class="fs-20 font-weight-bold text-heading mb-1">$1.250.000</p>
                    <ul class="list-inline mb-0 d-flex justify-content-end align-items-end h-100 hover-image">
                      <li class="list-inline-item mr-5">
                        <a href="#" class="text-body fs-20 hover-primary" data-toggle="tooltip" title="Wishlist">
                          <i class="far fa-heart"></i>
                        </a>
                      </li>
                      <li class="list-inline-item">
                        <a href="#" class="text-body fs-20 hover-primary" data-toggle="tooltip" title="Compare">
            ...
            <div class="box px-0">
              <div class="media d-flex flex-column flex-md-row align-items-md-center py-lg-8 position-relative cusstom-bg-slider-gray no-gutters">
                <div class="mr-lg-10 mr-md-6 card border-0 col-md-6">
                  <img src="images/properties-slider-02.jpg" class="card-img"
                ...
                <div class="media-body mt-3 mt-lg-0 pr-lg-9">
                  <h2 class="my-0"><a href="single-property-1.html" class="fs-26 lh-2 text-dark hover-primary">Home in Metric Way</a></h2>
                  <p class="mb-2 fs-16 font-weight-500 text-gray-light lh-1">Stourbridge, West Midlands, DY9 9TA</p>
                  <p class="mb-2 ml-0 pr-lg-3">Lorem ipsum dolor sit amet, consec tetur cing elit. Suspeor sit amet, cons ndisse suscorem ipsum dolor sit.</p>
                  <ul class="row list-inline mb-0 py-3">
                    <li class="col-sm-6">
            ...
            <div class="box px-0">
              <div class="media d-flex flex-column flex-md-row align-items-md-center py-lg-8 position-relative cusstom-bg-slider-gray no-gutters">
                <div class="mr-lg-10 mr-md-6 card border-0 col-md-6">
                  <img src="images/properties-slider-03.jpg" class="card-img"
                ...
                <div class="media-body mt-3 mt-lg-0 pr-lg-9">
                  <h2 class="my-0"><a href="single-property-1.html" class="fs-26 lh-2 text-dark hover-primary">Affordable Urban House</a></h2>
                  <p class="mb-2 fs-16 font-weight-500 text-gray-light lh-1">Stourbridge, West Midlands, DY9 9TA</p>
                  <p class="mb-2 ml-0 pr-lg-3">Lorem ipsum dolor sit amet, consec tetur cing elit. Suspeor sit amet, cons ndisse suscorem ipsum dolor sit.</p>
                  <ul class="row list-inline mb-0 py-3">
                    <li class="col-sm-6">
              ...
              <div class="slick-slider custom-arrow-spacing-30"
                ...
                <div class="card border-0">
                  <a href="single-property-1.html" class="hover-zoom-in d-block">
                    <img src="images/properties-city-11.jpg" class="card-img" alt="Los Angeles">
                  </a>
                  <div class="card-body p-0 mt-2">
                    <h2 class="mb-0"><a href="single-property-1.html" class="text-dark hover-primary fs-16 lh-2 ">Los Angeles</a></h2>
                    <p class="font-weight-500 text-gray-light mb-0">12 Properties</p>
                  </div>
                </div>
                <div class="card border-0">
                  <a href="single-property-1.html" class="hover-zoom-in d-block">
                    <img src="images/properties-city-12.jpg" class="card-img" alt="New York">
                  </a>
                  <div class="card-body p-0 mt-2">
                    <h2 class="mb-0"><a href="single-property-1.html" class="text-dark hover-primary fs-16 lh-2 ">New York</a></h2>
                    <p class="font-weight-500 text-gray-light mb-0">24 Properties</p>
                  </div>
                </div>
                <div class="card border-0">
                  <a href="single-property-1.html" class="hover-zoom-in d-block">
                    <img src="images/properties-city-13.jpg" class="card-img" alt="Sacramento">
                  </a>
                  <div class="card-body p-0 mt-2">
                    <h2 class="mb-0"><a href="single-property-1.html" class="text-dark hover-primary fs-16 lh-2 ">Sacramento</a></h2>
                    <p class="font-weight-500 text-gray-light mb-0">24 Properties</p>
                  </div>
                </div>
                <div class="card border-0">
      ...
      <section class="bg-accent bg-patten-02 py-11 pb-lg-12">
        <div class="container">
          ...
          <span class="heading-divider mx-auto"></span>
          <div class="mt-8 pt-1">
            <div class="slick-slider custom-arrow-spacing-30 mx-md-0"
			     data-slick-options='{"slidesToShow": 3,"arrows":false,"dots":false,"responsive":[{"breakpoint": 992,"settings": {"slidesToShow":3}},{"breakpoint": 768,"settings": {"slidesToShow": 2}},{"breakpoint": 576,"settings": {"slidesToShow": 1,"dots":true}}]}'>
              <div class="box px-md-0" data-animate="fadeInUp">
                <div class="card border-hover bg-transparent bg-hover-white shadow-hover-3 pl-lg-8 pr-lg-6 p-5 hover-change-image">
                  ...
                  <div class="card-body px-0 pt-6 pb-0">
                    <a href="listing-with-left-sidebar.html"
						   class="text-decoration-none d-flex align-items-center"><h4
								class="card-title fs-20 lh-1625 text-dark mb-1">Buy a new home</h4>
                      <span class="ml-2 text-primary fs-42 lh-1 hover-image">
        ...
        <div class="container">
          <div class="row no-gutters">
            <div class="col-sm-6 col-lg-3 mb-6 mb-sm-0 px-6 text-center" data-animate="fadeInUp">
              <div class="counterup fs-56 lh-1 mb-3 pt-2" data-start="0"
					     data-end="1790" data-decimals="0"
					     data-duration="0" data-separator="">1790
              </div>
              <div class="text-uppercase fs-13 lh-184 letter-spacing-163 opacity-7">happy clients</div>
            </div>
            <div class="col-sm-6 col-lg-3 mb-6 mb-sm-0 px-6 text-center" data-animate="fadeInUp">
              <div class="counterup fs-56 lh-1 mb-3 pt-2" data-start="0"
					     data-end="491" data-decimals="0"
					     data-duration="0" data-separator="">491
              </div>
              <div class="text-uppercase fs-13 lh-184 letter-spacing-163 opacity-7">finished projects</div>
            </div>
            <div class="col-sm-6 col-lg-3 mb-6 mb-sm-0 px-6 text-center" data-animate="fadeInUp">
              <div class="counterup fs-56 lh-1 mb-3 pt-2" data-start="0"
					     data-end="245" data-decimals="0"
					     data-duration="0" data-separator="">245
              </div>
            ...
            <div class="col-sm-6 col-lg-3 mb-6 mb-sm-0 px-6 text-center" data-animate="fadeInUp">
              <div class="counterup fs-56 lh-1 mb-3 pt-2" data-start="0"
					     ...
					     data-duration="0" data-separator="">1090
              </div>
              <div class="text-uppercase fs-13 lh-184 letter-spacing-163 opacity-7">posts</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div class="row align-items-center">
            ...
            <div class="col-lg-7" data-animate="fadeInRight">
              <div class="slick-slider custom-vertical mx-0"
				     data-slick-options='{"slidesToShow": 1,"vertical":true,"verticalSwiping":true,"centerMode":true,"swipeToSlide":true,"focusOnSelect":true,"centerPadding":"120px","infinite":true,"autoplay":false,"dots":false,"arrows":false}'>
      ...
      <section class="py-lg-13 pt-11 pb-sm-9 pb-7">
        <div class="container">
          <div class="row">
            <div class="col-lg-4 mt-lg-4" data-animate="fadeInLeft">
              <p class="text-primary font-weight-500 letter-spacing-263 text-uppercase mb-5">Blog & news</p>
              <h2 class="text-dark  mb-7 lh-15">Interesting Articles Updated Daily</h2>
              <ul class="list-unstyled mb-0">
                <li class="pb-3"><a href="blog-details-1.html" class="fs-15 font-weight-500 text-body hover-primary"><i class="fas fa-long-arrow-alt-right mr-2"></i>Opening a new store in NYC</a></li>
                <li class="pb-3"><a href="blog-details-1.html" class="fs-15 font-weight-500 text-body hover-primary"><i class="fas fa-long-arrow-alt-right mr-2"></i>5 Famous Progressive Web Apps</a></li>
                <li class="pb-3"><a href="blog-details-1.html" class="fs-15 font-weight-500 text-body hover-primary"><i class="fas fa-long-arrow-alt-right mr-2"></i>How to Create an Effective Elevator Pitch</a></li>
                <li class="pb-3"><a href="blog-details-1.html" class="fs-15 font-weight-500 text-body hover-primary"><i class="fas fa-long-arrow-alt-right mr-2"></i>Top Strategic Technology Trends for 2020</a></li>
                <li class="pb-3"><a href="blog-details-1.html" class="fs-15 font-weight-500 text-body hover-primary"><i class="fas fa-long-arrow-alt-right mr-2"></i>The Quest for Better Web Accessibility</a></li>
              </ul>
            </div>
            <div class="col-lg-8 mt-6 mt-lg-0" data-animate="fadeInRight">
              <div class="row">
                <div class="card border-0 col-sm-6 mb-sm-0 mb-7">
                  <div class="position-relative d-flex align-items-end card-img">
                    <a href="blog-details-1.html" class="hover-shine">
                      <img src="images/post-03.jpg"
								     alt="Retail banks wake up to digital lending this year">
                    </a>
                    <a href="/#"
							   class="badge pos-fixed-bottom text-white bg-dark-opacity-04 fs-13 font-weight-500 bg-hover-primary hover-white m-2 position-absolute">
                      rental
                    </a>
                  </div>
                  <div class="card-body p-0 pr-xl-8">
                    <ul class="list-inline mt-4 text-gray-lighter">
                    ...
                    <h3 class="fs-18 text-heading lh-194">
                      <a href="blog-details-1.html" class="text-heading hover-primary">Retail banks wake up to digital lending this year</a>
                    </h3>
                    <p class="mb-4">Lorem ipsum dolor sit amet, consecte tur cing elit. Suspe ndisse suscipit sagittis leo sit met condim entum, consecte tur cineoi</p>
                    <a href="blog-details-1.html" class="btn text-secondary btn-accent">Read more <i class="far fa-long-arrow-right ml-1"></i></a>
                  </div>
                </div>
                <div class="card border-0 col-sm-6 mb-sm-0 mb-7">
                  <div class="position-relative d-flex align-items-end card-img">
                    <a href="blog-details-1.html" class="hover-shine">
                      <img src="images/post-04.jpg"
                  ...
                  <div class="card-body p-0 pr-xl-8">
                    ...
                    <h3 class="fs-18 text-heading lh-194">
                      <a href="blog-details-1.html" class="text-heading hover-primary">Within the construction industry as their overdraft</a>
                    </h3>
                    <p class="mb-4">Lorem ipsum dolor sit amet, consecte tur cing elit. Suspe ndisse suscipit sagittis leo sit met condim entum, consecte tur cineoi</p>
                    <a href="blog-details-1.html" class="btn text-secondary btn-accent">Read more <i class="far fa-long-arrow-right ml-1"></i></a>
                  </div>

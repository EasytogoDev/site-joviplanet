            ...
            <div class="row align-items-lg-center" id="accordion-3-mobile">
              ...
              <div id="advanced-search-filters-3-mobile" class="col-12 pt-2 collapse"
                ...
                <div class="row">
                  ...
                  <div class="collapse row mx-0" id="other-feature-3-mobile">
        ...
        <div class="container">
          ...
          <div class="slick-slider custom-arrow-spacing-30"
            ...
            <div class="box">
              <div class="card" data-animate="fadeInUp">
                <div class="hover-change-image bg-hover-overlay rounded-lg card-img-top">
                  <img src="images/properties-grid-21.jpg" alt="Affordable Urban House">
                  <div class="card-img-overlay p-2 d-flex flex-column">
                    <div class="mt-auto d-flex hover-image">
                      <ul class="list-inline mb-0 d-flex align-items-end mr-auto">
                        <li class="list-inline-item mr-2" data-toggle="tooltip" title="9 Images">
            ...
            <div class="box">
              <div class="card" data-animate="fadeInUp">
                <div class="hover-change-image bg-hover-overlay rounded-lg card-img-top">
                  <img src="images/properties-grid-22.jpg" alt="Villa on Hollywood Boulevard">
                  <div class="card-img-overlay p-2 d-flex flex-column">
                    <div class="mt-auto d-flex hover-image">
                      <ul class="list-inline mb-0 d-flex align-items-end mr-auto">
                        <li class="list-inline-item mr-2" data-toggle="tooltip" title="9 Images">
              ...
              <div class="slick-slider custom-arrow-spacing-30"
                ...
                <div class="card border-0 bg-transparent">
                  <a href="single-property-1.html" class="hover-zoom-in d-block">
                    <img src="images/properties-city-11.jpg" class="card-img"
							     alt="Los Angeles">
                  </a>
                ...
                <div class="card border-0 bg-transparent">
                  <a href="single-property-1.html" class="hover-zoom-in d-block">
                    <img src="images/properties-city-12.jpg" class="card-img"
							     alt="New York">
                  </a>
                  <div class="card-body p-0 mt-2">
                    <h2 class="mb-0"><a href="single-property-1.html"
                ...
                <div class="card border-0 bg-transparent">
                  <a href="single-property-1.html" class="hover-zoom-in d-block">
                    <img src="images/properties-city-13.jpg" class="card-img"
							     alt="Sacramento">
                  </a>
                  <div class="card-body p-0 mt-2">
                    <h2 class="mb-0"><a href="single-property-1.html"
            ...
            <div class="box">
              <div class="card p-6" data-animate="fadeInUp">
                <div class="card-body p-0 text-center">
                  ...
                  <img src="images/testimonial-3.jpg" class="rounded-circle d-inline-block mb-2"
						     alt="Lydia Wise">
            ...
            <div class="box">
              <div class="card p-6" data-animate="fadeInUp">
                <div class="card-body p-0 text-center">
                  ...
                  <span class="mx-auto divider mb-5"></span>
                  <img src="images/testimonial-4.jpg" class="rounded-circle d-inline-block mb-2"
						     alt="Olive Erickson">
            ...
            <div class="box">
              <div class="card p-6" data-animate="fadeInUp">
                <div class="card-body p-0 text-center">
                  ...
                  <span class="mx-auto divider mb-5"></span>
                  <img src="images/testimonial-5.jpg" class="rounded-circle d-inline-block mb-2"
						     alt="Carl Knight">
        ...
        <div class="container">
          ...
          <div class="mx-n2">
            <div class="slick-slider mt-6 mx-n1 slick-dots-mt-0"
			     data-slick-options='{"slidesToShow": 3, "autoplay":false,"arrows":false,"dots":false,"responsive":[{"breakpoint": 992,"settings": {"slidesToShow":2}},{"breakpoint": 768,"settings": {"slidesToShow": 2,"autoplay":true}},{"breakpoint": 576,"settings": {"slidesToShow": 1,"arrows":false,"dots":true,"autoplay":true}}]}'>
                ...
                <div class="card border-0 shadow-xxs-3" data-animate="fadeInUp">
                  ...
                  <div class="card-body px-5 pt-3 pb-5">
                    ...
                    <h3 class="fs-18 text-heading lh-194 mb-1">
                      <a href="blog-details-1.html" class="text-heading hover-primary">The Interior Design The Hall On str. Filimonovo</a>
                    </h3>
                    ...
                    <a class="text-heading font-weight-500" href="blog-details-1.html">Learn more <i
              ...
              <div class="item py-4" data-animate="fadeInUp">
                <div class="card border-0 shadow-xxs-3" data-animate="fadeInUp">
                  ...
                  <div class="card-body px-5 pt-3 pb-5">
                    <p class="mb-1 fs-13">Dec 16, 2020</p>
                    <h3 class="fs-18 text-heading lh-194 mb-1">
                      <a href="blog-details-1.html" class="text-heading hover-primary">Future Office Buldings Intelligent by Design</a>
                    </h3>
                    <p class="mb-3">Lorem ipsum dolor sit amet, consectetur cing elit. Suspe ndisse suscipit sagittis leo sit met condimentum estibulum issim</p>
                    <a class="text-heading font-weight-500" href="blog-details-1.html">Learn more <i
									class="far fa-long-arrow-right text-primary ml-1"></i></a>

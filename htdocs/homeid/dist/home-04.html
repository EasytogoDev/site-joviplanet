          ...
          <div class="box px-0 d-flex flex-column">
              ...
              <div class="container">
                <div class="row py-8" data-animate="zoomIn">
                  <div class="col-lg-5 col-md-6 d-md-block d-none">
                    <a href="single-property-1.html" class="d-inline-block"><img
                                    src="images/single-image-05.png" class="rounded-lg"
                                    alt="Villa on Hollywood Boulevard"></a>
                    </div>
                    <div class="col-lg-7 col-md-6">
                      <p class="text-white fs-22 font-weight-500 letter-spacing-367 text-uppercase mt-7 mb-4">For sale</p>
                      <h2 class="lh-12 mb-4"><a href="single-property-1.html"
                                                      class="text-white fs-md-60 fs-48">Villa on Hollywood Boulevard</a></h2>
              ...
              <div class="bg-cover d-flex align-items-center custom-vh-02"
                ...
                <div class="container">
                  <div class="row py-8" data-animate="zoomIn">
                    <div class="col-lg-5 col-md-6 d-md-block d-none">
                      <a href="single-property-1.html" class="d-inline-block"><img
                                    src="images/single-image-06.jpg" class="rounded-lg"
                                    alt="Villa on Hollywood Boulevard"></a>
                      </div>
                      <div class="col-lg-7 col-md-6">
                        <p class="text-white fs-22 font-weight-500 letter-spacing-367 text-uppercase mt-7 mb-4">For sale</p>
                 ...
                 style="background-image: url('images/bg-slider-03.jpg')">
                  <div class="container">
                    <div class="row py-8" data-animate="zoomIn">
                      <div class="col-lg-5 col-md-6 d-md-block d-none">
                        <a href="single-property-1.html" class="d-inline-block"><img
                                    src="images/single-image-07.jpg" class="rounded-lg"
                                    alt="Villa on Hollywood Boulevard"></a>
                        </div>
                        <div class="col-lg-7 col-md-6">
                          <p class="text-white fs-22 font-weight-500 letter-spacing-367 text-uppercase mt-7 mb-4">For sale</p>
              ...
              <div class="container">
                ...
                <div class="row mt-7">
                  <div class="col-sm-6 col-md-4 col-lg-3 mb-6" data-animate="fadeInUp">
                    <div class="media rounded-lg bg-gray-02 px-4 h-100 align-items-center">
                      <img src="images/single-family.png" alt="Type"
                         class="mr-3 my-6 my-sm-0">
                      <div class="media-body">
                        <div class="text-uppercase letter-spacing-02 text-body lh-17">Type</div>
                        <div class="fs-16 lh-15 text-heading letter-spacing-03 font-weight-600">Single Family
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-6 col-md-4 col-lg-3 mb-6" data-animate="fadeInUp">
                    <div class="media rounded-lg bg-gray-02 px-4 h-100 align-items-center">
                      <span class="text-primary fs-64 d-inline-block mr-3">
                        <svg class="icon icon-year"><use
                                        xlink:href="#icon-year"></use></svg>
                      </span>
                      <div class="media-body">
                        <div class="text-uppercase letter-spacing-02 text-body lh-17">year built</div>
                        <div class="fs-16 lh-15 text-heading letter-spacing-03 font-weight-600">2020
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-6 col-md-4 col-lg-3 mb-6" data-animate="fadeInUp">
                    <div class="media rounded-lg bg-gray-02 px-4 h-100 align-items-center">
                      <span class="text-primary fs-64 d-inline-block mr-3">
                        <svg class="icon icon-heating"><use
                                        xlink:href="#icon-heating"></use></svg>
                      </span>
                      <div class="media-body">
                        <div class="text-uppercase letter-spacing-02 text-body lh-17">heating</div>
                        <div class="fs-16 lh-15 text-heading letter-spacing-03 font-weight-600">Radiant
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-6 col-md-4 col-lg-3 mb-6" data-animate="fadeInUp">
                    <div class="media rounded-lg bg-gray-02 px-4 h-100 align-items-center">
                      <span class="text-primary fs-64 d-inline-block mr-3">
                        <svg class="icon icon-price"><use
                                        xlink:href="#icon-price"></use></svg>
                      </span>
                      <div class="media-body">
                        <div class="text-uppercase letter-spacing-02 text-body lh-17">SQFT</div>
                        <div class="fs-16 lh-15 text-heading letter-spacing-03 font-weight-600">979.0
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-6 col-md-4 col-lg-3 mb-6" data-animate="fadeInUp">
                    <div class="media rounded-lg bg-gray-02 px-4 h-100 align-items-center">
                      <span class="text-primary fs-64 d-inline-block mr-3">
                        <svg class="icon icon-bedroom"><use
                                        xlink:href="#icon-bedroom"></use></svg>
                      </span>
                      <div class="media-body">
                        <div class="text-uppercase letter-spacing-02 text-body lh-17">Bedrooms</div>
                        <div class="fs-16 lh-15 text-heading letter-spacing-03 font-weight-600">3
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-6 col-md-4 col-lg-3 mb-6" data-animate="fadeInUp">
                    <div class="media rounded-lg bg-gray-02 px-4 h-100 align-items-center">
                      <img src="images/bath-rooms.png" alt="bathrooms"
                         class="mr-3 my-6 my-sm-0">
                      <div class="media-body">
                        <div class="text-uppercase letter-spacing-02 text-body lh-17">bathrooms</div>
                        <div class="fs-16 lh-15 text-heading letter-spacing-03 font-weight-600">2
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-6 col-md-4 col-lg-3 mb-6" data-animate="fadeInUp">
                    <div class="media rounded-lg bg-gray-02 px-4 h-100 align-items-center">
                      <span class="text-primary fs-64 d-inline-block mr-3">
                        <svg class="icon icon-Garage"><use
                                        xlink:href="#icon-Garage"></use></svg>
                      </span>
                      <div class="media-body">
                        <div class="text-uppercase letter-spacing-02 text-body lh-17">GARAGE</div>
                        <div class="fs-16 lh-15 text-heading letter-spacing-03 font-weight-600">1
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-6 col-md-4 col-lg-3 mb-6" data-animate="fadeInUp">
                    <div class="media rounded-lg bg-gray-02 px-4 h-100 align-items-center">
                      <span class="text-primary fs-64 d-inline-block mr-3">
                        <svg class="icon icon-status"><use
                                        xlink:href="#icon-status"></use></svg>
                      </span>
                      <div class="media-body">
                        <div class="text-uppercase letter-spacing-02 text-body lh-17">Status</div>
                        <div class="fs-16 lh-15 text-heading letter-spacing-03 font-weight-600">Active
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <section>
             ...
             data-slick-options='{"slidesToShow": 1, "autoplay":true,"dots":false,"arrows":false}'>
                  <div class="bg-cover"
                 style="background-image: url(images/properties-slider-11.jpg)" data-animate="zoomIn">
                    <div class="container">
                      <div class="row">
                        <div class="col-lg-6 offset-lg-6 col-md-8 offset-md-4 py-11">
                          <div class="bg-white rounded-lg position-relative z-index-2 pl-sm-13 pr-sm-10 py-sm-9 p-6">
                            <h2 class="mt-2"><a href="single-property-1.html"
                                                    class="text-heading hover-primary">Property amenities</a></h2>
                            <span class="heading-divider"></span>
                            <p class="pt-2">Lorem ipsum dolor sit amet, consec tetur cing elit.</p>
                            <ul class="list-unstyled row no-gutters mb-0">
                              <li class="col-sm-6 mb-2"><i class="far fa-check mr-2 text-primary"></i>Balcony
                              </li>
                              <li class="col-sm-6 mb-2"><i class="far fa-check mr-2 text-primary"></i>Fireplace
                              </li>
                              <li class="col-sm-6 mb-2"><i class="far fa-check mr-2 text-primary"></i>Basement
                              </li>
                              <li class="col-sm-6 mb-2"><i class="far fa-check mr-2 text-primary"></i>Cooling
                              </li>
                              <li class="col-sm-6 mb-2"><i class="far fa-check mr-2 text-primary"></i>Dining
                              </li>
                              <li class="col-sm-6 mb-2"><i class="far fa-check mr-2 text-primary"></i>Dishwasher
                              </li>
                              <li class="col-sm-6 mb-2"><i class="far fa-check mr-2 text-primary"></i>Swimming
                              </li>
                              <li class="col-sm-6 mb-2"><i class="far fa-check mr-2 text-primary"></i>Garage
                              </li>
                            </ul>
                          </div>
                        </div>
                  ...
                  <div class="bg-cover"
                 style="background-image: url(images/properties-slider-10.jpg)" data-animate="zoomIn">
                    <div class="container">
                      <div class="row">
                        <div class="col-lg-6 offset-lg-6 col-md-8 offset-md-4 py-11">
                          <div class="bg-white rounded-lg position-relative z-index-2 pl-sm-13 pr-sm-10 py-sm-9 p-6">
                  ...
                  <div class="bg-cover"
                 style="background-image: url(images/properties-slider-09.jpg)" data-animate="zoomIn">
                    <div class="container">
                      <div class="row">
                        <div class="col-lg-6 offset-lg-6 col-md-8 offset-md-4 py-11">
                          <div class="bg-white rounded-lg position-relative z-index-2 pl-sm-13 pr-sm-10 py-sm-9 p-6">
            ...
            <section class="pt-11 pb-9">
              <div class="container">
                <div class="row">
                  <div class="col-md-5 mb-6 mb-md-0" data-animate="fadeInLeft">
                    <h2 class="text-dark">Property On Map</h2>
                    <span class="heading-divider"></span>
                    <p class="pt-2 pr-xl-15">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                      incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation
                      ullamco laboris nisi ut aliquip ex.</p>
                  </div>
                  <div class="col-md-7" data-animate="fadeInRight">
                    <div class="position-relative">
                      <div id="map" class="mapbox-gl map-point-animate"  style="height: 303px;"
                         ...
                         data-mapbox-marker='[{"position":[-73.9947200, 40.6741035],"className":"marker","backgroundImage":"images/googlle-market-01.png","backgroundRepeat":"no-repeat","width":"30px","height":"40px"}]'>
                      </div>
                      <p class="mb-0 p-3 bg-white shadow rounded-lg position-absolute pos-fixed-bottom-right mb-7 mr-4 lh-17">
            ...
            <section class="pb-8">
              <div class="container container-xxl">
                <h2 class="text-dark text-center">Photo Gallery</h2>
                <span class="heading-divider mx-auto"></span>
                  ...
                  <div class="col-md-7">
                    <div class="row h-100">
                      <div class="col-sm-6 col-md-4 mb-6">
                        <div class="item item-size-1-1">
                          <div class="card p-0 hover-zoom-in hover-change-image">
                            <a href="images/gallery-lg-02.jpg" class="card-img"
                                   data-gtf-mfp="true" data-gallery-id="01"
                      ...
                      <div class="col-sm-6 col-md-4 mb-6">
                        <div class="item item-size-1-1">
                          <div class="card p-0 hover-zoom-in hover-change-image">
                            <a href="images/gallery-lg-03.jpg" class="card-img"
                                   data-gtf-mfp="true" data-gallery-id="01"
                      ...
                      <div class="col-sm-6 col-md-4 mb-6">
                        <div class="item item-size-1-1">
                          <div class="card p-0 hover-zoom-in hover-change-image">
                            <a href="images/gallery-lg-04.jpg" class="card-img"
                                   data-gtf-mfp="true" data-gallery-id="01"
                      ...
                      <div class="col-sm-6 col-md-4 mb-6">
                        <div class="item item-size-1-1">
                          <div class="card p-0 hover-zoom-in hover-change-image">
                            <a href="images/gallery-lg-05.jpg" class="card-img"
                                   data-gtf-mfp="true" data-gallery-id="01"
                      ...
                      <div class="col-sm-6 col-md-4 mb-6">
                        <div class="item item-size-1-1">
                          <div class="card p-0 hover-zoom-in hover-change-image">
                            <a href="images/gallery-lg-06.jpg" class="card-img"
                                   data-gtf-mfp="true" data-gallery-id="01"
                  ...
                  <div class="col-xl-5 col-lg-6 custom-lg-size-1-1 mb-lg-0 mb-6" data-animate="fadeInLeft">
                    <a href="#">
                      <div class="bg-cover h-100 rounded-lg"
                         style="background-image: url('images/agent-creative-04.jpg')"></div>
                    </a>
                  </div>
                  <div class="col-xl-7 col-lg-6" data-animate="fadeInRight">
                    <div class="bg-secondary rounded-lg pt-sm-9 px-sm-7 pb-sm-11 p-6">
                      <h2 class="mt-1 mb-2"><a href="agent-details-1.html"
                                             class="fs-30 font-weight-600 text-white">Blanche Gordon</a></h2>
                      <p class="opacity-4 text-white fs-16 font-weight-500">Real estate broker, agent</p>
                      <p class="text-white">Company Agent at <a href="#" class="text-white border-bottom pb-1">Modern
                          House Real Estate</a></p>
                      <p class="text-white">Lorem ipsum dolor sit amet, consec tetur cing elit. Suspe ndisse suscorem
                        ipsum dolor sit ametcipsum dolor sit t, consec tetur atetur cing elit. Suspe ndisse susco rem
                        ipsum dolor sit ametcipsum doloamet.</p>
                      <div class="row pt-2 pb-4 no-gutters border-opacity-025 border-bottom">
                        <div class="col-xl-3 col-sm-6">
                          <h4 class="text-white opacity-4 fs-14 mb-3">Phone</h4>
                          <p class="text-white font-weight-50 lh-143">+98 0390 909 039<br/>
                            +98 0900 098 888</p>
                        </div>
                        <div class="col-xl-3 col-sm-6">
                          <h4 class="text-white opacity-4 fs-14">Language</h4>
                          <p class="text-white font-weight-500">English, French, Spanish</p>
                        </div>
                        <div class="col-xl-3 col-sm-6">
                          <h4 class="text-white opacity-4 fs-14">Email</h4>
                          <p class="text-white font-weight-500">b.gordon@homeid.com</p>
                        </div>
                        <div class="col-xl-3 col-sm-6">
                          <h4 class="text-white opacity-4 fs-14">Website</h4>
                          <p class="text-white font-weight-500">thememove.com</p>
                        </div>
                      </div>
                      <ul class="list-inline mb-0 mt-4">
                        <li class="list-inline-item text-white font-weight-500">4.8/5</li>
                        ...
                        <li class="list-inline-item fs-13 text-muted">(67 reviews)</li>
                        <li class="list-inline-item pl-xl-7">
                          <ul class="list-inline mb-0 mt-4">
                            <li class="list-inline-item mb-2">
                              <a href="#"
                                       class="w-40px h-40 rounded-circle border-0 text-body bg-hover-primary hover-white d-flex align-items-center justify-content-center bg-white"><i
                            ...
                            <li class="list-inline-item mb-2">
                              <a href="#"
                                       class="w-40px h-40 rounded-circle border-0 text-body bg-hover-primary hover-white d-flex align-items-center justify-content-center bg-white">
          ...
          <footer class="bg-dark pt-10 pb-8 footer">
            <div class="container">
              ...
              <ul class="list-inline text-center mb-6">
                ...
                <li class="list-inline-item divider mr-3"></li>
                <li class="list-inline-item">
                  <a href="mailto:contact@homeid.com"
                   class="text-white opacity-7 hover-white">contact@homeid.com</a>
                </li>
              </ul>

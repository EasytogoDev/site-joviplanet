...
<html lang="en">
  <head>
    ...
    <title>Single Property 8 - HomeID</title>
    <!-- Google fonts -->
    ...
    <meta name="twitter:title" content="Single Property 8">
    <meta name="twitter:description" content="Real Estate Html Template">
    <meta name="twitter:image" content="images/homeid-social-logo.png">
    <!-- Facebook -->
    <meta property="og:url" content="single-property-8.html">
    <meta property="og:title" content="Single Property 8">
  ...
  <body>
    ...
    <main id="content">
      <section class="shadow-5">
        <div style="background-image: url('images/bg-slider-08.jpg')" class="py-lg-13 py-11 bg-cover">
          <div class="container">
            <div class="row">
              <div class="col-lg-8 col-md-6 align-self-lg-end align-self-md-center mb-md-0 mb-6">
                <h2 class="mb-4 fs-sm-54 fs-45 font-weight-bold text-white">Insight Lux Villa</h2>
                <p class="fs-16 text-white mb-2">Stourbridge, West Midlands, DY9 9TA</p>
                <p class="fs-30 font-weight-bold text-white mb-lg-1">$979.000<span class="text-white font-weight-normal fs-14 ml-6">$9350/SqFt</span></p>
              </div>
              <div class="col-lg-4 col-md-6">
                <div class="p-6 bg-white rounded-lg">
                  <div class="media align-items-center mb-4">
                    <img src="images/Oliver-Beddows.jpg" class="mr-3"
							     alt="Oliver Beddows">
                    <div class="media-body">
      ...
      <article class="bg-gray-01 pt-6 pb-lg-13 pb-11">
        <div class="container">
          <div class="row">
            <div class="col-lg-6">
              <section class="mt-2 p-6 bg-white rounded-lg">
                <h4 class="fs-22 text-heading mb-3 lh-13">Description</h4>
              ...
              <section class="mt-2 p-6 bg-white rounded-lg">
                ...
                <ul class="list-unstyled mb-0 row no-gutters">
                  <li class="col-sm-6 mb-2"><i class="far fa-check mr-2 text-primary"></i>Balcony</li>
                  <li class="col-sm-6 mb-2"><i class="far fa-check mr-2 text-primary"></i>Fireplace</li>
                  <li class="col-sm-6 mb-2"><i class="far fa-check mr-2 text-primary"></i>Balcony</li>
                  <li class="col-sm-6 mb-2"><i class="far fa-check mr-2 text-primary"></i>Fireplace</li>
                  <li class="col-sm-6 mb-2"><i class="far fa-check mr-2 text-primary"></i>Basement</li>
                  <li class="col-sm-6 mb-2"><i class="far fa-check mr-2 text-primary"></i>Cooling</li>
                  <li class="col-sm-6 mb-2"><i class="far fa-check mr-2 text-primary"></i>Basement</li>
                  <li class="col-sm-6 mb-2"><i class="far fa-check mr-2 text-primary"></i>Cooling</li>
                  <li class="col-sm-6 mb-2"><i class="far fa-check mr-2 text-primary"></i>Dining room</li>
                  <li class="col-sm-6 mb-2"><i class="far fa-check mr-2 text-primary"></i>Dishwasher</li>
                  <li class="col-sm-6 mb-2"><i class="far fa-check mr-2 text-primary"></i>Dining room</li>
                  <li class="col-sm-6 mb-2"><i class="far fa-check mr-2 text-primary"></i>Dishwasher</li>
                </ul>
              </section>
              ...
              <section class="mt-2 p-6 bg-white rounded-lg">
                <div class="card border-0">
                  <div class="card-body p-0">
                    ...
                    <div class="media border-top py-7 d-sm-flex d-block text-sm-left text-center">
                      <img src="images/review-07.jpg" alt="Danny Fox" class="mr-xl-8 mr-4 mb-4 mb-sm-0">
                      <div class="media-body">
                        ...
                        <p class="mb-3">Very good and fast support during the week. Thanks for always
                    ...
                    <div class="media border-top py-7 d-sm-flex d-block text-sm-left text-center">
                      <img src="images/review-08.jpg" alt="Viola Austin" class="mr-xl-8 mr-4 mb-4 mb-sm-0">
                      <div class="media-body">
                        <div class="row mb-1 align-items-center">
                          <div class="col-sm-6 mb-2 mb-sm-0">
                    ...
                    <div class="media border-top py-7 d-sm-flex d-block text-sm-left text-center">
                      <img src="images/review-09.jpg" alt="Nettie Singleton" class="mr-xl-8 mr-4 mb-4 mb-sm-0">
                      <div class="media-body">
                        <div class="row mb-1 align-items-center">
                          <div class="col-sm-6 mb-2 mb-sm-0">
            ...
            <div class="col-lg-6">
              ...
              <section class="mt-2 p-6 bg-white rounded-lg">
                <h4 class="fs-22 text-heading mb-4">What is Nearby?</h4>
                <div class="mt-4">
                  <ul class="nav nav-pills mb-1 tabs-03" id="pills-tab" role="tablist">
                  ...
                  <div class="tab-content p-0 shadow-none" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-restaurants" role="tabpanel" aria-labelledby="pills-restaurants-tab">
                      <div class="py-3 px-0  show active d-sm-flex justify-content-sm-between border-bottom">
                      ...
                      <div class="py-3 px-0  show active d-sm-flex justify-content-sm-between">
                        <div class="media align-items-sm-center d-sm-flex d-block">
                          <div class="mt-sm-0 mt-2">
                            <h4 class="my-0"><a href="#" class="lh-186 fs-15 text-heading hover-primary">Bacchanal Buffet-Temporarily Closed</a></h4>
                            <p class="lh-186 fs-15 font-weight-500 mb-0">3570 S Las Vegas BlvdLas Vegas, NV 89109</p>
                    ...
                    <div class="tab-pane fade" id="pills-schools" role="tabpanel" aria-labelledby="pills-schools-tab">
                      <div class="py-3 px-0  d-sm-flex justify-content-sm-between border-bottom">
                        <div class="media align-items-sm-center d-sm-flex d-block">
                          <div class="mt-sm-0 mt-2">
                      ...
                      <div class="py-3 px-0  d-sm-flex justify-content-sm-between">
                        <div class="media align-items-sm-center d-sm-flex d-block">
                          <div class="mt-sm-0 mt-2">
                            <h4 class="my-0"><a href="#" class="lh-186 fs-15 text-heading hover-primary">Safe Direction Firearms Training</a></h4>
                            <p class="lh-186 fs-15 font-weight-500 mb-0">3570 S Las Vegas BlvdLas Vegas, NV 89109</p>
              ...
              <section class="mt-2 p-6 bg-white rounded-lg">
                ...
                <iframe height="330" src="https://my.matterport.com/show/?m=wWcGxjuUuSb&amp;utm_source=hit-content-embed" allowfullscreen="" class="w-100"></iframe>
              </section>
              <section class="mt-2 p-6 bg-white rounded-lg" >
                <h4 class="fs-22 text-heading mb-1">Location</h4>
                <p class="mb-3">62 Gresham St, Victoria Park WA 6100, Australia</p>
                <div class="position-relative">
                  <div id="map" class="mapbox-gl map-point-animate" style="height: 330px"
                  ...
                  <div class="card-body p-0">
                    <div class="row">
                      <div class="col-sm-6 mb-6 mb-sm-0">
                        <div class="bg-gray-01 rounded-lg p-4">
                          ...
                          <ul class="list-inline">
                            <li class="list-inline-item bg-warning text-white w-28px h-28 rounded-lg d-inline-flex align-items-center justify-content-center fs-12 mb-1">
                            ...
                            <li class="list-inline-item bg-gray-04 text-white w-28px h-28 rounded-lg d-inline-flex align-items-center justify-content-center fs-12 mb-1">
                              <i class="fas fa-star"></i>
                            </li>
                          </ul>
                        </div>
              ...
              <section class="mt-2 p-6 bg-white rounded-lg">
                <h4 class="fs-22 text-heading mb-5">Similar Homes You May Like</h4>
                <div class="slick-slider custom-slider-arrow-top"
                  ...
                  <div class="box">
                    <div class="card shadow-hover-2 border-0">
                      ...
                      <div class="card-body p-0">
                        <h2 class="card-title fs-16 lh-2 mb-0 mt-1"><a href="single-property-1.html" class="text-dark hover-primary">Home in Metric Way</a></h2>
                        <p class="card-text font-weight-500 text-gray-light mb-0">1421 San Pedro St, Los Angeles</p>
                        <p class="fs-17 text-heading font-weight-bold mb-1 pb-1 border-bottom">$1.250.000</p>
                  ...
                  <div class="box">
                    <div class="card shadow-hover-2 border-0">
                      ...
                      <div class="card-body p-0">
                        <h2 class="card-title fs-16 lh-2 mb-0 mt-1"><a href="single-property-1.html" class="text-dark hover-primary">Garden Gingerbread House</a></h2>
                        <p class="card-text font-weight-500 text-gray-light mb-0">1421 San Pedro St, Los Angeles</p>
                        <p class="fs-17 text-heading font-weight-bold mb-1 pb-1 border-bottom">$1.250.000</p>
                        <ul class="list-inline d-flex mb-0 flex-wrap mr-n5">
                          <li class="list-inline-item text-gray font-weight-500 fs-13 d-flex align-items-center mr-5" data-toggle="tooltip" title="3 Bedroom">
                  ...
                  <div class="box">
                    <div class="card shadow-hover-2 border-0">
                      ...
                      <div class="card-body p-0">
                        <h2 class="card-title fs-16 lh-2 mb-0 mt-1"><a href="single-property-1.html" class="text-dark hover-primary">Affordable Urban House</a></h2>
                        <p class="card-text font-weight-500 text-gray-light mb-0">1421 San Pedro St, Los Angeles</p>
                        <p class="fs-17 text-heading font-weight-bold mb-1 pb-1 border-bottom">$1.250.000</p>
                        <ul class="list-inline d-flex mb-0 flex-wrap mr-n5">
                          <li class="list-inline-item text-gray font-weight-500 fs-13 d-flex align-items-center mr-5" data-toggle="tooltip" title="3 Bedroom">
              ...
              <section class="mt-2 p-6 bg-white rounded-lg chart">
                <div class="card border-0">
                  <div class="card-body p-0 collapse-tabs" >
                    <div class="mb-5">
                      <h2 class="mb-2 text-heading fs-22 lh-15 mr-auto">Page statistics</h2>
                      <ul class="nav nav-pills nav-pills-01 d-none d-sm-flex"
									    role="tablist">
                        <li class="nav-item pr-8 py-1">

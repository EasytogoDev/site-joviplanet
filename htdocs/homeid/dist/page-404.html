...
<html lang="en">
  <head>
    ...
    <!-- Facebook -->
    <meta property="og:url" content="page-404.html">
  ...
  <body>
    <header class="main-header navbar-light text-center border-bottom header-sticky header-sticky-smart">
      <div class="sticky-area bg-white py-4">
        <a href="index.html">
      ...
      <section class="pt-9 pb-10">
        <div class="container">
          <div class="text-center mb-15">
            <img src="images/page-404.jpg" alt="Page 404" class="mb-5">

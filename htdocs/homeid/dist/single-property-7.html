...
<html lang="en">
  <head>
    ...
    <title>Single Property 7 - HomeID</title>
    <!-- Google fonts -->
    ...
    <meta name="twitter:title" content="Single Property 7">
    <meta name="twitter:description" content="Real Estate Html Template">
    <meta name="twitter:image" content="images/homeid-social-logo.png">
    <!-- Facebook -->
    <meta property="og:url" content="single-property-7.html">
    <meta property="og:title" content="Single Property 7">
              ...
              <div class="row no-gutters m-n1 pb-7">
                <div class="col-6 col-sm-4">
                  <div class="item item-size-1-1">
                    <div class="card shadow-hover-xs-3 bg-hover-white bg-transparent p-1">
                ...
                <form>
                  ...
                  <div class="row">
                    <div class="col-md-6 mb-4">
                      ...
                      <div class="position-relative">
                        <input type="number" class="form-control border-0 pr-3 h-52 pl-7" value="2.500" step="0.25"
                                   name="interest-rate">
                        <span class="position-absolute pl-3 pos-fixed-left-center fs-13 font-weight-600">%</span>
                      </div>
                    </div>
              ...
              <section class="mt-2 pb-7 px-6 pt-6 bg-white rounded-lg">
                ...
                <div class="slick-slider"
                 data-slick-options='{"slidesToShow": 2, "dots":false,"responsive":[{"breakpoint": 1200,"settings": {"slidesToShow":2,"arrows":false}},{"breakpoint": 992,"settings": {"slidesToShow":2}},{"breakpoint": 768,"settings": {"slidesToShow": 1}},{"breakpoint": 576,"settings": {"slidesToShow": 1}}]}'>
                  <div class="box">
                    <div class="card shadow-hover-2 d-block">
                ...
                <div class="card mb-4">
                  <div class="card-body px-6 py-4 text-center">
                    ...
                    <form>
                      ...
                      <button type="submit" class="btn btn-primary btn-lg btn-block shadow-none">Request Info
                      </button>
                        ...
                        <div class="card border-0">
                          ...
                          <div class="card-img-overlay d-flex flex-column bg-gradient-3 rounded-lg">
                            ...
                            <div class="px-2 pb-2">
                              ...
                              <p class="card-text text-gray-light mb-0 font-weight-500">1421 San Predro
                                St, Los Angeles</p>

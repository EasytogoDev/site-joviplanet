...
<?php
 ...
 //$pesquisa = str_replace( array( ',', '.', '%', '-', '/', '\\' ),' ', $dados );
  ...
  $busca_query =  mysqli_query($conexao, "SELECT 
	  imagemPRODUTO, 
	  lancamentoPRODUTO, 
	  sulfixoPRODUTO, 
	  partnumberPRODUTO, 
	  ...
	  codigoPRODUTO, 
	  slugPRODUTO  
	  FROM tb0001_produtos  
   INNER JOIN tb0001_vinculoscategorias ON produtoVINCULOCATEGORIA = codigoPRODUTO 
   INNER JOIN tb0001_categorias ON categoriaVINCULOCATEGORIA = codigoCATEGORIA    
   WHERE CONCAT( sulfixoPRODUTO, ' ', partnumberPRODUTO , ' ', descricaoPRODUTO ) 
   LIKE '%".$dados."%' AND `ativoPRODUTO`='1' 
  ...
  $busca_total_query =  mysqli_query($conexao, "SELECT 
	  imagemPRODUTO, 
	  lancamentoPRODUTO, 
	  sulfixoPRODUTO, 
	  partnumberPRODUTO, 
   ...
   while($produtos = mysqli_fetch_assoc($busca_query)){	
		...
		$url = "/".$idioma."/".$traducao['ulr_produtos']."/".$produtos['slugCATEGORIA']."/".$produtos['codigoPRODUTO']."/".$produtos['slugPRODUTO'];
  ...
  /**
    ...
    */
    ...
    ?>
        ...
        <?php
        echo "<li><a href='".$idioma."/".$traducao['ulr_produtos']."/".$traducao['ulr_pesquisar']."/_pagina/1/".url_encode($dados)."' > << </a></li>";
		
        echo "<li><a href='".$idioma."/".$traducao['ulr_produtos']."/".$traducao['ulr_pesquisar']."/_pagina/".$anterior."/".url_encode($dados)."' > < </a></li>";
    ?>
        <?php
         /**

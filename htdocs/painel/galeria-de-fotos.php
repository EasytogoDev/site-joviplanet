...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <title> Galeria de fotos - Karmake Comunicação</title>
...
function openKCFinder(field) {
 ...
 function apagarfoto(GALERIA,CODIGO){
	
	if (confirm("Tem Certeza que deseja excluir a foto desta galeria?"))
	{
		
		location.href='?make=<?php echo $make;?>&acao=apagarfoto&galeria='+GALERIA+'&codigo='+CODIGO;

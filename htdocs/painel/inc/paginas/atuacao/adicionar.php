...
if($query)
		{
		echo '<script>alert("Serviço inserido com sucesso!");top.location.href="?make=atuacao";</script>';
		}
		else{
...
<div class="title-block">
                        ...
                        <p class="title-description"> Adicione uma nova atuação </p>
                    </div>
					...
					<section class="section">
                        ...
                        <p class="title-description"> Conteúdo da página de atuação</p>
                                  ...
                                  <div class="form-group"> <label class="control-label">Sub Titulo</label> <input name="subtitulo" type="text" class="form-control underlined" id="subtitulo" placeholder="Coloque a breve descrição do serviço"> </div>
      ...
      <label class="control-label">Conteúdo</label>   
                       <textarea class="ckeditor" cols="80" id="editor1" name="conteudo" rows="10"></textarea>                
                        ...
                        <p class="title-description"> SEO - Dados para otimização</p>
                                  ...
                                  <div class="form-group"> <label class="control-label">Meta-tags Keyworks</label> <input name="keyworks" type="text" class="form-control underlined" id="keyworks" placeholder="Tags separadas por virgulaas (tag1, tag2...)"> </div>

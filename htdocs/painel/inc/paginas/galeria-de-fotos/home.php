  <div class="title-search-block">
	  ...
	  $inicio = ($p*$qnt) - $qnt;
		...
		$query_total = mysqli_query($conexao, "SELECT * FROM tb0150_galeria INNER JOIN tb0075_eventos ON codigoEVENTO = eventoGALERIA WHERE vinculoGALERIA='0' ");
	  	$total_registros = mysqli_num_rows($query_total);
		
		$pags = ceil($total_registros/$qnt);
		$max_links = 3;
		
		$query_galerias = mysqli_query($conexao, "SELECT * FROM tb0150_galeria INNER JOIN tb0075_eventos ON codigoEVENTO = eventoGALERIA WHERE vinculoGALERIA='0'  LIMIT $inicio, $qnt ");
		$contagem = '1';

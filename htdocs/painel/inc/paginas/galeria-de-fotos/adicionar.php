...
class="form-control underlined" id="imagemGALERIA"  placeholder="Clique aqui e selecione uma imagem clicando duas vezes nele" onclick="openKCFinder(this)" readonly="readonly"/> </div>

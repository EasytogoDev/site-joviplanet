  <div class="title-search-block">
	  ...
	  $inicio = ($p*$qnt) - $qnt;
		...
		LEFT JOIN tb0301_usuarios ON codigoUSUARIO = usuarioPOST
        ORDER BY ativoPOST ASC,ordemPOST ASC
         ");
		...
		LEFT JOIN tb080_categorias ON codigoCATEGORIA = categoriaPOST  
		LEFT JOIN tb0301_usuarios ON codigoUSUARIO = usuarioPOST  
        ORDER BY ativoPOST ASC,ordemPOST ASC LIMIT $inicio, $qnt");
		$contagem = '1';
                            ...
                            <li class="item">
                                <div class="item-row">
                                 ...
                                 <div class="item-col fixed item-col-img md">
                                    ...
                                    <div class="item-col item-col-sales">
                                        <div class="item-heading">Ordem</div>
                                        <div> <?php echo $posts['ordemPOST'];?> </div>
                                    </div>

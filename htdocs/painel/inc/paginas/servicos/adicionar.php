...
if($query)
		{
		echo '<script>alert("Serviço inserido com sucesso!");top.location.href="?make=servicos";</script>';
		}
		else{
...
<div class="title-block">
                        ...
                        <p class="title-description"> Adicione um novo serviço </p>
                    </div>

...
<html lang="en">
  ...
  <body>
    ...
    <main id="content">
      ...
      <section class="py-15 text-center bg-cover"
       ...
       data-animate="fadeInUp">Find out more<i
                ...
                <div class="card-body px-0 pt-6 pb-0">
                  <a href="single-property-1.html"
                    ...
                    <span class="d-none d-sm-flex align-items-center ml-2 text-primary fs-42 lh-1"><svg
                                    class="icon icon-long-arrow"><use xlink:href="#icon-long-arrow"></use></svg></span>
                  </a>
        ...
        <div class="container">
          <div class="row">
            <div class="col-xl-5 col-lg-6">
              <h2 class="text-white fs-32 lh-163 mb-6">Send us a message</h2>
              <form>
                <div class="form row">
                  ...
                  <div class="col-12 pt-4">
                    <textarea class="form-control border-0 shadow-none bg-gray-03 placeholder-muted h-145"
                                      id="exampleFormControlTextarea1" placeholder="Messenger"></textarea>
                  </div>

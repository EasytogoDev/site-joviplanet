...
<html lang="en">
  ...
  <body>
    ...
    <main id="content">
      <section>
        <div style="background-image: url('images/bg-home-02.jpg')" class="py-lg-17 py-11 bg-cover">
      ...
      <section class="pt-lg-12 pt-11 pb-11">
        <div class="container container-xxl">
          <div class="row flex-lg-row flex-cloumn">
            ...
            <div class="col-lg-7 col-xxl-6">
              <ul class="nav nav-pills mt-lg-4 justify-content-lg-end mb-lg-0 mb-6" role="tablist">
                ...
                <li class="nav-item pl-lg-3 pr-3 pr-lg-0 mb-3">
                  <a class="pointer nav-link  fs-13 letter-spacing-087 text-secondary text-uppercase px-4 bg-gray-01 text-active-white bg-active-primary rounded-lg"
                           id="pills-house-tab" data-toggle="pill" href="#pills-house" role="tab"
                           aria-controls="pills-house" aria-selected="true">house</a>
                </li>
                <li class="nav-item pl-lg-3 pr-3 pr-lg-0 mb-3">
                  <a class="pointer nav-link  fs-13 letter-spacing-087 text-secondary text-uppercase px-4 bg-gray-01 text-active-white bg-active-primary rounded-lg"
                           id="pills-office-tab" data-toggle="pill" href="#pills-office" role="tab"
                           aria-controls="pills-office" aria-selected="true">office</a>
                </li>
                <li class="nav-item pl-lg-3 pr-3 pr-lg-0 mb-3">
                  <a class="pointer nav-link  fs-13 letter-spacing-087 text-secondary text-uppercase px-4 bg-gray-01 text-active-white bg-active-primary rounded-lg"
                           id="pills-homes-tab" data-toggle="pill" href="#pills-homes" role="tab"
                           aria-controls="pills-homes" aria-selected="true">homes</a>
                </li>
                <li class="nav-item pl-lg-3 pr-3 pr-lg-0 mb-3">
                  <a class="pointer nav-link  fs-13 letter-spacing-087 text-secondary text-uppercase px-4 bg-gray-01 text-active-white bg-active-primary rounded-lg"
          ...
          <div class="tab-content p-0 shadow-none" id="pills-tabContent">
              ...
              <div class="row">
                <div class="col-xxl-3 col-lg-4 col-md-6 mb-6" data-animate="zoomIn">
                  <div class="card border-0 bg-overlay-gradient-3 rounded-lg hover-change-image">
                    <img src="images/properties-grid-08.jpg" class="card-img"
                    ...
                    <div class="card-img-overlay d-flex flex-column position-relative-sm">
                      ...
                      <div class="mt-auto px-2">
                        ...
                        <h4 class="mt-0 mb-2 lh-1"><a href="single-property-1.html"
                                                                  class="fs-16 text-white">Villa on Hollywood Boulevard</a></h4>
                ...
                <div class="col-xxl-3 col-lg-4 col-md-6 mb-6" data-animate="zoomIn">
                  <div class="card border-0 bg-overlay-gradient-3 rounded-lg hover-change-image">
                    <img src="images/properties-grid-09.jpg" class="card-img"
                    ...
                    <div class="card-img-overlay d-flex flex-column position-relative-sm">
                      ...
                      <div class="mt-auto px-2">
                        <p class="fs-17 font-weight-bold text-white mb-0 lh-13">$5.700<span
                                            class="fs-14 font-weight-500"> / year</span></p>
                        <h4 class="mt-0 mb-2 lh-1"><a href="single-property-1.html"
                                                                  class="fs-16 text-white">Home in Metric Way</a></h4>
                        <div class="border-top border-white-opacity-03 pt-2">
                          <ul class="list-inline d-flex mb-0 flex-wrap mt-2 mt-lg-0 mr-n5">
                            <li class="list-inline-item text-white font-weight-500 fs-13 d-flex align-items-center mr-5"
                                                data-toggle="tooltip" title="3 Bedroom">
                ...
                <div class="col-xxl-3 col-lg-4 col-md-6 mb-6" data-animate="zoomIn">
                  <div class="card border-0 bg-overlay-gradient-3 rounded-lg hover-change-image">
                    <img src="images/properties-grid-10.jpg" class="card-img"
                    ...
                    <div class="card-img-overlay d-flex flex-column position-relative-sm">
                      ...
                      <div class="mt-auto px-2">
                        <p class="fs-17 font-weight-bold text-white mb-0 lh-13">$550<span
                                            class="fs-14 font-weight-500"> / month</span></p>
                        <h4 class="mt-0 mb-2 lh-1"><a href="single-property-1.html"
                                                                  class="fs-16 text-white">Affordable Urban House</a></h4>
                        <div class="border-top border-white-opacity-03 pt-2">
                          <ul class="list-inline d-flex mb-0 flex-wrap mt-2 mt-lg-0 mr-n5">
                            <li class="list-inline-item text-white font-weight-500 fs-13 d-flex align-items-center mr-5"
                                                data-toggle="tooltip" title="3 Bedroom">
                ...
                <div class="col-xxl-3 col-lg-4 col-md-6 mb-6" data-animate="zoomIn">
                  <div class="card border-0 bg-overlay-gradient-3 rounded-lg hover-change-image">
                    <img src="images/properties-grid-11.jpg" class="card-img"
                                 alt="Home in Metric Way">
                    <div class="card-img-overlay d-flex flex-column position-relative-sm">
                      <div class="d-flex">
                        <div class="mr-auto h-24 d-flex">
                ...
                <div class="col-xxl-3 col-lg-4 col-md-6 mb-6" data-animate="zoomIn">
                  <div class="card border-0 bg-overlay-gradient-3 rounded-lg hover-change-image">
                    <img src="images/properties-grid-40.jpg" class="card-img"
                                 alt="Home in Metric Way">
                    <div class="card-img-overlay d-flex flex-column position-relative-sm">
                      <div class="d-flex">
                        <div class="mr-auto h-24 d-flex">
                ...
                <div class="col-xxl-3 col-lg-4 col-md-6 mb-6" data-animate="zoomIn">
                  <div class="card border-0 bg-overlay-gradient-3 rounded-lg hover-change-image">
                    <img src="images/properties-grid-41.jpg" class="card-img"
                                 alt="Affordable Urban House">
                    <div class="card-img-overlay d-flex flex-column position-relative-sm">
                      <div class="d-flex">
                        <div class="mr-auto h-24 d-flex">
                ...
                <div class="col-xxl-3 col-lg-4 col-md-6 mb-6" data-animate="zoomIn">
                  <div class="card border-0 bg-overlay-gradient-3 rounded-lg hover-change-image">
                    <img src="images/properties-grid-42.jpg" class="card-img"
                                 alt="Villa on Hollywood Boulevard">
                    <div class="card-img-overlay d-flex flex-column position-relative-sm">
                      <div class="d-flex">
                        <div class="mr-auto h-24 d-flex">
                ...
                <div class="col-xxl-3 col-lg-4 col-md-6 mb-6" data-animate="zoomIn">
                  <div class="card border-0 bg-overlay-gradient-3 rounded-lg hover-change-image">
                    <img src="images/properties-grid-43.jpg" class="card-img"
                                 alt="Affordable Urban House">
                    <div class="card-img-overlay d-flex flex-column position-relative-sm">
                      <div class="d-flex">
                        <div class="mr-auto h-24 d-flex">
                ...
                <div class="col-xxl-3 col-lg-4 col-md-6 mb-6" data-animate="zoomIn">
                  <div class="card border-0 bg-overlay-gradient-3 rounded-lg hover-change-image">
                    ...
                    <div class="card-img-overlay d-flex flex-column position-relative-sm">
                      ...
                      <div class="mt-auto px-2">
                        <p class="fs-17 font-weight-bold text-white mb-0 lh-13">$1.250.</p>
                        <h4 class="mt-0 mb-2 lh-1"><a href="single-property-1.html"
                                                                  class="fs-16 text-white">Home in Metric Way</a></h4>
                        <div class="border-top border-white-opacity-03 pt-2">
                          <ul class="list-inline d-flex mb-0 flex-wrap mt-2 mt-lg-0 mr-n5">
            ...
            <div class="tab-pane fade " id="pills-house"
                 role="tabpanel" aria-labelledby="pills-house-tab">
              <div class="row">
                <div class="col-xxl-3 col-lg-4 col-md-6 mb-6" data-animate="zoomIn">
                  <div class="card border-0 bg-overlay-gradient-3 rounded-lg hover-change-image">
                    <img src="images/properties-grid-41.jpg" class="card-img"
            ...
            <div class="tab-pane fade " id="pills-office"
                 role="tabpanel" aria-labelledby="pills-office-tab">
              <div class="row">
                <div class="col-xxl-3 col-lg-4 col-md-6 mb-6" data-animate="zoomIn">
                  <div class="card border-0 bg-overlay-gradient-3 rounded-lg hover-change-image">
                    <img src="images/properties-grid-08.jpg" class="card-img"
            ...
            <div class="tab-pane fade " id="pills-homes"
                 role="tabpanel" aria-labelledby="pills-homes-tab">
              <div class="row">
                <div class="col-xxl-3 col-lg-4 col-md-6 mb-6" data-animate="zoomIn">
                  <div class="card border-0 bg-overlay-gradient-3 rounded-lg hover-change-image">
                    <img src="images/properties-grid-11.jpg" class="card-img"
        ...
        <div class="container container-xxl">
          ...
          <div class="slick-slider mx-n2 custom-arrow-spacing-30"
            ...
            <div class="box px-2" data-animate="fadeInUp">
              <div class="card border-0 hover-change-image">
                <div class="bg-overlay-gradient-1 bg-hover-overlay-gradient-3 rounded-lg card-img">
                  <img src="images/properties-grid-12.jpg"
                             alt="Villa on Hollywood Boulevard">
                ...
                <div class="card-body p-0">
                  <h2 class="my-0 mt-1"><a href="single-property-1.html"
            ...
            <div class="box px-2" data-animate="fadeInUp">
              <div class="card border-0 hover-change-image">
                <div class="bg-overlay-gradient-1 bg-hover-overlay-gradient-3 rounded-lg card-img">
                  <img src="images/properties-grid-13.jpg"
                             alt="Home in Metric Way">
                  <div class="card-img-overlay d-flex flex-column justify-content-between">
                    <div>
                      <span class="badge mr-2 badge-primary">For Sale</span>
                ...
                <div class="card-body p-0">
                  <h2 class="my-0 mt-1"><a href="single-property-1.html"
                                                 class="fs-16 text-dark hover-primary lh-2">Home in Metric Way</a>
                  </h2>
                  <p class="text-gray-light font-weight-500 mb-1">1421 San Pedro St, Los Angeles</p>
                  <p class="fs-17 font-weight-bold text-heading mb-0">$1.250.000</p>
                </div>
            ...
            <div class="box px-2" data-animate="fadeInUp">
              <div class="card border-0 hover-change-image">
                <div class="bg-overlay-gradient-1 bg-hover-overlay-gradient-3 rounded-lg card-img">
                  <img src="images/properties-grid-14.jpg"
                             alt="Affordable Urban House">
                  <div class="card-img-overlay d-flex flex-column justify-content-between">
                    <div>
                      <span class="badge mr-2 badge-primary">For Sale</span>
                ...
                <div class="card-body p-0">
                  <h2 class="my-0 mt-1"><a href="single-property-1.html"
                                                 class="fs-16 text-dark hover-primary lh-2">Affordable Urban House</a>
                  </h2>
                  <p class="text-gray-light font-weight-500 mb-1">1421 San Pedro St, Los Angeles</p>
                  <p class="fs-17 font-weight-bold text-heading mb-0">$1.250.000</p>
                </div>
            ...
            <div class="box px-2" data-animate="fadeInUp">
              <div class="card border-0 hover-change-image">
                <div class="bg-overlay-gradient-1 bg-hover-overlay-gradient-3 rounded-lg card-img">
                  <img src="images/properties-grid-15.jpg"
                ...
                <div class="card-body p-0">
                  <h2 class="my-0 mt-1"><a href="single-property-1.html"
                                                 class="fs-16 text-dark hover-primary lh-2">Explore Old Barcelona</a>
                  </h2>
                  <p class="text-gray-light font-weight-500 mb-1">1421 San Pedro St, Los Angeles</p>
                  <p class="fs-17 font-weight-bold text-heading mb-0">$1.250.000</p>
                </div>
            ...
            <div class="box px-2" data-animate="fadeInUp">
              <div class="card border-0 hover-change-image">
                <div class="bg-overlay-gradient-1 bg-hover-overlay-gradient-3 rounded-lg card-img">
                  <img src="images/properties-grid-16.jpg"
                ...
                <div class="card-body p-0">
                  <h2 class="my-0 mt-1"><a href="single-property-1.html"
                                                 class="fs-16 text-dark hover-primary lh-2">Garden Gingerbread House</a>
                  </h2>
                  <p class="text-gray-light font-weight-500 mb-1">1421 San Pedro St, Los Angeles</p>
                  <p class="fs-17 font-weight-bold text-heading mb-0">$1.250.000</p>
                </div>
        ...
        <div class="container container-xxl">
          ...
          <div class="slick-slider mx-n2"
            ...
            <div class="box px-2" data-animate="fadeInUp">
              <div class="card border-0 hover-change-image">
                <div class="rounded-lg bg-overlay-gradient-7 bg-hover-overlay-gradient-3 card-img">
                  <img src="images/properties-grid-23.jpg"
                             alt="Villa on Hollywood Boulevard">
                  <div class="card-img-overlay d-flex flex-column justify-content-between">
                    <div>
            ...
            <div class="box px-2" data-animate="fadeInUp">
              <div class="card border-0 hover-change-image">
                <div class="rounded-lg bg-overlay-gradient-7 bg-hover-overlay-gradient-3 card-img">
                  <img src="images/properties-grid-24.jpg"
                             alt="Home in Metric Way">
                  <div class="card-img-overlay d-flex flex-column justify-content-between">
                    <div>
                      <span class="badge mr-2 badge-indigo">For Rent</span>
            ...
            <div class="box px-2" data-animate="fadeInUp">
              <div class="card border-0 hover-change-image">
                <div class="rounded-lg bg-overlay-gradient-7 bg-hover-overlay-gradient-3 card-img">
                  <img src="images/properties-grid-25.jpg"
                             alt="Affordable Urban House">
                  <div class="card-img-overlay d-flex flex-column justify-content-between">
                    <div>
                      <span class="badge mr-2 badge-orange">Featured</span>
            ...
            <div class="box px-2" data-animate="fadeInUp">
              <div class="card border-0 hover-change-image">
                <div class="rounded-lg bg-overlay-gradient-7 bg-hover-overlay-gradient-3 card-img">
                  <img src="images/properties-grid-26.jpg"
                             alt="Explore Old Barcelona">
                  <div class="card-img-overlay d-flex flex-column justify-content-between">
                    <div>
                      <span class="badge mr-2 badge-indigo">For Rent</span>
            ...
            <div class="row info-box-3 mt-7 no-gutters mx-auto">
                ...
                <a href="listing-with-left-sidebar.html"
                  ...
                  <div class="card-img-top d-flex align-items-center justify-content-center border-md-right rounded-0">
                    <div class=" position-relative">
                      ...
                      <img src="images/white-verified.png" class="image"
                                     alt="Apartment">
                    </div>
                  </div>
                  ...
                  <div class="card-img-top d-flex align-items-center justify-content-center border-md-right rounded-0">
                    <div class=" position-relative">
                      <img src="images/sofa.png"
                                     class="hover-image position-absolute pos-fixed-top" alt="House">
                      <img src="images/white-sofa.png" class="image"
                                     alt="House">
                    </div>
                  </div>
                  <div class="card-body px-0 pt-5 pb-0">
              ...
              <div class="col-md-3 col-sm-6 mb-6 mb-md-0" data-animate="zoomIn">
                <a href="listing-with-left-sidebar.html"
                  ...
                  <div class="card-img-top d-flex align-items-center justify-content-center border-md-right rounded-0">
                    <div class=" position-relative">
                      <img src="images/architecture-and-city.png"
                                     class="hover-image position-absolute pos-fixed-top" alt="Office">
                      <img src="images/white-architecture-and-city.png" class="image"
                                     alt="Office">
                    </div>
                  </div>
                  <div class="card-body px-0 pt-5 pb-0">
              ...
              <div class="col-md-3 col-sm-6 mb-6 mb-md-0" data-animate="zoomIn">
                <a href="listing-with-left-sidebar.html"
                  ...
                  <div class="card-img-top d-flex align-items-center justify-content-center  rounded-0">
                    <div class=" position-relative">
                      <img src="images/eco-house.png"
                                     class="hover-image position-absolute pos-fixed-top" alt="Villa">
                      <img src="images/white-eco-house.png" class="image"
                                     alt="Villa">
                    </div>
                  </div>
                  <div class="card-body px-0 pt-5 pb-0">
      ...
      <section class="pt-lg-13 pb-lg-9 mt-lg-1 py-11">
        <div class="container container-xxl">
          <div class="row">
            <div class="col-lg-6">
              <h2 class="text-heading mb-6">From Our Blog</h2>
              <div class="card border-0 mb-7" data-animate="fadeInLeft">
                <div class="row no-gutters align-items-lg-center h-100">
                  <div class="d-flex align-items-end p-0 col-sm-4">
                    <a href="blog-details-1.html" class="hover-shine">
                      <img src="images/post-02.jpg" class="card-img"
                                     alt="Retail banks wake up to digital lending this year">
                    </a>
                    <a href="#"
                               class="badge pos-fixed-bottom text-white bg-dark-opacity-04 fs-13 m-2 font-weight-500 bg-hover-primary hover-white position-absolute">
                      rental
                    </a>
                  </div>
                  <div class="col-sm-8">
                    <div class="card-body pl-sm-6 px-0 pt-5 pt-lg-0 pb-0">
                      <div class="fs-15 mb-0 mb-md-2 text-gray">
                        30th Dec, 2020
                      </div>
              ...
              <div class="card border-0 mb-7" data-animate="fadeInLeft">
                <div class="row no-gutters align-items-lg-center h-100">
                  <div class="d-flex align-items-end p-0 col-sm-4">
                    <a href="blog-details-1.html" class="hover-shine">
                      <img src="images/post-01.jpg" class="card-img"
          ...
          <div class="slick-slider mx-n2"
            ...
            <div class="box px-2" data-animate="zoomIn">
              <div class="card text-white bg-overlay-gradient-5 hover-zoom-in">
                <img src="images/properties-city-06.jpg" class="card-img" alt="New York">
            ...
            <div class="box px-2" data-animate="zoomIn">
              <div class="card text-white bg-overlay-gradient-5 hover-zoom-in">
                <img src="images/properties-city-07.jpg" class="card-img" alt="Los Angeles">
                <div class="card-img-overlay d-flex justify-content-end flex-column p-4">
                  <h2 class="mb-0 fs-20 lh-182"><a href="single-property-1.html" class="text-white">Los Angeles</a></h2>
                  <p class="fs-13 font-weight-500 letter-spacing-087 mb-0">FROM<span
                                class="ml-2 fs-15 font-weight-bold">$520.000 - $700.000</span>
                  </p>
                </div>
              </div>
            </div>
            <div class="box px-2" data-animate="zoomIn">
              <div class="card text-white bg-overlay-gradient-5 hover-zoom-in">
                <img src="images/properties-city-08.jpg" class="card-img" alt="San Jose">
                <div class="card-img-overlay d-flex justify-content-end flex-column p-4">
            ...
            <div class="box px-2" data-animate="zoomIn">
              <div class="card text-white bg-overlay-gradient-5 hover-zoom-in">
                <img src="images/properties-city-09.jpg" class="card-img" alt="Fort Worth">
                <div class="card-img-overlay d-flex justify-content-end flex-column p-4">
                  <h2 class="mb-0 fs-20 lh-182"><a href="single-property-1.html" class="text-white">Fort Worth</a></h2>
                  <p class="fs-13 font-weight-500 letter-spacing-087 mb-0">FROM<span
                                class="ml-2 fs-15 font-weight-bold">$240.000 - $660.000</span>
                  </p>
                </div>
              </div>
            </div>
            <div class="box px-2" data-animate="zoomIn">
              <div class="card text-white bg-overlay-gradient-5 hover-zoom-in">
                <img src="images/properties-city-10.jpg" class="card-img" alt="Kansas City">
                <div class="card-img-overlay d-flex justify-content-end flex-column p-4">
                  <h2 class="mb-0 fs-20 lh-182"><a href="single-property-1.html" class="text-white">Kansas City</a></h2>
                  <p class="fs-13 font-weight-500 letter-spacing-087 mb-0">FROM<span
                                class="ml-2 fs-15 font-weight-bold">$380.000 - $680.000</span>
                  </p>
                </div>
              </div>
            </div>

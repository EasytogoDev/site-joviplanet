...
<html lang="en">
  <head>
    ...
    <!-- Facebook -->
    <meta property="og:url" content="password-recovery.html">
            ...
            <div class="col-lg-7 mx-auto">
              <div class="card border-0 shadow-xxs-2 login-register">
                <div class="card-body p-6">
                  ...
                  <p class="mb-4">Don’t have an account yet? <a href="signup-and-login.html" class="text-heading hover-primary"><u>Sign
                        up for free</u></a></p>
                  <form class="form">
                    ...
                    <button type="submit" class="btn btn-primary btn-lg rounded">Get new password
                    </button>
                  </form>

...
<html lang="en">
  ...
  <body>
    <header class="main-header navbar-light header-sticky header-sticky-smart header-mobile-lg header-landing position-absolute fixed-top">
      <div class="sticky-area">
          ...
          <nav class="navbar navbar-expand-lg px-0">
            ...
            <div class="d-flex d-lg-none ml-auto">
              <button class="navbar-toggler border-0 px-0" type="button" data-toggle="collapse"
                            data-target="#landingMenu"
                            aria-controls="landingMenu" aria-expanded="false" aria-label="Toggle navigation">
                <span class="text-white fs-24"><i class="fal fa-bars"></i></span>
              </button>
            </div>
            <div class="collapse navbar-collapse mt-3 mt-lg-0 mx-auto justify-content-center" id="landingMenu">
              <ul class="navbar-nav hover-menu main-menu px-0 mx-lg-n4">
                <li id="navbar-demos" aria-haspopup="true" aria-expanded="false"
        class="nav-item py-2 py-lg-5 px-0 px-lg-4">
           ...
           href="#demos" >
                ...
                <li id="navbar-listing" aria-haspopup="true" aria-expanded="false"
        class="nav-item py-2 py-lg-5 px-0 px-lg-4">
                  <a class="nav-link p-0"
           href="#listing" >
                    Listing
                ...
                <li id="navbar-property" aria-haspopup="true" aria-expanded="false"
        class="nav-item py-2 py-lg-5 px-0 px-lg-4">
                  <a class="nav-link p-0"
           href="#property" >
                    Property
                ...
                <li id="navbar-dashboard" aria-haspopup="true" aria-expanded="false"
        class="nav-item py-2 py-lg-5 px-0 px-lg-4">
                  <a class="nav-link p-0"
           href="#dashboard" >
                    Dashboard
                ...
                <li id="navbar-docs" aria-haspopup="true" aria-expanded="false"
        class="nav-item dropdown py-2 py-lg-5 px-0 px-lg-4">
           ...
           href="https://sp.g5plus.net/" target="_blank">
              ...
              <div class="ml-auto d-block d-lg-none mt-2">
                <a class="btn btn-primary btn-lg"
                           href="#">
                  Purchase
                  <span class="d-inline-block ml-1"><i class="fal fa-long-arrow-right"></i></span>
                </a>
              </div>
            </div>
            <div class="ml-auto d-none d-lg-block">
              <a class="btn btn-primary btn-lg shadow-xs-6"
                       href="#">
                Purchase
                <span class="d-inline-block ml-1"><i class="fal fa-long-arrow-right"></i></span>
              </a>
      ...
      <section class="position-relative bg-gray-02 vh-100 landing-banner d-flex align-items-center py-lg-13 overflow-hidden">
        ...
        <div class="d-none d-xl-block">
          <div class="layer position-absolute z-index-1 d-none d-xxl-block" style="top:8%;left:-160px">
            <img src="images/banner-landing-01.png" alt="Banner Landing 01">
          </div>
          <div class="layer position-absolute z-index-1 d-block d-xxl-none" style="top:8%;left:-100px">
            <img src="images/banner-landing-01-sm.png" alt="Banner Landing 01">
          </div>
          <div class="layer position-absolute z-index-1" style="top:60%;left:5%">
            <div class="position-relative">
              <img src="images/banner-landing-02.png" alt="Banner Landing 02"
                     class="d-none d-xxl-block">
              <img src="images/banner-landing-02-sm.png" alt="Banner Landing 02"
                     class="d-block d-xxl-none">
              <div class="position-absolute" style="right:-30px;top:-30px">
                <img src="images/banner-landing-03.png" alt="Banner Landing 03"
                         class="d-none d-xxl-block">
                <img src="images/banner-landing-03-sm.png" alt="Banner Landing 03"
                         class="d-block d-xxl-none">
              </div>
            </div>
          </div>
          <div class="layer position-absolute z-index-1 d-none d-xxl-block" style="top:13%;right:10%">
            <div class="position-relative">
              <img src="images/banner-landing-04.png" alt="Banner Landing 04">
              <div class="position-absolute" style="left:-3px;top:-10px">
                <img src="images/banner-landing-05.png" alt="Banner Landing 05">
              </div>
            </div>
          </div>
          <div class="layer position-absolute z-index-1 d-block d-xxl-none" style="top:13%;right:8%">
            <div class="position-relative">
              <img src="images/banner-landing-04-sm.png" alt="Banner Landing 04">
              <div class="position-absolute" style="left:-3px;top:-10px">
                <img src="images/banner-landing-05-sm.png" alt="Banner Landing 05">
              </div>
            </div>
          </div>
          <div class="layer position-absolute z-index-1 d-none d-xxl-block" style="top:40%;right:-100px">
            <div class="position-relative">
              <img src="images/banner-landing-06.png" alt="Banner Landing 06">
              <div class="position-absolute" style="bottom:-100px;left:-35px">
                <img src="images/banner-landing-07.png" alt="Banner Landing 07">
              </div>
            </div>
          </div>
          <div class="layer position-absolute z-index-1 d-block d-xxl-none" style="top:40%;right:-100px">
            <div class="position-relative">
              <img src="images/banner-landing-06-sm.png" alt="Banner Landing 06">
              <div class="position-absolute" style="bottom:-33px;left:-23px">
                <img src="images/banner-landing-07-sm.png" alt="Banner Landing 07">
              </div>
            </div>
          </div>
          <div class="layer position-absolute z-index-1 d-none d-xxl-block" style="bottom:5%;right:26%">
            <img src="images/banner-landing-08.png" alt="Banner Landing 08">
          </div>
          <div class="layer position-absolute z-index-1 d-block d-xxl-none" style="bottom:0%;right:26%">
            <img src="images/banner-landing-08-sm.png" alt="Banner Landing 08"
            >
          </div>
        </div>
      </section>
          ...
          <div class="container container-xxl">
            <div class="row mx-xl-n6">
              <div class="col-lg-4 col-sm-6 box-shadow-lg-5 px-xl-6 mb-9" data-animate="fadeInUp">
                <a href="home-01.html" class="hover-shine d-block"> <img
                            src="images/home-landing-01.jpg"
                            class="rounded-lg" alt="Home 01"></a>
                  <h4 class="mt-lg-7 mt-5 mb-0 text-center"><a class="fs-20 text-white lh-16"
                                                                 href="home-01.html">Home 01</a></h4>
                </div>
                <div class="col-lg-4 col-sm-6 box-shadow-lg-5 px-xl-6 mb-9" data-animate="fadeInUp">
                  <a href="home-02.html" class="hover-shine d-block"> <img
                            src="images/home-landing-02.jpg"
                            class="rounded-lg" alt="Home 02"></a>
                    <h4 class="mt-lg-7 mt-5 mb-0 text-center"><a class="fs-20 text-white lh-16"
                                                                 href="home-02.html">Home 02</a></h4>
                  </div>
                  <div class="col-lg-4 col-sm-6 box-shadow-lg-5 px-xl-6 mb-9" data-animate="fadeInUp">
                    <a href="home-03.html" class="hover-shine d-block"> <img
                            src="images/home-landing-03.jpg"
                            class="rounded-lg" alt="Home 03"></a>
                      <h4 class="mt-lg-7 mt-5 mb-0 text-center"><a class="fs-20 text-white lh-16"
                                                                 href="home-03.html">Home 03</a></h4>
                    </div>
                    <div class="col-lg-4 col-sm-6 box-shadow-lg-5 px-xl-6 mb-9" data-animate="fadeInUp">
                      <a href="home-04.html" class="hover-shine d-block"> <img
                            src="images/home-landing-04.jpg"
                            class="rounded-lg" alt="Home 04"></a>
                        <h4 class="mt-lg-7 mt-5 mb-0 text-center"><a class="fs-20 text-white lh-16"
                                                                 href="home-04.html">Home 04</a></h4>
                      </div>
                      <div class="col-lg-4 col-sm-6 box-shadow-lg-5 px-xl-6 mb-9" data-animate="fadeInUp">
                        <a href="home-05.html" class="hover-shine d-block"> <img
                            src="images/home-landing-05.jpg"
                            class="rounded-lg" alt="Home 05"></a>
                          <h4 class="mt-lg-7 mt-5 mb-0 text-center"><a class="fs-20 text-white lh-16"
                                                                 href="home-05.html">Home 05</a></h4>
                        </div>
                        <div class="col-lg-4 col-sm-6 box-shadow-lg-5 px-xl-6 mb-9" data-animate="fadeInUp">
                          <a href="home-06.html" class="hover-shine d-block"> <img
                            src="images/home-landing-06.jpg"
                            class="rounded-lg" alt="Home 06"></a>
                            <h4 class="mt-lg-7 mt-5 mb-0 text-center"><a class="fs-20 text-white lh-16"
                                                                 href="home-06.html">Home 06</a></h4>
                          </div>
                          <div class="col-lg-4 col-sm-6 box-shadow-lg-5 px-xl-6 mb-9" data-animate="fadeInUp">
                            <a href="home-07.html" class="hover-shine d-block"> <img
                            src="images/home-landing-07.jpg"
                            class="rounded-lg" alt="Home 07"></a>
                              <h4 class="mt-lg-7 mt-5 mb-0 text-center"><a class="fs-20 text-white lh-16"
                                                                 href="home-07.html">Home 07</a></h4>
                            </div>
                            <div class="col-lg-4 col-sm-6 box-shadow-lg-5 px-xl-6 mb-9" data-animate="fadeInUp">
                              <a href="home-08.html" class="hover-shine d-block"> <img
                            src="images/home-landing-08.jpg"
                            class="rounded-lg" alt="Home 08"></a>
                                <h4 class="mt-lg-7 mt-5 mb-0 text-center"><a class="fs-20 text-white lh-16"
                                                                 href="home-08.html">Home 08</a></h4>
                              </div>
                              <div class="col-lg-4 col-sm-6 box-shadow-lg-5 px-xl-6 mb-9" data-animate="fadeInUp">
                                <a href="#" class="hover-shine d-block"> <img
                            src="images/home-landing-09.jpg"
                            class="rounded-lg" alt="New Demos <br/>are Coming Soon !"></a>
                                  <h4 class="mt-lg-7 mt-5 mb-0 text-center"><a class="fs-20 text-white lh-16"
                                                                 href="#">New Demos <br/>
                                      are Coming Soon !</a></h4>
                                </div>
                              </div>
                            </div>
                          </div>
                ...
                class="text-heading font-weight-500">optimized features</span> are integrated into HomeID to help you
                            ...
                            <div class="row mx-xl-n6">
                              <div class="col-lg-4 col-sm-6 px-xl-6 pb-xl-9 pb-6" data-animate="fadeInUp">
                                <div class="card border-0 text-center shadow-lg-6 border-radius-10 hover-to-top overflow-hidden">
                                  <img class="card-img" src="images/landing-feature-01.jpg" alt="Compare Property">
                                  <div class="card-body py-7 px-xxl-7 border-top position-relative mh-sm-243">
                                    <img class="custom-img-ft-landing position-absolute"
                             src="images/icon-landing-feature-01.png" alt="icon">
                              ...
                              <div class="col-lg-4 col-sm-6 px-xl-6 pb-xl-9 pb-6" data-animate="fadeInUp">
                                <div class="card border-0 text-center shadow-lg-6 border-radius-10 hover-to-top overflow-hidden">
                                  <img class="card-img" src="images/landing-feature-02.jpg" alt="Mortgage Calculator">
                                  <div class="card-body py-7 px-xxl-7 border-top position-relative mh-sm-243">
                                    <img class="custom-img-ft-landing position-absolute"
                             src="images/icon-landing-feature-02.png" alt="icon">
                              ...
                              <div class="col-lg-4 col-sm-6 px-xl-6 pb-xl-9 pb-6" data-animate="fadeInUp">
                                <div class="card border-0 text-center shadow-lg-6 border-radius-10 hover-to-top overflow-hidden">
                                  <img class="card-img" src="images/landing-feature-03.jpg" alt="Google Analytic Integration">
                                  <div class="card-body py-7 px-xxl-7 border-top position-relative mh-sm-243">
                                    <img class="custom-img-ft-landing position-absolute"
                             src="images/icon-landing-feature-03.png" alt="icon">
                              ...
                              <div class="col-lg-4 col-sm-6 px-xl-6 pb-xl-9 pb-6" data-animate="fadeInUp">
                                <div class="card border-0 text-center shadow-lg-6 border-radius-10 hover-to-top overflow-hidden">
                                  <img class="card-img" src="images/landing-feature-04.jpg" alt="Wishlist">
                                  <div class="card-body py-7 px-xxl-7 border-top position-relative mh-sm-243">
                                    <img class="custom-img-ft-landing position-absolute"
                             src="images/icon-landing-feature-04.png" alt="icon">
                              ...
                              <div class="col-lg-4 col-sm-6 px-xl-6 pb-xl-9 pb-6" data-animate="fadeInUp">
                                <div class="card border-0 text-center shadow-lg-6 border-radius-10 hover-to-top overflow-hidden">
                                  <img class="card-img" src="images/landing-feature-05.jpg" alt="Agents & Agencies">
                                  <div class="card-body py-7 px-xxl-7 border-top position-relative mh-sm-243">
                                    <img class="custom-img-ft-landing position-absolute"
                             src="images/icon-landing-feature-05.png" alt="icon">
                              ...
                              <div class="col-lg-4 col-sm-6 px-xl-6 pb-xl-9 pb-6" data-animate="fadeInUp">
                                <div class="card border-0 text-center shadow-lg-6 border-radius-10 hover-to-top overflow-hidden">
                                  <img class="card-img" src="images/landing-feature-06.jpg" alt="Mobile Friendly">
                                  <div class="card-body py-7 px-xxl-7 border-top position-relative mh-sm-243">
                                    <img class="custom-img-ft-landing position-absolute"
                             src="images/icon-landing-feature-06.png" alt="icon">
                        ...
                        <section class="pt-15 pb-10"
         style="background-image: url('images/bg-property-details.png');background-position: right bottom;background-repeat: no-repeat;">
                          <div class="container container-xxl">
                            <div class="row">
                              <div class="col-xl-5 mb-8 mb-xl-0" data-animate="fadeInLeft">
                                <div class="row align-items-center">
                                  <div class="col-sm-6 col-xl-12">
                                    <h2 class="fs-36 fs-md-44 lh-143 mb-7 text-center text-sm-left"> The Property<br>
                                      Detail Page includes<br>
                                      the following Features
                                    </h2>
                                  </div>
                                  <div class="col-sm-6 col-xl-12 ml-n4 text-center text-sm-right text-xl-left">
                                    <img src="images/property-details-landing.png" alt="The Property
                              ...
                              <div class="col-xl-7" data-animate="fadeInRight">
                                <div class="row">
                                  <div class="col-sm-6 mb-7">
                                    <div class="media">
                                      <img src="images/icon-property-details-01.png"
                                 alt="Schedule Property Tour" class="mr-5">
                                      <div class="media-body">
                                        <h4 class="fs-20 text-dark lh-16 mb-2">Schedule Property Tour</h4>
                                        <p class="text-landing fs-15">Visitors can schedule an appointment online and arrange a
                                          property viewing easily with our schedule function.
                                        </p>
                                      </div>
                                    </div>
                                  </div>
                                  <div class="col-sm-6 mb-7">
                                    <div class="media">
                                      <img src="images/icon-property-details-04.png"
                                 alt="Floor Plans" class="mr-5">
                                      <div class="media-body">
                                        <h4 class="fs-20 text-dark lh-16 mb-2">Floor Plans</h4>
                                        <p class="text-landing fs-15">Each floor plan can be uploaded on the single property
                                          page to provide the audience with additional information of size, the number of
                                          rooms…
                                        </p>
                                      </div>
                                    </div>
                                  ...
                                  <div class="col-sm-6 mb-9">
                                    <div class="media">
                                      <img src="images/icon-property-details-02.png"
                                 alt="360 Virtual Tour" class="mr-5">
                                      <div class="media-body">
                                        <h4 class="fs-20 text-dark lh-16 mb-2">360 Virtual Tour</h4>
                                        <p class="text-landing fs-15">A convenient way to help the audience to have an overview
                                          of the property online right in the single property page.
                                        </p>
                                      </div>
                                    </div>
                                  </div>
                                  <div class="col-sm-6 mb-9">
                                    <div class="media">
                                      <img src="images/icon-property-details-05.png"
                                 alt="Nearby Listings" class="mr-5">
                                      <div class="media-body">
                                        <h4 class="fs-20 text-dark lh-16 mb-2">Nearby Listings</h4>
                                        <p class="text-landing fs-15">Providing your customer with an overview of the property’s
                                          nearby area such as school, store, hospital…
                                        </p>
                                      </div>
                                    </div>
                                  </div>
                                  <div class="col-sm-6 mb-7">
                                    <div class="media">
                                      <img src="images/icon-property-details-03.png"
                                 alt="Google Analytics Integration" class="mr-5">
                                      <div class="media-body">
                                        <h4 class="fs-20 text-dark lh-16 mb-2">Google Analytics Integration</h4>
                                        <p class="text-landing fs-15">This function allows admin to control the statistics of
                                          the property such as the number of views in that property page.
                                        </p>
                                      </div>
                                    </div>
                                  </div>
                            ...
                            <div class="row align-items-center">
                              <div class="col-lg-6" data-animate="fadeInLeft">
                                ...
                                <p class="text-landing lh-188 mxw-545 fs-16 mb-lg-11 mb-8">
                                  ...
                                  HomeID to meet any requirements from visitors in finding their dream home.</p>

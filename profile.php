...
<html lang="en">
  <head>
    ...
    <title>My Profile - Joviplanet</title>
    <!-- Google fonts -->
                ...
                <div class="row mb-6">
                  <div class="col-lg-6">
                    ...
                    <div class="card mb-6">
                      <div class="card-body px-6 pt-6 pb-5">
                        ...
                        <div class="col-md-6 px-4">
                                  ...
                                  <label for="agent/imobilaria" class="text-heading">Agent/Imobiliaria</label>
                                  <select class="form-control form-control-lg border-0" id="fumarIMOVEL" name="fumarIMOVEL">
                                  <option value="">Select...</option>
                                  <option value="Sim">Agent</option>
                                  <option value="Não">Imobiliaria</option>
                                  </select>
                                  </div>
                                  </div>
                                  <div class="form-group col-md-6 px-4 mb-md-0">
                            <label for="skype" class="text-heading">Idiomas</label>
                            <input type="text" class="form-control form-control-lg border-0" id="Idiomas"
                                       name="idiomas">
                          </div>
                        ...
                        <div class="form-row mx-n4">
                          ...
                          <div class="form-group col-md-6 px-4">
                            <label for="mobile" class="text-heading">Nome/Imobiliaria</label>
                        ...
                        <div class="form-row mx-n4">
                          ...
                          <div class="form-group col-md-6 px-4 mb-md-0">
                            <label for="skype" class="text-heading">Documento/AMI</label>
                    ...
                    <div class="card mb-6 mb-lg-0">
                      <div class="card-body px-6 pt-6 pb-5">
                        <h3 class="card-title mb-0 text-heading fs-22 lh-15">Sobre</h3>
                        <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
                        <div class="form-group mb-0">
                          <label for="title" class="text-heading">Description</label>
                          <textarea class="form-control form-control-lg border-0" rows="4" cols="50" ></textarea>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-6">
                    <div class="card mb-6">
                      <div class="card-body px-6 pt-6 pb-5">
                        <h3 class="card-title mb-0 text-heading fs-22 lh-15">Social detail</h3>

            ...
            <div class="px-3 px-lg-6 px-xxl-13 py-5 py-lg-10">
              <div class="d-flex flex-wrap flex-md-nowrap mb-6">
                <div class="mr-0 mr-md-auto">
                  <h2 class="mb-0 text-heading fs-22 lh-15">My Bookings<span
                  ...
                  <tbody>
                    <tr class="shadow-hover-xs-2 bg-hover-white">
                      ...
                      <td class="align-middle">
                        <span
                                class="badge text-capitalize font-weight-normal fs-12 badge-yellow">pending</span>
                      </td>
                      <td class="align-middle">2049</td>
                      <td class="align-middle">
                        <a href="#" data-toggle="tooltip" title="Edit" class="d-inline-block fs-18 text-muted hover-primary mr-5"><i
                                class="fal fa-pencil-alt"></i></a>
                        <a href="#" data-toggle="tooltip" title="Delete" class="d-inline-block fs-18 text-muted hover-primary"><i
                    ...
                    <tr class="shadow-hover-xs-2 bg-hover-white">
                      <td class="align-middle pt-6 pb-4 px-6">
                        <div class="media">
                          <div class="w-120px mr-4 position-relative">
                            ...
                            <span class="badge badge-primary position-absolute pos-fixed-top">for sale</span>
                          </div>
                          <div class="media-body">
                            <a href="single-property-1.html" class="text-dark hover-primary">
                              <h5 class="fs-16 mb-0 lh-18">Garden Gingerbread House</h5>
                            </a>
                            <p class="mb-1 font-weight-500">1421 San Pedro St, Los Angeles</p>
                      ...
                      <td class="align-middle">
                        <span
                                class="badge text-capitalize font-weight-normal fs-12 badge-pink">published</span>
                      </td>
                      <td class="align-middle">2049</td>
                      <td class="align-middle">
                        <a href="#" data-toggle="tooltip" title="Edit" class="d-inline-block fs-18 text-muted hover-primary mr-5"><i
                    ...
                    <tr class="shadow-hover-xs-2 bg-hover-white">
                      <td class="align-middle pt-6 pb-4 px-6">
                        <div class="media">
                          ...
                          <div class="media-body">
                            <a href="single-property-1.html" class="text-dark hover-primary">
                              <h5 class="fs-16 mb-0 lh-18">Affordable Urban House</h5>
                            </a>
                            <p class="mb-1 font-weight-500">1421 San Pedro St, Los Angeles</p>
                            <span class="text-heading lh-15 font-weight-bold fs-17">$2500</span>
                            <span class="text-gray-light">/month</span>
                      ...
                      <td class="align-middle">
                        <span
                                class="badge text-capitalize font-weight-normal fs-12 badge-pink">processing</span>
                      </td>
                      <td class="align-middle">2049</td>
                      <td class="align-middle">
                        <a href="#" data-toggle="tooltip" title="Edit" class="d-inline-block fs-18 text-muted hover-primary mr-5"><i
                    ...
                    <tr class="shadow-hover-xs-2 bg-hover-white">
                      <td class="align-middle pt-6 pb-4 px-6">
                        <div class="media">
                          ...
                          <div class="media-body">
                            <a href="single-property-1.html" class="text-dark hover-primary">
                              <h5 class="fs-16 mb-0 lh-18">Villa on Hollywood Boulevard</h5>
                            </a>
                            <p class="mb-1 font-weight-500">1421 San Pedro St, Los Angeles</p>
                            <span class="text-heading lh-15 font-weight-bold fs-17">$.1250.000</span>
                          </div>
                    ...
                    <tr class="shadow-hover-xs-2 bg-hover-white">
                      <td class="align-middle pt-6 pb-4 px-6">
                        <div class="media">
                          ...
                          <div class="media-body">
                            <a href="single-property-1.html" class="text-dark hover-primary">
                              <h5 class="fs-16 mb-0 lh-18">Explore Old Barcelon</h5>
                            </a>
                            <p class="mb-1 font-weight-500">1421 San Pedro St, Los Angeles</p>
                            <span class="text-heading lh-15 font-weight-bold fs-17">$2500</span>
                            <span class="text-gray-light">/month</span>

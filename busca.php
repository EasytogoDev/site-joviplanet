...
<html lang="en">
  <head>
    ...
    <title>Resultados da Busca Jovi PLanet</title>
    <!-- Google fonts -->
    ...
    <meta name="twitter:title" content="Listing Half Map Grid Layout 2">
    <meta name="twitter:description" content="Real Estate Html Template">
    <meta name="twitter:image" content="images/homeid-social-logo.png">
    <!-- Facebook -->
    <meta property="og:url" content="listing-half-map-grid-layout-2.html">
    <meta property="og:title" content="Listing Half Map Grid Layout 2">
  ...
  <div class="gtranslate_wrapper"></div>
    ...
    <main id="content">
      ...
      <section class="pt-6 pb-5 shadow-xs-1" style=" background: #ba824f;">
        <div class="container-fluid px-xxl-8">
          <form class="form-inline mx-n1" id="accordion-5">
            <div class="form-group p-1">
              <label for="location-2" class="sr-only">Location</label>
            ...
            <div class="form-group p-1">
              <a href="#advanced-search-filters-5" class="btn bg-transparent border-0 shadow-xxs-1 text-gray-light"
            ...
            <div class="form-group p-1 custom-control custom-switch custom-switch-right ml-lg-auto">
              ...
              <input type="checkbox" class="custom-control-input" name="features" id="customSwitch1"
                       checked>
              <label class="custom-control-label h-24" for="customSwitch1"></label>
            </div>
            <div id="advanced-search-filters-5" class="row pb-6 pt-2 collapse p-1" data-parent="#accordion-5">
              <div class="col-sm-6 col-md-4 col-lg-3 py-2">
                <div class="custom-control custom-checkbox">
      ...
      <section class="position-relative">
        <div class="container-fluid px-0">
          <div class="row no-gutters">
            <div class="col-xl-6 pt-7 pb-11 order-2 order-xl-1 px-3 px-xxl-8">
                ...
                <div class="col-md-6 mt-6 mt-md-0 col-xl-7 col-xxl-6">
                  <div class="d-flex justify-content-md-end align-items-center">
                    ...
                    <div class="d-none d-md-block">
                      <a class="fs-sm-18 text-dark opacity-2"
              ...
              <div class="row mx-lg-n2">
                ...
                <div class="col-lg-4 col-sm-6 pb-6 px-lg-2" data-animate="fadeInUp">
                  <div class="card border-0 hover-change-image">
                    <div class="bg-overlay-gradient-1 bg-hover-overlay-gradient-3 rounded-lg card-img">
                      <img src="images/properties-grid-78.jpg"
                                     alt="Villa on Hollywood Boulevard">
                      <div class="card-img-overlay d-flex flex-column justify-content-between h-100">
                        <div>
                ...
                <div class="col-lg-4 col-sm-6 pb-6 px-lg-2" data-animate="fadeInUp">
                  <div class="card border-0 hover-change-image">
                    <div class="bg-overlay-gradient-1 bg-hover-overlay-gradient-3 rounded-lg card-img">
                      <img src="images/properties-grid-74.jpg"
                                     alt="Home in Metric Way">
                      <div class="card-img-overlay d-flex flex-column justify-content-between h-100">
                        <div>
                          <span class="badge badge-indigo">for Rent</span>
                ...
                <div class="col-lg-4 col-sm-6 pb-6 px-lg-2" data-animate="fadeInUp">
                  <div class="card border-0 hover-change-image">
                    <div class="bg-overlay-gradient-1 bg-hover-overlay-gradient-3 rounded-lg card-img">
                      <img src="images/properties-grid-75.jpg"
                ...
                <div class="col-lg-4 col-sm-6 pb-6 px-lg-2" data-animate="fadeInUp">
                  <div class="card border-0 hover-change-image">
                    <div class="bg-overlay-gradient-1 bg-hover-overlay-gradient-3 rounded-lg card-img">
                      <img src="images/properties-grid-76.jpg"
                                     alt="Affordable Urban House">
                      <div class="card-img-overlay d-flex flex-column justify-content-between h-100">
                        <div>
                          <span class="badge badge-orange mr-2">Featured</span>
                ...
                <div class="col-lg-4 col-sm-6 pb-6 px-lg-2" data-animate="fadeInUp">
                  <div class="card border-0 hover-change-image">
                    <div class="bg-overlay-gradient-1 bg-hover-overlay-gradient-3 rounded-lg card-img">
                      <img src="images/properties-grid-77.jpg"
                                     alt="Affordable Urban House">
                      <div class="card-img-overlay d-flex flex-column justify-content-between h-100">
                        <div>
                          <span class="badge badge-orange mr-2">Featured</span>
            ...
            <div class="col-xl-6 order-1 order-xl-2 primary-map map-sticky overflow-hidden" id="map-sticky">
      ...
      <div class="d-none" id="template-properties">
        <div class="marker-item" data-icon-marker="images/googlle-market-02.png"
                  ...
                  <div class="mt-auto d-flex hover-image">
                    ...
                    <ul class="list-inline mb-0 mr-n3 d-flex">
                      <li class="list-inline-item mr-3 h-32 d-flex align-items-end"><a href="#"
                                                                                             class="text-white fs-20 hover-primary"><i
         ...
         data-marker-style='{"className":"marker","style":{"width":"45px","height":"48px"},"popup":{"className":"popup-map-property","maxWidth":"269px"}}'>
            ...
            <div class="marker-item" data-icon-marker="images/googlle-market-03.png"

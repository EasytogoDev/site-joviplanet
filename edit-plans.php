...
$SqlPlanos = "SELECT * FROM tb0037_planos WHERE codigoPLANO = '".$pga."'  ";

$queryPlanos = $PDO->prepare($SqlPlanos);
$queryPlanos->execute();


$ResultPlano = $queryPlanos->fetchAll(PDO::FETCH_ASSOC);

$Planos = $ResultPlano[0];
...
<head>
    ...
    <title>Edit Plans - Joviplanet</title>
    <!-- Google fonts -->
    <link
...
<body>
            ...
            <div class="page-content">
                ...
                <main id="content" class="bg-gray-01">
                    <div class="px-3 px-lg-6 px-xxl-13 py-5 py-lg-10">
                        <div class="mb-6">
                            <h2 class="mb-0 text-heading fs-22 lh-15">My Plans
                            </h2>
                            <p class="mb-1">Lorem ipsum dolor sit amet, consec tetur cing elit. Suspe ndisse suscipit
                            </p>
                        </div>
                        <!-- campos ocultos -->
                        <input type="hidden" class="form-control form-control-lg border-0" id="codigoPLANO" name="codigoPLANO" value="<?php echo $Planos['codigoPLANO'];?>">
                                ...
                                <div class="col-lg-12">
                                    <div class="card mb-6">
                                        <div class="card-body px-6 pt-6 pb-5">
                                            <h3 class="card-title mb-0 text-heading fs-22 lh-15">Edit Plans</h3>
                                            <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit
                                            </p>
                                            <div class="form-group">
                                                <label for="facebook" class="text-heading">Type</label>
                                                <select
                                                    class="form-control border-0 shadow-none form-control-lg selectpicker"
                                                    title="Select" data-style="btn-lg py-2 h-52" id="tipoPLANO"
                                                    name="tipoPLANO">
 ...
 -->
                                                    ...
                                                    SELECT codigoTIPOPLANO ,planoTIPOPLANO FROM `tb0155_tipoplanos`
                                                    WHERE ativoTIPOPLANO = 1
";
                                                    try {
                                                    ...
                                                    ?>
                                                    <option
                                                        value="<?php echo $CategoriasImaveis['codigoTIPOPLANO']; ?>"<?php if($Planos['tipoPLANO']==$CategoriasImaveis['codigoTIPOPLANO']){echo 'selected="selected"';}?>>
                                                        <?php echo $CategoriasImaveis['planoTIPOPLANO']; ?>
                                                    </option>
                                            ...
                                            <div class="form-group">
                                                <label for="tempoPLANO" class="text-heading">Periodo</label>
                                                <select
                                                    class="form-control border-0 shadow-none form-control-lg selectpicker"
                                                    title="Select" data-style="btn-lg py-2 h-52" id="tempoPLANO"
                                                    name="tempoPLANO">
                                                    ...
                                                    INNER JOIN tb0159_periodos ON codigoPLANO = planoPERIODO
                                                    WHERE ativoPLANO = 1 AND ativoPERIODO = 1
";
                                                    try {
                                                    ...
                                                    <option
                                                        value="<?php echo $CategoriasImaveis['codigoPLANO']; ?>"<?php if($Planos['tempoPLANO']==$CategoriasImaveis['codigoPLANO']){echo 'selected="selected"';}?>>
                                                        <?php echo $CategoriasImaveis['nomePERIODO']; ?>
                                                    </option>
                                            ...
                                            <div class="form-group">
                                                <label for="nomePLANO" class="text-heading">Name</label>
                                                <input type="text" class="form-control form-control-lg border-0" 
                                                id="nomePLANO" name="nomePLANO" value="<?php echo $Planos['nomePLANO'];?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="slugPLANO" class="text-heading">Slug</label>
                                                <input type="text" class="form-control form-control-lg border-0" 
                                                id="slugPLANO" name="slugPLANO" value="<?php echo $Planos['slugPLANO'];?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="valorPLANO" class="text-heading">Price</label>
                                                <input type="text" class="form-control form-control-lg border-0"
                                                    id="valorPLANO" name="valorPLANO" value="<?php echo $Planos['valorPLANO'];?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="quantidadePLANO" class="text-heading">Quantity</label>
                                                <input type="text" class="form-control form-control-lg border-0"
                                                    id="quantidadePLANO" name="quantidadePLANO" value="<?php echo $Planos['quantidadePLANO'];?>">

                                            </div>
                                            <div class="form-group">
                                                <label for="urlPLANO" class="text-heading">Url</label>
                                                <input type="text" class="form-control form-control-lg border-0"
                                                    id="urlPLANO" name="urlPLANO" value="<?php echo $Planos['urlPLANO'];?>">
                                ...
                                <div class="d-flex justify-content-end flex-wrap">
                                    <button class="btn btn-lg btn-primary ml-4 mb-3" onclick="EditPlano();">Update Plans</button>
                                </div>
                    </div>
                </main>
            </div>
    ...
    <script>
        function EditPlano(){
          $.ajax({
        url: '/require/ajax/my-plans/edit.php',
        type: 'post',
        data: {
          ...
          valorPLANO: $('#valorPLANO').val(),
          quantidadePLANO: $('#quantidadePLANO').val(), 
          slugPLANO: $('#slugPLANO').val(),
          urlPLANO: $('#urlPLANO').val(),
          tempoPLANO: $('#tempoPLANO').val()
        

        },
        success: function (data) {

          alert(data+'Plano editado com sucesso!');

          top.location.href="/edit-plans/"+$('#codigoPLANO').val();

 ...
 <div class="content"   style="padding-top: 0px;">
            ...
            <div class="container">
                <div class="dlab-bnr-inr-entry">
                    <h1 class="text-white"><?php echo $idioma['TituloLinha'];?></h1>
                </div>
            </div>
        </div>
        ...
        <div class="breadcrumb-row">
            <div class="container">
                <ul class="list-inline">
                    ...
                    <li><a href="/<?php echo $idioma['urlProdutos']?>"><?php echo $idioma['TituloLinha'];?></a></li>
                    <li><?php echo $linhas['nomeLINHA'];?></li>
                </ul>
            </div>
        </div>
...
<div class="section-full bg-white content-inner" >
                <div class="container">
                    <div class="section-content">
                        <div class="row">
                            <div class="col-lg-7">
                                <h2 class="text-uppercase"><img src="<?php echo $linhas['imagemLINHA'];?>" width="42" style="border-radius:20px">&nbsp<?php echo $linhas['nomeLINHA'];?> </h2>
...
lancamentoPRODUTO, sulfixoPRODUTO, partnumberPRODUTO, codigoIMAGEMPRODUTO  FROM `tb0015_produtos`
...
GROUP BY slugCATEGORIA,slugenCATEGORIA,slugesCATEGORIA, codigoPRODUTO, slugPRODUTO,slugenPRODUTO,slugesPRODUTO, lancamentoPRODUTO, sulfixoPRODUTO, partnumberPRODUTO, codigoIMAGEMPRODUTO

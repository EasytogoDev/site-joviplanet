...
<div class="section-full bg-white content-inner" >
                <div class="container">
                    <div class="section-content">
                        <div class="row">
                            <div class="col-lg-7">
                                <h2 class="text-uppercase">Lançamentos </h2>
...
$sql = " SELECT slugCATEGORIA, codigoPRODUTO, slugPRODUTO, lancamentoPRODUTO, sulfixoPRODUTO, partnumberPRODUTO, codigoIMAGEMPRODUTO  FROM `tb0015_produtos`
...
INNER JOIN tb0011_linhas_vinculos ON produtoLINHAVINCULO = codigoPRODUTO                        
...
WHERE `lancamentoPRODUTO` = '1' AND ativoPRODUTO = 1 AND dataPRODUTO >= CURDATE() - INTERVAL 365 DAY
...
ORDER BY partnumberPRODUTO ASC LIMIT ".$inicio.",".$quantidade;
 ...
 /**
  ...
  $sqlTotal   = "SELECT slugCATEGORIA, codigoPRODUTO, slugPRODUTO, lancamentoPRODUTO, sulfixoPRODUTO, partnumberPRODUTO, codigoIMAGEMPRODUTO  FROM `tb0015_produtos`
  INNER JOIN tb0012_categorias_vinculos ON codigoPRODUTO = produtoCATEGORIAVINCULO
  INNER JOIN tb0012_categorias ON codigoCATEGORIA = categoriaCATEGORIAVINCULO 
  INNER JOIN tb0011_linhas_vinculos ON produtoLINHAVINCULO = codigoPRODUTO                        
  INNER JOIN tb0011_linhas ON codigoLINHA = linhaLINHAVINCULO
...
<?php
  ...
  /**
    ...
    */
    ?>
        ...
        <?php
        echo "<a class='btn' href='/produtos/lancamentos/".$pgb."/_pagina/1' > << </a> ";
		
        echo "<a class='btn' href='/produtos/lancamentos/".$pgb."/_pagina/".$anterior."' > < </a>";
    ?>
        <?php
         /**
   ...
   for($i = $pagina-$exibir; $i <= $pagina-1; $i++){
       if($i > 0)	
        echo "<a class='btn' href='/produtos/lancamentos/".$pgb."/_pagina/".$i."' > ".$i." </a>";
  }

   echo "<a class='btn' href='/produtos/lancamentos/".$pgb."/_pagina/".$pagina."' style='box-shadow: none; background-color: #ee3131;  color: #fff;'>  ".$pagina."  </a>";
  ...
  for($i = $pagina+1; $i < $pagina+$exibir; $i++){
    ...
    */
    ...
    ?>
    <?php
        echo "<a  class='btn' href='/produtos/lancamentos/".$pgb."/_pagina/".$posterior."' > > </a>";
	
        echo "<a  class='btn' href='/produtos/lancamentos/".$pgb."/_pagina/".$totalPagina."' > >> </a>";
    ?>

...
$sql_Imovel = " SELECT * FROM tb0181_agentes WHERE codigoAGENTE = '".$pga."' ";
...
<html lang="pt">
  <head>
    ...
    <title>Agent Details - Jovi Planet</title>
    <!-- Google fonts -->
    ...
    <meta name="twitter:title" content="Agent Details 2">
    <meta name="twitter:description" content="Real Estate Html Template">
    <meta name="twitter:image" content="/images/homeid-social-logo.png">
    <!-- Facebook -->
    <meta property="og:url" content="agent-details-2.html">
    <meta property="og:title" content="Agent Details 2">
        ...
        <div class="row" style="margin-right: -200px;">
          <div class="col-md-6">
            <div class="pb-6 page-title shadow">
              <h1 class="text-white fs-30 lh-16 mb-1 font-weight-600" data-animate="fadeInRight"><?php echo $imovel['nomeAGENTE'];?>
              </h1>
              <h6 class="text-white mb-1"><?php echo $imovel['categoriaAGENTE'];?></h6>
            </div>
          </div>
        </div> 
      </div>
                  ...
                  <div class="card-footer bg-white px-0 pt-1">
                    <ul class="list-group list-group-no-border mb-7">
                      <li class="list-group-item d-flex align-items-sm-center lh-114 row m-0 px-0 pt-3 pb-0">
                        ...
                        <span class="col-9 p-0 text-heading font-weight-500"><?php echo $imovel['telefoneAGENTE'];?></span>
                      </li>
                      <li class="list-group-item d-flex align-items-sm-center lh-114 row m-0 px-0 pt-3 pb-0">
                        <span class="col-3 p-0 fs-13">Mobile</span>
                        <span class="col-9 p-0 text-heading font-weight-500"><?php echo $imovel['celularAGENTE'];?></span>
                      </li>
                      <li class="list-group-item d-flex align-items-sm-center row m-0 px-0 pt-2 pb-0">
                        <span class="col-3 p-0 fs-13">Email</span>
                        <span class="col-9 p-0"><?php echo $imovel['emailAGENTE'];?></span>
                      </li>
                      <li class="list-group-item d-flex align-items-sm-center lh-114 row m-0 px-0 pt-3 pb-0">
                        <span class="col-3 p-0 fs-13">Social</span>
                        <ul class="col-9 list-inline text-gray-lighter m-0 p-0 z-index-2">
                          <li class="list-inline-item m-0">
                            <a href="<?php echo $imovel['twitterAGENTE'];?>" class="w-32px h-32 rounded bg-hover-primary bg-white hover-white text-body d-flex align-items-center justify-content-center border border-hover-primary"><i
                            class="fab fa-twitter"></i></a>
                          </li>
                          <li class="list-inline-item mr-0 ml-2">
                            <a href="<?php echo $imovel['facebookAGENTE'];?>" class="w-32px h-32 rounded bg-hover-primary bg-white hover-white text-body d-flex align-items-center justify-content-center border border-hover-primary"><i
                            class="fab fa-facebook-f"></i></a>
                          </li>
                          <li class="list-inline-item mr-0 ml-2">
                            <a href="<?php echo $imovel['instagramAGENTE'];?>" class="w-32px h-32 rounded bg-hover-primary bg-white hover-white text-body d-flex align-items-center justify-content-center border border-hover-primary"><i
                            class="fab fa-instagram"></i></a>
                          </li>
                          <li class="list-inline-item mr-0 ml-2">
                            <a href="<?php echo $imovel['linkedinAGENTE'];?>" class="w-32px h-32 rounded bg-hover-primary bg-white hover-white text-body d-flex align-items-center justify-content-center border border-hover-primary"><i
              ...
              <div class="card border-0 mb-10">
                <div class="card-body py-5 px-6">
                  <h3 class="card-title text-heading fs-16 lh-213">
                    About <?php echo $imovel['nomeAGENTE'];?>
                  </h3>
                  <p class="lh-214 mb-6"><?php echo $imovel['descricaoAGENTE'];?></p>
                </div>
              </div>

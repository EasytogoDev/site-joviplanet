...
$SqlImovel = "SELECT * FROM tb0031_imoveis WHERE codigoIMOVEL = '".$pga."'  ";

$queryImovel = $PDO->prepare($SqlImovel);
$queryImovel->execute();


$ResultImovel = $queryImovel->fetchAll(PDO::FETCH_ASSOC);

$Imovels = $ResultImovel[0];
...
<head>
  ...
  <title><?php echo $Imovels['tituloIMOVEL'];?> - Edit Listing - Joviplanet</title>
  <!-- Google fonts -->
  <link
      ...
      <div class="page-content">
        ...
        <main id="content" class="bg-gray-01">
          <div class="px-3 px-lg-6 px-xxl-13 py-5 py-lg-10 my-profile">
            <div class="mb-6">
              <h2 class="mb-0 text-heading fs-22 lh-15">Edit property - <?php echo $Imovels['tituloIMOVEL'];?>
              </h2>
            </div>

            <!--Campos Ocultos-->
            <input type="hidden" class="form-control form-control-lg border-0" id="clienteIMOVEL" name="clienteIMOVEL" value="<?php echo $Imovels['clienteIMOVEL'];?>">
            <input type="hidden" class="form-control form-control-lg border-0" id="codigoIMOVEL" name="codigoIMOVEL" value="<?php echo $Imovels['codigoIMOVEL'];?>">
              ...
              <ul class="nav nav-pills border py-2 px-3 mb-6 d-none d-md-flex mb-6" role="tablist">
                ...
                <li class="nav-item col">
                  <a class="nav-link bg-transparent shadow-none py-2 font-weight-500 text-center lh-214 d-block"
                    id="media-tab" data-toggle="pill" data-number="2." href="#media" role="tab" aria-controls="media"
                    aria-selected="false"><span class="number">2.</span> Media</a>
                </li>
                <li class="nav-item col">
                  <a class="nav-link bg-transparent shadow-none py-2 font-weight-500 text-center lh-214 d-block"
                ...
                <li class="nav-item col">
                  <a class="nav-link bg-transparent shadow-none py-2 font-weight-500 text-center lh-214 d-block"
                    id="detail-tab" data-toggle="pill" data-number="4." href="#detail" role="tab" aria-controls="detail"
                    aria-selected="false"><span class="number">4.</span> Detail</a>
                </li>
                <li class="nav-item col">
                  <a class="nav-link bg-transparent shadow-none py-2 font-weight-500 text-center lh-214 d-block"
                    id="amenities-tab" data-toggle="pill" data-number="5." href="#amenities" role="tab"
                    aria-controls="amenities" aria-selected="false"><span class="number">5.</span> Amenities</a>
                </li>
              </ul>
                                ...
                                <div class="card mb-6">
                                  <div class="card-body p-6">
                                    ...
                                    <div class="form-group">
                                      <label for="tituloIMOVEL" class="text-heading">Title <span
                                          class="text-muted">(mandatory)</span></label>
                                      <input type="text" class="form-control form-control-lg border-0" id="tituloIMOVEL"
                                        name="tituloIMOVEL" value="<?php echo $Imovels['tituloIMOVEL'];?>" >
                                    </div>
                                    <div class="form-group mb-0">
                                      <label for="descricaoIMOVEL" class="text-heading">Description</label>
                                      <textarea class="form-control border-0" rows="5" name="descricaoIMOVEL"
                                        id="descricaoIMOVEL"><?php echo $Imovels['descricaoIMOVEL'];?></textarea>
                                    </div>
                                  ...
                                  <div class="card-body p-6">
                                    ...
                                    <div class="form-row mx-n2">
                                      <div class="col-md-6 col-lg-12 col-xxl-6 px-2 mb-4 mb-md-0">
                                        <div class="form-group mb-0">
                                          <label for="categoriaIMOVEL" class="text-heading">Category</label>
                                          <select class="form-control border-0 shadow-none form-control-lg selectpicker"
                                            title="Select" data-style="btn-lg py-2 h-52" id="categoriaIMOVEL" name="categoriaIMOVEL">

                                            <option value="0" <?php if($Imovels['categoriaIMOVEL']==0){echo 'selected="selected"';}?>>Todos</option>

                                            <?php

                                            $sql_ImovelsImaveis = "
SELECT codigoCATEGORIA, nomeCATEGORIA, imagemCATEGORIA FROM tb0001_categorias WHERE ativoCATEGORIA = 1
";
                                            try {

                                              $query_ImovelsImaveis = $PDO->prepare($sql_ImovelsImaveis);
                                              $query_ImovelsImaveis->execute();
                                            ...
                                            while ($ImovelsImaveis = $query_ImovelsImaveis->fetch(PDO::FETCH_ASSOC)) {

                                              ?>
                                              <option value="<?php echo $ImovelsImaveis['codigoCATEGORIA']; ?>"  <?php if($Imovels['categoriaIMOVEL']==$ImovelsImaveis['codigoCATEGORIA']){echo 'selected="selected"';}?>>
                                                <?php echo $ImovelsImaveis['nomeCATEGORIA']; ?>
                                              </option>
                                      ...
                                      <div class="col-md-6 col-lg-12 col-xxl-6 px-2 mb-4 mb-md-0">
                                        <div class="form-group mb-0">
                                          <label for="tipoIMOVEL" class="text-heading">Type</label>
                                          <select class="form-control border-0 shadow-none form-control-lg selectpicker"
                                            title="Select" data-style="btn-lg py-2 h-52" id="tipoIMOVEL" name="tipoIMOVEL">
                                            <?php

                                            $sql_TipoImoveis = "SELECT codigoTIPOIMOVEL, nomeTIPOIMOVEL FROM tb0035_tipoimovel WHERE ativoTIPOIMOVEL = 1";
                                            try {

                                              $query_TipoImoveis = $PDO->prepare($sql_TipoImoveis);
                                              $query_TipoImoveis->execute();
                                            ...
                                            while ($TipoImoveis = $query_TipoImoveis->fetch(PDO::FETCH_ASSOC)) {

                                              ?>
                                              <option value="<?php echo $TipoImoveis['codigoTIPOIMOVEL']; ?>" <?php if($Imovels['tipoIMOVEL']==$TipoImoveis['codigoTIPOIMOVEL']){echo 'selected="selected"';}?>>
                                                <?php echo $TipoImoveis['nomeTIPOIMOVEL']; ?>
                                              </option>
                                      ...
                                      <div class="col-md-6 col-lg-12 col-xxl-6 px-2 mb-4 mb-md-0">
                                        <div class="form-group mb-0">
                                          <label for="planoIMOVEL" class="text-heading">Plans (Highlights)</label>
                                          <select class="form-control border-0 shadow-none form-control-lg selectpicker"
                                              data-style="btn-lg py-2 h-52" id="planoIMOVEL" name="planoIMOVEL">
                                            <?php

                                            $sql_PlanoImoveis = "SELECT codigoPLANO, nomePLANO, planoTIPOPLANO  
        
                                            FROM tb0037_planos 
                                            INNER JOIN tb0155_tipoplanos ON codigoTIPOPLANO = tipoPLANO
                                            INNER JOIN tb0038_checkout ON planoCHECKOUT = codigoPLANO
                                            WHERE ativoPLANO = 1 AND clienteCHECKOUT = '".$usuario['codigoUSUARIO']."'; ";
                                            try {

                                              $query_PlanoImoveis = $PDO->prepare($sql_PlanoImoveis);
                                              $query_PlanoImoveis->execute();
                                            ...
                                            while ($PlanoImoveis = $query_PlanoImoveis->fetch(PDO::FETCH_ASSOC)) {

                                              ?>
                                              <option value="<?php echo $PlanoImoveis['codigoPLANO']; ?>" <?php if($Imovels['planoIMOVEL']==$PlanoImoveis['codigoPLANO']){echo 'selected="selected"';}?>>
                                              <?php echo $PlanoImoveis['planoTIPOPLANO']; ?> - <?php echo $PlanoImoveis['nomePLANO']; ?>
                                              </option>
                                  ...
                                  <div class="card-body p-6">
                                    ...
                                    <div class="form-row mx-n2">
                                      <div class="col-md-6 col-lg-12 col-xxl-6 px-2">
                                        <div class="form-group">
                                          <label for="valorIMOVEL" class="text-heading">Price in $ <span
                                              class="text-muted">(only numbers)</span></label>
                                          <input type="text" class="form-control form-control-lg border-0" id="valorIMOVEL"
                                            name="valorIMOVEL"  value="<?php echo $Imovels['valorIMOVEL'];?>">
                                        </div>
                                      </div>
                                    </div>
                                    <div class="form-row mx-n2">
                                      ...
                                      <div class="col-md-6 col-lg-12 col-xxl-6 px-2">
                                        <div class="form-group">
                                          <label for="labelvalorIMOVEL" class="text-heading">After Price Label <span
                                              class="text-muted">( ex: /month)</span>
                                          </label>
                                          <input type="text" class="form-control form-control-lg border-0"
                                            id="labelvalorIMOVEL" name="labelvalorIMOVEL"  value="<?php echo $Imovels['labelvalorIMOVEL'];?>">
                                        </div>
                                      </div>
                                    </div>
                                    <div class="form-row mx-n2">
                    ...
                    <div class="tab-pane tab-pane-parent fade px-0" id="media" role="tabpanel"
                      ...
                      <div class="card bg-transparent border-0">
                        <div class="card-header d-block d-md-none bg-transparent px-0 py-1 border-bottom-0"
                          ...
                          <h5 class="mb-0">
                            <button class="btn btn-lg collapse-parent btn-block border shadow-none"
                              data-toggle="collapse" data-number="2." data-target="#media-collapse" aria-expanded="true"
                                ...
                                <div class="card mb-6">
                                  <div class="card-body p-6">
                                    ...
                                    <div class="dropzone upload-file text-center py-5" data-uploader="true"
                                      id="fotosIMOVEL" data-uploader-url="./dashboard-add-new-property.html">
                                    ...
                                    <div class="form-row mx-n2">
                                      ...
                                      <div class="col-md-12 col-lg-12 col-xxl-12 px-2">
                                        <div class="form-group mb-md-0">
                                          <label for="videoIMOVEL" class="text-heading">Embed Video id</label>
                                          <input type="text" name="videoIMOVEL"
                                            class="form-control form-control-lg border-0" id="videoIMOVEL">
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                    ...
                    <div class="tab-pane tab-pane-parent fade px-0" id="location" role="tabpanel"
                      ...
                      <div class="card bg-transparent border-0">
                        ...
                        <div id="location-collapse" class="collapse collapsible" aria-labelledby="heading-location"
                          data-parent="#collapse-tabs-accordion">
                          <div class="card-body py-4 py-md-0 px-0">
                            <div class="row">
                              <div class="col-lg-6">
                                <div class="card mb-6">
                                  <div class="card-body p-6">
                                    ...
                                    <p class="card-text mb-5">Lorem ipsum dolor sit amet, consectetur
                                      adipiscing elit</p>
                                    <div class="form-group">
                                      <label for="enderecoIMOVEL" class="text-heading">Address</label>
                                      <mapbox-address-autofill>
                                        <input type="text" class="form-control form-control-lg border-0"
                                          id="enderecoIMOVEL" name="enderecoIMOVEL"
                                    ...
                                    <div class="form-row mx-n2">
                                      <div class="col-md-6 col-lg-12 col-xxl-6 px-2">
                                        <div class="form-group">
                                          <label for="stateIMOVEL" class="text-heading">State</label>
                                          <input type="text" class="form-control form-control-lg border-0"
                                            id="stateIMOVEL" name="stateIMOVEL" autocomplete="shipping address-level1">
                                        </div>
                                      </div>
                                      <div class="col-md-6 col-lg-12 col-xxl-6 px-2">
                                        <div class="form-group">
                                          <label for="cityIMOVEL" class="text-heading">City</label>
                                          <input type="text" class="form-control form-control-lg border-0" id="cityIMOVEL"
                                            name="cityIMOVEL" autocomplete="shipping address-level2">
                                        </div>
                                      </div>
                                    </div>
                                    <!------------------------------------------------------------------------------------>
                                    <div class="form-row mx-n2">
                                      <div class="col-md-6 col-lg-12 col-xxl-6 px-2">
                                        <div class="form-group">
                                          <label for="postalcode" class="text-heading">ZIP / Postcode</label>
                                          <input type="text" placeholder="ZIP / Postcode"
                                            class="form-control form-control-lg border-0" id="zipcodeIMOVEL"
                                            name="postalcode" autocomplete="shipping postal-code">
                                        </div>
                                      </div>
                                    </div> 
                                    ...
                                    <div class="form-group mb-md-0">
                                      <label for="paisIMOVEL" class="text-heading">Country </label>
                                      <select disabled
                                        class="form-control border-0 shadow-none form-control-lg selectpicker"
                                        title="Select" data-style="btn-lg py-2 h-52" id="paisIMOVEL" name="paisIMOVEL">
                                        ...
                                        $sql_PaisImaveis = "
                                              SELECT codigoPAIS, nomePAIS FROM tb0039_pais WHERE ativoPAIS = 1
                                              ";
                                        try {

                                          $query_PaisImaveis = $PDO->prepare($sql_PaisImaveis);
                                          $query_PaisImaveis->execute();
                                        ...
                                        while ($PaisImaveis = $query_PaisImaveis->fetch(PDO::FETCH_ASSOC)) {

                                          ?>
                                          <option value="<?php echo $PaisImaveis['codigoPAIS']; ?>">
                                            <?php echo $PaisImaveis['nomePAIS']; ?>
                                          </option>
                              ...
                              <div class="col-lg-6">
                                <div class="card mb-6">
                                  <div class="card-body p-6">
                                    ...
                                    <div id="map" class="mapbox-gl map-point-animate mb-6" style="height: 296px"
                                      data-mapbox-access-token="pk.eyJ1IjoiZWFzeXRvZ28iLCJhIjoiY2x1aWw5ajJnMDVyYzJqbnVnMTgyMXYyeCJ9.xn_ZXB7fb683Z6kPtzaAmQ"
                                    ...
                                    <div class="form-row mx-n2">
                                      <div class="col-md-6 col-lg-12 col-xxl-6 px-2">
                                        <div class="form-group mb-md-0">
                                          ...
                                          <input type="text" class="form-control form-control-lg border-0" id="latitude"
                                            name="latitude">
                                        </div>
                                      </div>
                                      <div class="col-md-6 col-lg-12 col-xxl-6 px-2">
                    ...
                    <div class="tab-pane tab-pane-parent fade px-0" id="detail" role="tabpanel"
                      ...
                      <div class="card bg-transparent border-0">
                        ...
                        <div id="detail-collapse" class="collapse collapsible" aria-labelledby="heading-detail"
                          data-parent="#collapse-tabs-accordion">
                          <div class="card-body py-4 py-md-0 px-0">
                            <div class="card mb-6">
                              <div class="card-body p-6">
...
<!---começo-C----------------->
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="metragemIMOVEL" class="text-heading">Area in <span
                                          class="text-muted"></span></label>
                                      <!----<input type="number" class="form-control form-control-lg border-0" id="metragemIMOVEL"
                                        name="metragemIMOVEL">
                                    ----->
                                    <input type="number" min="0" class="form-control form-control-lg border-0" id="metragemIMOVEL" name="metragemIMOVEL">
                                  ...
                                  <div class="col-lg-2">
                                    <div class="form-group">
                                      <label for="floors-no" class="text-heading">Type of area<span
                                          class="text-muted"></span></label>
                                      <select class="form-control border-0 shadow-none form-control-lg selectpicker"
                                        title="Select" data-style="btn-lg py-2 h-52" id="floors-no" name="floors-no">
                                        <option>m²</option>
                                        <option>ft²</option>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="quartosIMOVEL" class="text-heading">Rooms</label>
                                      <!--------<input type="text" class="form-control form-control-lg border-0" id="roomIMOVEL"
                                        name="roomIMOVEL">
                                    ------>
                                    <input type="number" min="0" class="form-control form-control-lg border-0" id="quartosIMOVEL" name="quartosIMOVEL">
                                      </div>
                                  </div>
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="roomIMOVEL" class="text-heading">Rooms</label>
                                      <!--------<input type="text" class="form-control form-control-lg border-0" id="roomIMOVEL"
                                        name="roomIMOVEL">
                                    ------>
                                    <input type="number" min="0" class="form-control form-control-lg border-0" id="roomIMOVEL" name="roomIMOVEL">
                                      </div>
                                  </div>

                              <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="numeroIMOVEL" class="text-heading">Number</label>
                                      <input type="text" class="form-control form-control-lg border-0" id="numeroIMOVEL"
                                        name="numeroIMOVEL">
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="solteirocamasIMOVEL" class="text-heading">Single bed</label>
                                      <!--<input type="text" class="form-control form-control-lg border-0"
                                        id="quartosIMOVEL" name="quartosIMOVEL">
                                    
                                      -->    <input type="number" min="0" class="form-control form-control-lg border-0" id="solteirocamasIMOVEL" name="casalcamasIMOVEL">
                                      </div>
                                  </div>

                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="casalcamasIMOVEL" class="text-heading">Double bed</label>
                                      <!--<input type="text" class="form-control form-control-lg border-0"
                                        id="quartosIMOVEL" name="quartosIMOVEL">
                                    
                                      -->    <input type="number" min="0" class="form-control form-control-lg border-0" id="casalcamasIMOVEL" name="banheirosIMOVEL">
                                      </div>
                                  </div>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="banheirosIMOVEL" class="text-heading">Bathrooms</label>
                                      <!-----<input type="text" class="form-control form-control-lg border-0"
                                        id="banheirosIMOVEL" name="banheirosIMOVEL">
                                    ----->
                                    <input type="number" min="0" class="form-control form-control-lg border-0" id="banheirosIMOVEL" name="banheirosIMOVEL">
                                      </div>
                                  </div>

                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="lavanderiaIMOVEL" class="text-heading">Laundry<span
                                          class="text-muted"></span></label>
                                      <!------<input type="text" class="form-control form-control-lg border-0"
                                        id="lavanderiaIMOVEL" name="lavanderiaIMOVEL">
                                    --->
                                    <select class="form-control form-control-lg border-0" id="lavanderiaIMOVEL" name="lavanderiaIMOVEL">
                                  ...
                                  <option value="Não">No</option>
                                    ...
                                    <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="wifiIMOVEL" class="text-heading">Wifi<span
                                          class="text-muted"></span></label>
                                      <!------<input type="text" class="form-control form-control-lg border-0"
                                        id="lavanderiaIMOVEL" name="lavanderiaIMOVEL">
                                    --->
                                    <select class="form-control form-control-lg border-0" id="wifiIMOVEL" name="wifiIMOVEL">
                                    <option value="">Select...</option>
                                  <option value="Sim">Yes</option>
                                  <option value="Não">No</option>
                                  </select>
                                    ...
                                    <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="closetIMOVEL" class="text-heading">Closet<span
                                          class="text-muted"></span></label>
                                      <!-------<input type="text" class="form-control form-control-lg border-0"
                                        id="closetIMOVEL" name="closetIMOVEL">
                                    ------>
                                    <select class="form-control form-control-lg border-0" id="closetIMOVEL" name="closetIMOVEL">
                                    <option value="">Select...</option>
                                  <option value="Sim">Yes</option>
                                  <option value="Não">No</option>
                                  </select>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="arcondicionadoIMOVEL" class="text-heading">Air conditioning</label>
                                      <!---<input type="text" class="form-control form-control-lg border-0"
                                        id="arcondicionadoIMOVEL" name="arcondicionadoIMOVEL">
                                    ---><select class="form-control form-control-lg border-0" id="arcondicionadoIMOVEL" name="arcondicionadoIMOVEL">
                                    <option value="">Select...</option>
                                  <option value="Sim">Yes</option>
                                  <option value="Não">No</option>
                                  </select>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="vagasgaragemIMOVEL" class="text-heading">Garages</label>
                                      <!----<input type="text" class="form-control form-control-lg border-0"
                                        id="vagasgaragemIMOVEL" name="vagasgaragemIMOVEL">
                                    -----><select class="form-control form-control-lg border-0" id="vagasgaragemIMOVEL" name="vagasgaragemIMOVEL">
                                    <option value="">Select...</option>
                                  <option value="Sim">Yes</option>
                                  <option value="Não">No</option>
                                  </select>
                                  ...
                                  <div class="col-lg-4">
                                  <div class="form-group">
                                  <label for="fumarIMOVEL" class="text-heading">Smoking is allowed</label>
                                  <select class="form-control form-control-lg border-0" id="fumarIMOVEL" name="fumarIMOVEL">
                                  <option value="">Select...</option>
                                  <option value="Sim">Yes</option>
                                  <option value="Não">No</option>
                                  </select>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="fumarIMOVEL" class="text-heading">Smoking Prohibited</label>
                                      <input type="text" class="form-control form-control-lg border-0"
                                        id="fumarIMOVEL" name="fumarIMOVEL">
                                    </div>
                                  </div>
                                  ------>
                                   <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="salaodejogosIMOVEL" class="text-heading">Games room</label>
                                     <!-- <input type="number" class="form-control form-control-lg border-0"
                                        id="salaodejogosIMOVEL" name="salaodejogosIMOVEL">
                                      -->
                                      <select class="form-control form-control-lg border-0" id="salaodejogosIMOVEL" name="salaodejogosIMOVEL">
                                      <option value="">Select...</option>
                                  <option value="Sim">Yes</option>
                                  <option value="Não">No</option>
                                  </select>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="portariaIMOVEL" class="text-heading">Building entrance</label>
                                      <!---<input type="number" class="form-control form-control-lg border-0"
                                        id="portariaIMOVEL" name="portariaIMOVEL">
                                      -->
                                      <select class="form-control form-control-lg border-0" id="portariaIMOVEL" name="portariaIMOVEL">
                                      <option value="">Select...</option>
                                  <option value="Sim">Yes</option>
                                  <option value="Não">No</option>
                                  </select>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="playgroundIMOVEL" class="text-heading">Playground</label>
                                      <!--<input type="text" class="form-control form-control-lg border-0"
                                        id="playgroundIMOVEL" name="playgroundIMOVEL">
                                    --->
                                    <select class="form-control form-control-lg border-0" id="playgroundIMOVEL" name="playgroundIMOVEL">
                                    <option value="">Select...</option>
                                  <option value="Sim">Yes</option>
                                  <option value="Não">No</option>
                                  </select>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="proximoaometroIMOVEL" class="text-heading">Close to the subway</label>
                                      <!---<input type="text" class="form-control form-control-lg border-0"
                                        id="proximoaometroIMOVEL" name="proximoaometroIMOVEL">
                                    --->
                                    <select class="form-control form-control-lg border-0" id="proximoaometroIMOVEL" name="proximoaometroIMOVEL">
                                    <option value="">Select...</option>
                                  <option value="Sim">Yes</option>
                                  <option value="Não">No</option>
                                  </select>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="elevadorIMOVEL" class="text-heading">Elevator</label>
                                      <!---<input type="number" class="form-control form-control-lg border-0"
                                        id="elevadorIMOVEL" name="elevadorIMOVEL">
                                    --->
                                    <select class="form-control form-control-lg border-0" id="elevadorIMOVEL" name="elevadorIMOVEL">
                                    <option value="">Select...</option>
                                  <option value="Sim">Yes</option>
                                  <option value="Não">No</option>
                                  </select>
...
<!----
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      ...
                                      <!----<input type="text" class="form-control form-control-lg border-0" id="garage-size"
                                        name="garage-size">
                                 ...
                                 --->
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      ...
                                      <!----<input type="text" class="form-control form-control-lg border-0" id="basement"
                                        name="basement">
                                    ----->
                                    <select class="form-control form-control-lg border-0" id="poraoIMOVEL" name="poraoIMOVEL">
                                    <option value="">Select...</option>
                                  <option value="Sim">Yes</option>
                                  <option value="Não">No</option>
                                  </select>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="quadraesportivaIMOVEL" class="text-heading">Sports court</label>
                                    <!----  <input type="text" class="form-control form-control-lg border-0" id="quadraesportivaIMOVEL"
                                        name="quadraesportivaIMOVEL">
                                    --->
                                    <select class="form-control form-control-lg border-0" id="quadraesportivaIMOVEL" name="quadraesportivaIMOVEL">
                                    <option value="">Select...</option>
                                  <option value="Sim">Yes</option>
                                  <option value="Não">No</option>
                                  </select>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="festaIMOVEL" class="text-heading">Party<span
                                          class="text-muted"></span></label>
                                      <!---<input type="text" class="form-control form-control-lg border-0"
                                        id="festaIMOVEL" name="festaIMOVEL">
                                    ---->
                                    <select class="form-control form-control-lg border-0" id="festaIMOVEL" name="festaIMOVEL">
                                    <option value="">Select...</option>
                                  <option value="Sim">Yes</option>
                                  <option value="Não">No</option>
                                  </select>
                                    ...
                                    <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="academiaIMOVEL" class="text-heading">Gym<span
                                          class="text-muted"></span></label>
                                      <!----<input type="text" class="form-control form-control-lg border-0"
                                        id="academiaIMOVEL" name="academiaIMOVEL">
                                    --->
                                    <select class="form-control form-control-lg border-0" id="academiaIMOVEL" name="academiaIMOVEL">
                                    <option value="">Select...</option>
                                  <option value="Sim">Yes</option>
                                  <option value="Não">No</option>
                                  </select>
                                    ...
                                    <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="saunaIMOVEL" class="text-heading">Steam room<span
                                          class="text-muted"></span></label>
                                      <!---<input type="text" class="form-control form-control-lg border-0"
                                        id="saunaIMOVEL" name="saunaIMOVEL">
                                    ----->
                                    <select class="form-control form-control-lg border-0" id="saunaIMOVEL" name="saunaIMOVEL">
                                    <option value="">Select...</option>
                                  <option value="Sim">Yes</option>
                                  <option value="Não">No</option>
                                  </select>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="petsIMOVEL" class="text-heading">Pets allowed<span
                                          class="text-muted"></span></label>
                                      <!------<input type="text" class="form-control form-control-lg border-0"
                                        id="petsIMOVEL" name="petsIMOVEL">
                                    ------->
                                    <select class="form-control form-control-lg border-0" id="petsIMOVEL" name="petsIMOVEL">
                                    <option value="">Select...</option>
                                  <option value="Sim">Yes</option>
                                  <option value="Não">No</option>
                                  </select>
                                    ...
                                    <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="regrasadicionaisIMOVEL" class="text-heading">Additional Rules<span
                                          class="text-muted"></span></label>
                                      <!-------<input type="text" class="form-control form-control-lg border-0"
                                        id="regrasadicionaisIMOVEL" name="regrasadicionaisIMOVEL">
                                    ------>
                                    <select class="form-control form-control-lg border-0" id="regrasadicionaisIMOVEL" name="regrasadicionaisIMOVEL">
                                    <option value="">Select...</option>
                                  <option value="Sim">Yes</option>
                                  <option value="Não">No</option>
                                      </div>
                                    ...
                                    <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="slugIMOVEL" class="text-heading">Slug</label><span
                                          class="text-muted"></span></label>
                                      <input type="text" class="form-control form-control-lg border-0"
                                        id="slugIMOVEL" name="slugIMOVEL">
                                    </div>
                                  </div>
                                  <!----    
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="camasIMOVEL" class="text-heading">Bed</label>
                                      <input type="text" class="form-control form-control-lg border-0"
                                        id="camasIMOVEL" name="camasIMOVEL">
                                    
                                    <input type="number" min="0" class="form-control form-control-lg border-0" id="fumarIMOVEL" name="fumarIMOVEL">
                                      </div>
                                  </div>
                              -->
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="poraoIMOVEL" class="text-heading">Roofing</label>
                                    <!-----  <input type="text" class="form-control form-control-lg border-0" id="roofing"
                                        name="roofing">
                                    ----->
                                    <select class="form-control form-control-lg border-0" id="poraoIMOVEL" name="poraoIMOVEL">
                                    <option value="">Select...</option>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="extraIMOVEL" class="text-heading">Exterior Material</label>
                                      <input type="text" class="form-control form-control-lg border-0"
                                        id="extraIMOVEL" name="extraIMOVEL">
                                    </div>
                                  </div>
                                  
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="customID" class="text-heading">Custom ID <span
                                          class="text-muted">(text)</span></label>
                                      <input type="text" class="form-control form-control-lg border-0" id="customID"
                                        name="customID">
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="structure-type" class="text-heading">Structure type</label>
                                      <select class="form-control border-0 shadow-none form-control-lg selectpicker"
                                        title="Select" data-style="btn-lg py-2 h-52" id="structure-type"
                                        name="structure-type">
...
--->                          
                                  <div class="col-lg-8">
                                    <div class="form-group">
                                      <label for="floors-no" class="text-heading">Floors </label>
                                      <select class="form-control border-0 shadow-none form-control-lg selectpicker"
                                        title="Select" data-style="btn-lg py-2 h-52" id="floors-no" name="floors-no">
                                        <option>1</option>
                                        <option>2</option>
                                  ...
                                  <div class="col-lg-8">
                                    <div class="form-group mb-0">
                                      <label for="owner" class="text-heading">Owner/ Agent nots (not visible on
                                        front end)</label>
                                ...
                                <!-----------------------------------------------------------------------Vacation-Switch------------>
                                  <div class="col-lg-12">
                                    <div class="row" id="BlocoFerias" style="display:none">


                                    <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="qtdpessoasIMOVEL" class="text-heading">Number of peoples<span
                                          class="text-muted">(numeric)</span></label>
                                      <!---<input type="text" class="form-control form-control-lg border-0" id="qtdpessoasIMOVEL"
                                        name="qtdpessoasIMOVEL">
                                    ---->
                                    <input type="number" min="0" class="form-control form-control-lg border-0" id="qtdpessoasIMOVEL" name="qtdpessoasIMOVEL">
                                      </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                      <label for="criancasIMOVEL" class="text-heading">Kids<span
                                          class="text-muted">(numeric)</span></label>
                                      <!---<input type="text" class="form-control form-control-lg border-0" id="criancasIMOVEL"
                                        name="criancasIMOVEL">
                                    ---->
                                    <input type="number" min="0" class="form-control form-control-lg border-0" id="criancasIMOVEL" name="criancasIMOVEL">
                                      </div>
                                  </div>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="checkoutIMOVEL" class="text-heading">Check-In by
                                        <span class="text-muted">(Time)</span></label>
                                      <input type="time" class="form-control form-control-lg border-0"
                                        id="checkoutIMOVEL" name="checkoutIMOVEL">
                                    </div>
                                  </div>
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="checkinIMOVEL" class="text-heading">Check-Out by
                                        <span class="text-muted">(Time)</span></label>
                                      <input type="time" class="form-control form-control-lg border-0"
                                        id="checkinIMOVEL" name="checkinIMOVEL">
                                    </div>
                                    </div>
                                    <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="permanenciamaximaIMOVEL" class="text-heading">Maximum Stay</label>
                                      <label class="text-muted">(Nights)</label>
                                      <!----<input type="text" class="form-control form-control-lg border-0" id="permanenciamaximaIMOVEL"
                                        name="permanenciamaximaIMOVEL">
                                    ----->
                                    <input type="number" min="0" class="form-control form-control-lg border-0" id="permanenciamaximaIMOVEL" name="permanenciamaximaIMOVEL">
                                      </div>
                                    </div>
                                    <div class="col-lg-4">
                                      <div class="form-group">
                                        <label for="permanenciaminimaIMOVEL" class="text-heading">Minimum Stay</label>
                                        <label class="text-muted">(Nights)</label>
                                       <!--- <input type="text" class="form-control form-control-lg border-0" id="permanenciaminimaIMOVEL"
                                          name="permanenciaminimaIMOVEL">
                                      ---->
                                      <input type="number" min="0" class="form-control form-control-lg border-0" id="permanenciaminimaIMOVEL" name="permanenciaminimaIMOVEL">
                                        </div>
                                  </div>
                              ...
                              <button class="btn btn-lg btn-primary next-button mb-3">Next step
                                ...
                                <!----------------------------------------------------------------------------------
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="metragemIMOVEL" class="text-heading">Size in ft <span
                                          class="text-muted">(only numbers)</span></label>
                                      <input type="text" class="form-control form-control-lg border-0" id="metragemIMOVEL"
                                        name="metragemIMOVEL">
                                    </div>
                                  </div>
                                  <div class="col-lg-4">
                              ...
                              <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="numeroIMOVEL" class="text-heading">Numero</label>
                                      <input type="text" class="form-control form-control-lg border-0" id="numeroIMOVEL"
                                        name="numeroIMOVEL">
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="quartosIMOVEL" class="text-heading">Bedrooms</label>
                                      <input type="text" class="form-control form-control-lg border-0"
                                        id="quartosIMOVEL" name="quartosIMOVEL">
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="fumarIMOVEL" class="text-heading">Fumar</label>
                                      <input type="text" class="form-control form-control-lg border-0"
                                        id="fumarIMOVEL" name="fumarIMOVEL">
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="salaodejogosIMOVEL" class="text-heading">Salão de Jogos</label>
                                      <input type="number" class="form-control form-control-lg border-0"
                                        id="salaodejogosIMOVEL" name="salaodejogosIMOVEL">
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="portariaIMOVEL" class="text-heading">Portaria</label>
                                      <input type="number" class="form-control form-control-lg border-0"
                                        id="portariaIMOVEL" name="portariaIMOVEL">
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="proximoaometroIMOVEL" class="text-heading">Proximo ao Metrô</label>
                                      <input type="text" class="form-control form-control-lg border-0"
                                        id="proximoaometroIMOVEL" name="proximoaometroIMOVEL">
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="elevadorIMOVEL" class="text-heading">Elevador</label>
                                      <input type="number" class="form-control form-control-lg border-0"
                                        id="elevadorIMOVEL" name="elevadorIMOVEL">
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-lg-4">
                                    ...
                                    <div class="form-group">
                                      <label for="year-built" class="text-heading">Kids<span
                                          class="text-muted">(numeric)</span></label>
                                      <input type="text" class="form-control form-control-lg border-0" id="criancasIMOVEL"
                                        name="criancasIMOVEL">
                                    </div>
                                  ...
                                  <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="permanenciamaximaIMOVEL" class="text-heading">Permanencia Maxima</label>
                                      <input type="text" class="form-control form-control-lg border-0" id="permanenciamaximaIMOVEL"
                                        name="permanenciamaximaIMOVEL">
                                    </div>
                                    </div>
                                    <div class="col-lg-4">
                                      <div class="form-group">
                                        <label for="permanenciaminimaIMOVEL" class="text-heading">Permanencia Minima</label>
                                        <input type="text" class="form-control form-control-lg border-0" id="permanenciaminimaIMOVEL"
                                          name="permanenciaminimaIMOVEL">
                                      </div>
                                  </div>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="quadraesportivaIMOVEL" class="text-heading">Quadra Esportiva</label>
                                      <input type="text" class="form-control form-control-lg border-0" id="quadraesportivaIMOVEL"
                                        name="quadraesportivaIMOVEL">
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="lot-size-in-ft" class="text-heading">Party<span
                                          class="text-muted"></span></label>
                                      <input type="text" class="form-control form-control-lg border-0"
                                        id="festaIMOVEL" name="festaIMOVEL">
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="lot-size-in-ft" class="text-heading">Sauna<span
                                          class="text-muted"></span></label>
                                      <input type="text" class="form-control form-control-lg border-0"
                                        id="saunaIMOVEL" name="saunaIMOVEL">
                                    </div>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="lot-size-in-ft" class="text-heading">Pets<span
                                          class="text-muted"></span></label>
                                      <input type="text" class="form-control form-control-lg border-0"
                                        id="petsIMOVEL" name="petsIMOVEL">
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="lot-size-in-ft" class="text-heading">Regras Adicionais<span
                                          class="text-muted"></span></label>
                                      <input type="text" class="form-control form-control-lg border-0"
                                        id="regrasadicionaisIMOVEL" name="regrasadicionaisIMOVEL">
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="lot-size-in-ft" class="text-heading">Slug</label><span
                                          class="text-muted"></span></label>
                                      <input type="text" class="form-control form-control-lg border-0"
                                        id="slugIMOVEL" name="slugIMOVEL">
                                    </div>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="casalcamasIMOVEL" class="text-heading">Double Bed</label>
                                      <input type="text" class="form-control form-control-lg border-0"
                                        id="casalcamasIMOVEL" name="casalcamasIMOVEL">
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="solteirocamasIMOVEL" class="text-heading">Single Bed</label>
                                      <input type="text" class="form-control form-control-lg border-0"
                                        id="solteirocamasIMOVEL" name="solteirocamasIMOVEL">
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="exterior-material" class="text-heading">Exterior Material</label>
                                      <input type="text" class="form-control form-control-lg border-0"
                    ...
                    <div class="tab-pane tab-pane-parent fade px-0" id="amenities" role="tabpanel"
                      ...
                      <div class="card bg-transparent border-0">
                        ...
                        <div id="amenities-collapse" class="collapse collapsible" aria-labelledby="heading-amenities"
                          data-parent="#collapse-tabs-accordion">
                          <div class="card-body py-4 py-md-0 px-0">
                            <div class="card mb-6">
                              <div class="card-body p-6">
                                    ...
                                    <ul class="list-group list-group-no-border">
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input" name="features[]"
                                            id="basketball-court">
                                          <label class="custom-control-label" for="basketball-court">Basketball
                                            court</label>
                                        </div>
                                      </li>
                                      <li class="list-group-item px-0 pt-0 pb-2">
                            ...
                            <div class="d-flex flex-wrap">
                              ...
                              <button class="btn btn-lg btn-primary mb-3" type="button"
                                onclick="EditaImovel();">Edit property
                              </button>
                            </div>
                          </div>
                        </div>
...
*/
    ...
    const ACCESS_TOKEN = 'pk.eyJ1IjoiZWFzeXRvZ28iLCJhIjoiY2x1aWw5ajJnMDVyYzJqbnVnMTgyMXYyeCJ9.xn_ZXB7fb683Z6kPtzaAmQ';
  ...
  <script>
    ...
    function EditaImovel() {
      ...
      $.ajax({
        url: '/require/ajax/my-listings/edit.php',
        type: 'post',
        data: {
            codigoIMOVEL: $('#codigoIMOVEL').val(),
          planoIMOVEL: $('#planoIMOVEL').val(),
          clienteIMOVEL: $('#clienteIMOVEL').val(),
          valorIMOVEL: $('#valorIMOVEL').val(),
          labelvalorIMOVEL: $('#labelvalorIMOVEL').val(),          
          enderecoIMOVEL: $('#enderecoIMOVEL').val(),
          categoriaIMOVEL: $('#categoriaIMOVEL').val(),
          tipoIMOVEL: $('#tipoIMOVEL').val(),
          paisIMOVEL: $('#paisIMOVEL').val(),
          tituloIMOVEL: $('#tituloIMOVEL').val(),
          descricaoIMOVEL: $('#descricaoIMOVEL').val(),
          qtdpessoasIMOVEL: $('#qtdpessoasIMOVEL').val(),
          quartosIMOVEL: $('#quartosIMOVEL').val(),
          casalcamasIMOVEL: $('#casalcamasIMOVEL').val(),
          solteirocamasIMOVEL: $('#solteirocamasIMOVEL').val(),
           
          
          banheirosIMOVEL: $('#banheirosIMOVEL').val(),
          metragemIMOVEL: $('#metragemIMOVEL').val(),
          checkinIMOVEL: $('#checkinIMOVEL').val(),
          checkoutIMOVEL: $('#checkoutIMOVEL').val(),
          fotosIMOVEL: $('#fotosIMOVEL').val(),
          videoIMOVEL: $('#videoIMOVEL').val(),
          vagasgaragemIMOVEL: $('#vagasgaragemIMOVEL').val(),
          arcondicionadoIMOVEL: $('#arcondicionadoIMOVEL').val(),
          academiaIMOVEL: $('#academiaIMOVEL').val(),
          lavanderiaIMOVEL: $('#lavanderiaIMOVEL').val(),
          saunaIMOVEL: $('#saunaIMOVEL').val(),
          fumarIMOVEL: $('#fumarIMOVEL').val(),
          petsIMOVEL: $('#petsIMOVEL').val(),
          festaIMOVEL: $('#festaIMOVEL').val(),
          criancasIMOVEL: $('#criancasIMOVEL').val(),
          permanenciaminimaIMOVEL: $('#permanenciaminimaIMOVEL').val(),
          permanenciamaximaIMOVEL: $('#permanenciamaximaIMOVEL').val(),
          regrasadicionaisIMOVEL: $('#regrasadicionaisIMOVEL').val(),
          slugIMOVEL: $('#slugIMOVEL').val(), 
          closetIMOVEL: $('#closetIMOVEL').val(),
          salaodejogosIMOVEL: $('#salaodejogosIMOVEL').val(),
          quadraesportivaIMOVEL: $('#quadraesportivaIMOVEL').val(),
          portariaIMOVEL: $('#portariaIMOVEL').val(),
          proximoaometroIMOVEL: $('#proximoaometroIMOVEL').val(),
          elevadorIMOVEL: $('#elevadorIMOVEL').val(),
          playgroundIMOVEL: $('#playgroundIMOVEL').val(),
          roomIMOVEL: $('#roomIMOVEL').val(),
          cityIMOVEL: $('#cityIMOVEL').val(),
          numeroIMOVEL: $('#numeroIMOVEL').val(),
          zipcodeIMOVEL: $('#zipcodeIMOVEL').val(),
          paisIMOVEL: $('#paisIMOVEL').val(),
          stateIMOVEL: $('#stateIMOVEL').val(),
          longitudeIMOVEL: $('#longitudeIMOVEL').val(),
          latitudeIMOVEL: $('#latitudeIMOVEL').val(),
          ativoIMOVEL: $('#ativoIMOVEL').val(),

        },
        success: function (data) {

        alert(' Imovel Eitado com Sucesso! ');
        //  console.log(data);
        top.location.href="/edit-listings/<?php echo $pga;?>";

...
<head>
  ...
  <title>About Us - JoviPlanet</title>
  <!-- Google fonts -->
  <link
...
<body> 
  ...
  <main id="content">
    ...
    <section style="background-image: url('images/image-1440x960-1.png')"
      class="bg-img-cover-center py-10 pt-md-16 pb-md-17 bg-overlay">
        ...
        <div class="container position-relative z-index-2 ">
          <div class=" pb-6 page-title shadow">
            <h1 class="text-white fs-30 lh-16 mb-1 font-weight-600" data-animate="fadeInRight">About us </h1>
            <h6 class="text-white mb-1">We offer unique places suitable for your comfort</h6>
          </div>
        </div>
   ...
   <!--  <section class="bg-patten-03 bg-gray-01 pb-13 spt-10 pt-lg-17 pb-10">
    </section> -->

    
    <section class=" pb-13 spt-10 pt-lg-5 pb-10">
      <div class="container">
        <div class="row mt-8">
          <div class="col-md-6 mb-4 mb-lg-0 ">
            
              <div class="text-left">
                <h2 class="card-title  mb-2" style="color: #8C4E15;">Our mission</h2>
                <h4 class="elementor-heading-title elementor-size-default">Breaking Borders, Expanding Connections</h4>
                <p class="card-text">
                JoviPlanet is an international platform dedicated to the real estate universe. Our mission is to offer you, in a simple and efficient way, the opportunity to explore and discover prestigious and charming properties in renowned locations around the world. Whether you are a luxury property enthusiast or looking for a rural home, we are here to meet your needs, breaking boundaries and expanding connections.
                </p>
              </div>
          ...
          <div class="col-md-6 mb-4 mb-lg-0 ">
            <div class="text-left">
                <h2 class="card-title  mb-2" style="color: #8C4E15;">What we do</h2>
                <h4 class="elementor-heading-title elementor-size-default">Technology for the Real Estate World</h4>
                <p class="card-text">
                At JoviPlanet, we offer unparalleled experience in the real estate industry. We offer an international platform that not only connects buyers and sellers, but also provides ease and efficiency throughout the process of searching, selling, renting and booking vacation properties. Our cutting-edge technology makes searching and publishing properties simple, quick and practical.
                </p>
            </div>
          </div>
          <div class="col-md-6 mb-4 mb-lg-0 pt-lg-8">
          <div class="text-left">
                <h2 class="card-title  mb-2" style="color: #8C4E15;">Commitment to Security</h2>
                <h4 class="elementor-heading-title elementor-size-default">Protecting Your Privacy</h4>
                <p class="card-text">
                We understand the importance of our customers’ privacy and security. At JoviPlanet, we are truly committed to protecting the personal data of our visitors and registered customers. Your trust is fundamental to us.
                </p>
              </div>
          </div>
          <div class="col-md-6 mb-4 mb-lg-0 pt-lg-8">
          <div class="text-left">
                <h2 class="card-title  mb-2" style="color: #8C4E15;">Global Opportunities</h2>
                <h4 class="elementor-heading-title elementor-size-default">Connecting the World of Real Estate</h4>
                <p class="card-text">
                If you already have a national real estate website, you want to expand your business outside your country and increase your sales by joining us. At JoviPlanet, we offer an international platform that allows you to highlight your offers to any type of audience worldwide.
                </p>
              </div>
          </div>
          <div class="col-md-6 mb-4 mb-lg-0 pt-lg-8">
          <div class="text-left">
                <h2 class="card-title mb-2" style="color: #8C4E15;">No Commissions, No Language Barriers</h2>
                <h4 class="elementor-heading-title elementor-size-default">Greater International Visibility</h4>
                <p class="card-text">
                At JoviPlanet, we believe in transparency and simplicity. We do not charge commissions on any transactions between owners and users. Furthermore, all ads are translated into several languages, ensuring that your property reaches the entire audience in more than 100 countries.
                </p>
              </div>
          </div>
          <div class="col-md-6 mb-4 mb-lg-0 pt-lg-8">
          <div class="text-left">
                <h2 class="card-title  mb-2" style="color: #8C4E15;">Join ust</h2>
                <h4 class="elementor-heading-title elementor-size-default">International spotlight for your properties</h4>
                <p class="card-text">
                Would you like to give your property international prominence? Sign up now and select the customer account and plan that best suits your needs. At JoviPlanet, we offer exceptional visibility on a global scale, providing exciting opportunities for your property. Join us and explore a world of possibilities in the international real estate market!
                </p>
              </div>
          </div>
        </div>
    ...
    <section data-animated-id="3">
        <div class="bg-patten-01 pt-12 pb-12 bg-primary">
          <div class="container">
             
            <div class="row info-box-5 mt-7 mb-7 no-gutters mx-auto" style="padding: 0px; margin: -50px !important;">
              
            
            
            
            <div class="col-md-4 col-sm-6 mb-6  zoomIn animated" data-animate="zoomIn" style="
    padding: 10px;
    text-align: center;
">
                <a href="listing-with-left-sidebar.html" class="card border-0 align-items-center justify-content-center pb-5 pt-7 px-0 bg-transparent text-decoration-none">
                  <div class="card-img-top d-flex align-items-center justify-content-center rounded-0">
                    <div class=" position-relative">
                      <img src="images/Frame-0-porcent.png" class="hover-image position-absolute pos-fixed-top" alt="Apartment">
                      <img src="images/Frame-0-porcent.png" class="image" alt="Apartment">
                    </div>
                  </div>
                  <div class="card-body px-0 pt-5 pb-0">
                    <h4 class="card-title fs-20 lh-2 text-white mb-0">Zero commission on sale</h4>

                  </div>
                </a>
                <span class="text-dark fs-16" >You only pay to place the ad online, <br> only once, after validating the virtual</span>
              </div>
              <div class="col-md-4 col-sm-6 mb-6  zoomIn animated" data-animate="zoomIn" style="padding: 10px; text-align: center;">
                <a href="listing-with-left-sidebar.html" class="card border-0 align-items-center justify-content-center pb-5 pt-7 px-0 bg-transparent text-decoration-none">
                  <div class="card-img-top d-flex align-items-center justify-content-center  rounded-0">
                    <div class=" position-relative">
                      <img src="images/Frame-globo.png" class="hover-image position-absolute pos-fixed-top" alt="House">
                      <img src="images/Frame-globo.png" class="image" alt="House">
                    </div>
                  </div>
                  <div class="card-body px-0 pt-5 pb-0">
                  <h4 class="card-title fs-20 lh-2 text-white mb-0">Get International Visibility</h4>



                  </div>
                </a>
                <span class="text-dark fs-16">Your ad has been automatically translated <br> into over 20 languages and published in <br> over 100 countries. 50% of traffic abroad <br> and 50% in your country.</span>
              </div>

              <div class="col-md-4 col-sm-6  zoomIn animated" data-animate="zoomIn" style="
    padding: 10px;
    text-align: center;
">
                <a href="listing-with-left-sidebar.html" class="card border-0 align-items-center justify-content-center pb-5 pt-7 px-0 bg-transparent text-decoration-none">
                  <div class="card-img-top d-flex align-items-center justify-content-center rounded-0">
                    <div class=" position-relative">
                      <img src="images/Frame-peoples.png" class="hover-image position-absolute pos-fixed-top" alt="Office">
                      <img src="images/Frame-peoples.png" class="image" alt="Office">
                    </div>
                  </div>
                  <div class="card-body px-0 pt-5 pb-0">
                  <h4 class="card-title fs-20 lh-2 text-white mb-0">+ 1 million visits pe month</h4>


                  </div>
                </a>
                <span class="text-dark fs-16">Receive the data of potencial <br> buyers directly by email.</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section data-animated-id="3">
        <div class=" pt-12 pb-12  " style="background-color: #FFFFFF;">
          <div class="container" style="border: 1px solid #000; background-color: black; padding: 69px; " >
          ...
          <h2 class="col-lg-6" style="color: #ba824f;">Create your ad in just a few minutes </h2>
              <div  class="col-lg-6 text-white"><img src="images/bt_sobre_1.png"><br>make your payment</div>
...
<div class="row">
              ...
              <div  class="col-lg-6 text-white"><img src="images/bt_sobre_2.png"><br>Include all ad information</div>
              <div  class="col-lg-6 text-white"><img src="images/bt_sobre_3.png"><br>Enter your contact information</div>
          </div>
          <br>
          <div class="row">
              <div  class="col-lg-6 text-white"><img src="images/bt_sobre_4.png"><br>Review/Review property listing data</div>
              <div  class="col-lg-6 text-white"><img src="images/bt_sobre_5.png"><br>Publish your properties worldwide! What is simple</div>
          </div>

        
        </div>

          <div class="col-lg-6 pl-xl-6 row">
...
>
          ...
          <h6 class="mt-5 fs-23 lh-1625" style="color: #000; text-align: center;"> Join us and <strong>explore a world of possibilities</strong> in the international real estate market!</h6>
<br>
          <div class="col-lg-12 pb-20 row" style="text-align: center;">
          <div class="col-lg-6 pl-xl-6">
          ...
          <button type="button" class="btn btn-light" style="border: 1px solid;">Login</button>
          </div>
    ...
    <section>
      <div style="  "
        ...
        <div class="container container-xxl">
          <div class="row align-items-center">
<! ---------------------------------------------------------------------------------------------------------------------- >            
            <div class="col-lg-6 pl-xl-8" style="width: 50%" data-animate="fadeInRight">
              <h2 class="mt-5 lh-1625" style="color: #ba824f;">Create your ad in just a few minutes
                </h2>
...
<! ----------------------------------------------------------------------------------------------------------------------- >
            <div class="col-lg-4 pl-xl-8" style=" width: 50%; background-color: white;" data-animate="fadeInRight">
              <h2 class="text-dark mt-5 lh-1625">Find your<br>
                neighborhood</h2>
              <span class="heading-divider"></span>
              <p class="mb-6 text-dark">Lorem ipsum dolor sit amet, consec tetur cing elit. Suspe ndisse</p>
              <div class="input-group input-group-lg pr-sm-17">
                <input type="text" class="form-control fs-13 font-weight-500 text-gray-light rounded-lg rounded-right-0 border-0 shadow-none h-52 bg-white" name="search" placeholder="Enter an address, neighbourhood">
                <button type="submit" class="btn btn-primary fs-18 rounded-left-0 rounded-lg px-6 border-0">
                  <i class="far fa-search"></i>
                </button>
              </div>
